...
class M_master_barge extends CI_Model {
    ...
    function json()
    {
        $this->datatables->select('a.barge_charges_id, a.container_id, b.container_name, a.container_size, a.validity_from, a.validity_till,
                                ...
                                a.cust_export_empty, a.cust_export_reefer, a.cust_export_laden, a.cust_import_transhipment, a.cust_misc, c.kepanjangan,
        ...
        $this->datatables->join('zhl_mst_charges_type as c', 'a.chargestype = c.chargestype','left');
    ...
    function insert()
    {
        $info = array(
            ...
            'chargestype'                   => remove_thousand_separator($this->input->post('chargestype')),
        );
