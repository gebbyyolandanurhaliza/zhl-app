...
class M_master_transport extends CI_Model {
    ...
    private $id             = 'transport_charges_id';
    ...
    function json()
    {
        $this->datatables->select('a.transport_charges_id, a.container_id, b.container_name, a.container_size, a.validity_from, a.validity_till,
