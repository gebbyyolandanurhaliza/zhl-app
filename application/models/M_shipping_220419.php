...
//    ----------------------------------------------------------------------------------------------------------------------------------
    ...
    function simpan_cont_sp($datahdr){
        $this->db->trans_begin();
            ...
            $supp=$this->input->post('supplier_supp');
            ...
            $query3=$this->simpan_local_cont_sp_dtl($contid,$container_number_lc,$container_id_lc,$container_name_lc,$loading_port_lc,$supplier_lc,$customer_lc,$proses_lc,$stuffing_lc,$jml_lc,$id_lc);
            $flag3=$query3->flag;
    ...
    function simpan_local_cont_sp_dtl($contid,$container_number_lc,$container_id_lc,$container_name_lc,$loading_port_lc,$supplier_lc,$customer_lc,$proses_lc,$stuffing_lc,$jml_lc,$id_lc){
        for($i=0; $i<$jml_lc; $i++){

            $this->db->query("SET @flag = 0");
            $this->db->query("call save_local_container_dtl('".$contid."','".$container_number_lc[$i]."','".$container_id_lc[$i]."','".$container_name_lc[$i]."','".$loading_port_lc[$i]."','".$supplier_lc[$i]."','".$customer_lc[$i]."','".$proses_lc."','".$stuffing_lc[$i]."','".$id_lc[$i]."',@flag)
                ");
        }
