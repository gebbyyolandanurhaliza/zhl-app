...
class M_master_freight extends CI_Model {
    ...
    function json()
    {
        $this->datatables->select('a.freight_charges_id,a.container_id,a.container_size,d.container_name,a.port_id,b.port_name,b.country_id,c.country_name, a.vendor_rates,a.vendor_misc,a.cust_rates,a.cust_misc,a.validity_from, a.validity_till, a.createdby, a.createddate, a.updatedby, a.updateddate, a.vendor_rates2, a.vendor_rates3, a.shipping_line1, a.shipping_line2, a.shipping_line3, a.cust_rates2, a.cust_rates3, a.consignee1, a.consignee2, a.consignee3, a.shipping_term_id, e.trading_term_name');
    ...
    {
        $query = ('trading_term_id in (2,3,15,16)');
