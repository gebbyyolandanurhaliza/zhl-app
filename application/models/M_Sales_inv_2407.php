...
class M_Sales_inv extends CI_Model
{
    ...
    function get_harga($idcon, $jenisinv){
        ...
        if($jenisinv == 'EE' || $jenisinv == 'EL' || $jenisinv == 'IT' || $jenisinv == 'IL'){
    ...
    function get_detail_freigthcont($awal, $akhir){
        $sql = $this->db->query("SELECT DISTINCT  A.invno, F.container,F.contid, C.container_id, D.container_name, F.seal   
