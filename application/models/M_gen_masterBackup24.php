...
class M_gen_master extends CI_Model
{
    ...
    private $tblmst_country = 'gen_tbl_mst_country';
    private $country_id = 'country_id';
	
	private $tblmst_currency = 'gen_tbl_mst_currency';
	private $currency_id = 'currency_id';
	
	private $tblmst_status = 'gen_tbl_mst_status';
	private $status_id = 'status_id';
	
	private $tblmst_factory = 'gen_tbl_mst_factory';
	private $factory_id	= 'factory_id';
	
	private $tblmst_uom = 'gen_tbl_mst_item_uom';

	private $tblmst_group_cust = 'mar_tblmst_customer_group';
	
	private $tblmst_ship_line = 'ship_tbl_mst_shipping_line';
	

//------ akses database acak -----
  	private $table_vendor		= 'pur_tbl_mst_supplier';
  	private $table_group_vendor = 'gen_tbl_mst_vendor_group';
  	//private $id 				= 'id';


	private $mark_table			= 'mar_tblmst_marketing';
	private $mark_view			= 'mar_vw_mst_marketing';
    private $mark_id			= 'marketing_id';

	private $sales_view			= 'mar_vw_mst_sales_marketing';
	private $sales_id			= 'userid';

	private $cust_table			= 'mar_tblmst_customer';
	private $cust_view			= 'mar_vw_mst_customer';
    private $cust_id			= 'customer_id';

	private $cust_doc_table		= 'mar_tblmst_customer_document';
	private $cust_product_table	= 'mar_tblmst_customer_product_purchase';

	private $cust_payterm_table = 'mar_tblmst_customer_payterm';
	private $cust_payterm_view	= 'mar_vw_mst_customer_payterm';

    private $cust_bank_table    = 'mar_tblmst_customer_bank';
    private $cust_bank_view     = 'mar_vw_mst_customer_bank';

	private $agent_table		= 'mar_tblmst_agent';
	private $agent_view			= 'mar_vw_mst_agent';

	private $brand_table		= 'mar_tblmst_brand';
	private $brand_id			= 'brand_id';

	private $document_table		= 'mar_tblmst_document';
	private $document_id		= 'document_id';

	private $bank_table			= 'mar_tblmst_bank';
	private $bank_view			= 'mar_vw_mst_bank';

	private $uom_volume_table	= 'mar_tblmst_uom_volume';

	private $uom_quantity_table = 'mar_tblmst_uom_quantity';

	private $uom_price_table	= 'mar_tblmst_uom_price';

	private $pack_size_table	= 'mar_tblmst_packing_size';
	private $packing_size_id	= 'packing_size_id';

	private $packing_type_table = 'mar_tblmst_packing_type';
	private $packing_type_id	= 'packing_type_id';

	private $container_table	= 'mar_tblmst_container';
	private $container_id		= 'container_id';

	private $port_table			= 'mar_tblmst_port';
	private $port_view			= 'mar_vw_mst_port';
	private $port_id			= 'port_id';

	private $tradingterm_table	= 'mar_tblmst_trading_term';
	private $tradingterm_id		= 'trading_term_id';

	private $paymentterm_table	= 'mar_tblmst_payment_term';
	private $paymentterm_id		= 'payment_term_id';

	private $shelf_table		= 'mar_tblmst_product_shelf_life';
	private $shelf_id			= 'product_shelf_life_id';

	private $maincate_table		= 'mar_tblmst_main_category';
	private $maincate_id		= 'main_category_id';

	private $sup_table			= 'pur_tbl_mst_supplier';
//------ akses database acak -----
    ...
    function get_by_id($nama_master, $id)
    {
		switch ($nama_master) {
			...
			case 'group_customer':
				...
				$this->db->where($this->customer_group_id,$id);
				break;
