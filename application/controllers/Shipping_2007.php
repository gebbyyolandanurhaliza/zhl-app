...
//    ------------------------------------------------------------------ABOUT Container Outward--------------------------------------------------------
    ...
    public function container_stock_choice (){
        $data['stock']= $this->m_shipping->tampil_factory_stock_container_inward($this->input->get('stock'));
...
//-------------------------------Modul Container Stock-------------------------------//
    ...
    public function container_local_create(){
        $this->template->display('shipping/local_container_create');   
...
//---------------------Fungsi Save---------------
     ...
     public function container_local_delete (){
        $contid=$this->input->get('stock');
        // echo $id;
        $this->m_shipping->delete_container_local_hdr($contid);
        redirect('shipping/local_container');
    }
     ...
     public function container_shippping_delete (){
        ...
        $hdr=$this->input->get('contid');
        // echo $id;
        $this->m_shipping->delete_container_shipping($id);
    }
//------------------------------------------------PRINT-----------------------------------------------------------------------------------
...
//--------------------------------------------------------------------END----------------------------------------------------------------
    ...
    function container_inward_move(){
        ...
        $this->m_shipping->containerinward_move($shipdate, $id, $flag, $et);
    }
}