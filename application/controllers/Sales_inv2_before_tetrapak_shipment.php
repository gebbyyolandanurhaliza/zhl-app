...
class Sales_inv2 extends CI_Controller{
    function __construct() {
        parent::__construct();
        $this->load->model(array('M_Sales_inv2','m_purchasing', 'M_purchase_inv', 'M_vcdn'));
    ...
    function edit(){
        ...
        $data['customer'] = $this->M_Sales_inv2->get_cust();
        // $data['supplier'] = $this->M_Sales_inv2->supplier();
    ...
    function get_detail2(){
        ...
        if($invtype == 'lem' || $invtype == 'eim'){
            $data['_detail2'] = $this->M_Sales_inv2->get_isilclcont2_1($tgl, $bargedest);
            $data['_ft2'] = $this->M_Sales_inv2->get_2ft3($tgl, $bargedest);
        }else{
            $data['_detail'] = $this->M_Sales_inv2->get_isidetail2($tgl, $bargedest);
            $data['_detail2'] = $this->M_Sales_inv2->get_isilclcont($tgl, $bargedest, $sup); 
            $data['_detail3'] = $this->M_Sales_inv2->get_isilclcont2($tgl, $bargedest);
            $data['_ft1'] = $this->M_Sales_inv2->get_2ft($tgl, $bargedest);
            $data['_ft2'] = $this->M_Sales_inv2->get_2ft2($tgl, $bargedest, $sup);
            $data['_ft3'] = $this->M_Sales_inv2->get_2ft3($tgl, $bargedest);
            // echo "2";
    ...
    function get_detail3(){
        ...
        if($invtype == 'lem' || $invtype == 'eim'){
            $data['_detail2'] = $this->M_Sales_inv2->get_isilclcontdtl2_1($tgl, $bargedest);
        }
        else{
            $data['_detail'] = $this->M_Sales_inv2->get_isidetail3($tgl, $bargedest);
            $data['_detail2'] = $this->M_Sales_inv2->get_isilclcontdtl($tgl, $bargedest, $sup);
            $data['_detail3'] = $this->M_Sales_inv2->get_isilclcontdtl2($tgl, $bargedest);
        }
    ...
    function get_detail4(){
        ...
        if($invtype == 'lem' || $invtype == 'eim'){
            $data['_detail2'] = $this->M_Sales_inv2->get_2ft3detail($tgl, $bargedest);
        }
        else{
            $data['_detail'] = $this->M_Sales_inv2->get_2ftdetail($tgl, $bargedest);
            $data['_detail2'] = $this->M_Sales_inv2->get_2ft2detail($tgl, $bargedest, $sup);
            $data['_detail3'] = $this->M_Sales_inv2->get_2ft3detail($tgl, $bargedest);
        }
    ...
    function get_vessel(){
     ...
     function getharga(){
        ...
        $sql = $this->M_Sales_inv2->get_harga($idcon, $jenisinv);
    ...
    function geteta(){
        ...
        $sql = $this->M_Sales_inv2->geteta($barge, $p_tanggal);
    ...
    function getetd(){
        ...
        $sql = $this->M_Sales_inv2->getetd($barge, $p_tanggal);
    ...
    function getbarge(){
        ...
        $sql = $this->M_Sales_inv2->getbarge($barge, $p_tanggal);
    ...
    function geteta2(){
        ...
        $sql = $this->M_Sales_inv2->geteta2($barge, $p_tanggal);
        echo "<input type='text' name='tgl_eta' value='$sql' id='tgl_eta' class='form-control' data-date-format='dd/mm/yyyy' readonly>";
    ...
    function getetd2(){
        ...
        $sql = $this->M_Sales_inv2->getetd2($barge, $p_tanggal);
        echo "<input type='text' name='tgl_etd' value='$sql' id='tgl_etd' class='form-control' data-date-format='dd/mm/yyyy' readonly>";
    ...
    function getbarge2(){
        ...
        $sql = $this->M_Sales_inv2->getbarge2($barge, $p_tanggal);
        echo "<input type='text' id='barge' name='barge' class='form-control' value='$sql'  />";
    }
