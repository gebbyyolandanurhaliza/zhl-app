...
class Purchasing_pl extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model(array('m_purchasing', 'm_purchasing_pl', 'm_purchasing_so'));
    ...
    function index()
    {
        // $data['_factory'] = $this->m_purchasing_pl->get_factory();
        $this->template->display('purchasing/packing_list/index');
    }   

    public function filter_pl()
    {
        $data['so'] =  $this->m_purchasing_pl->tampil_pl_all($this->input->get('inv'));
        $this->load->view('purchasing/packing_list/packing_list_all', $data);
    }

    public function remove_packing_list()
    {
        $data['pl'] =  $this->m_purchasing_pl->tampil_pl_where($this->input->get('delete'));
        $this->load->view('purchasing/packing_list/packing_list_filter_modal_delete', $data);
    }

    public function sales_order_inv()
    {
        $data['so'] =  $this->m_purchasing_so->tampil_so($this->input->get('inv'));
        $this->load->view('purchasing/packing_list/sales_order_inv_all', $data);
    }
    ...
    public function PI_show()
    {
        ...
        $this->template->display('purchasing/packing_list/add_packing_list', $data);
    }
    ...
    public function show_pl()
    {
        ...
        $data['cur'] =  $this->m_purchasing->tampil_cur();
        $this->template->display('purchasing/packing_list/edit_packing_list', $data);
    }


    function print_report_pl()
    {
        $packdo         = $this->m_purchasing_pl->tampil_pl_where($this->input->get('pl'));
        $data['packdo'] = $packdo;
    ...
    function print_report_do()
    {
        $packdo         = $this->m_purchasing_pl->tampil_pl_where($this->input->get('pl'));
        $data['packdo'] = $packdo;
        $this->load->view('purchasing/packing_list/rpt_do', $data);
    }
    ...
    {
        $this->m_purchasing_pl->delete_packing_list($this->input->get('pl'));
    ...
    // function edit()
    // {
    //     $data['packdo']   = $this->m_purchasing_pl->tampil_packdo_where($this->input->get('noreff'));
    //     $data['_factory'] = $this->m_purchasing_pl->get_factory();
    ...
    //     $query   = $this->m_purchasing_pl->delete_detail_do($id);
    ...
    // {
    //     $data['_datagr'] = $this->m_purchasing_pl->get_gr($this->input->get('cust'), $this->input->get('po'));
    ...
    //     $data['_datagr'] = $this->m_purchasing_pl->get_gr_do($factory);
    //     $this->load->view('purchasing/packing_do/data_gr_ajax_do', $data);
    // }

    // public function filter_do()
    // {
    //     $data['packdo']   = $this->m_purchasing_pl->tampil_pack_list($this->input->get('po'));
    //     $data['_factory'] = $this->m_purchasing_pl->get_factory();
    ...
    //     $data['_list'] = $this->m_purchasing_pl->tampil_packdo_filter($p_dari, $p_sampai, $mainpo, $item, $npbb, $status);
    ...
    //     $data['record'] = $this->m_purchasing_pl->tampil_packdo_filter($p_dari, $p_sampai, $mainpo, $item, $npbb, $status);
    ...
    // {
    //     $data['po'] =  $this->m_purchasing_pl->tampil_gr_po($this->input->get('cust'), $this->input->get('po'));
    ...
    //     $query =  $this->m_purchasing_pl->simpan_lr_sp($datahdr);
    ...
    // {
    //     $this->m_purchasing_pl->delete_loading_report($this->input->get('lr'), 0);
    //     redirect('Packing_do/add_loading_report');
    // }
    ...
    //     $this->m_purchasing_pl->loading_report_delete_item_dp($this->input->get('itemid'), 0);
    //     redirect('Packing_do/loading_report_show?lr=' . $lr);
    // }

    // public function remove_loading_report()
    // {
    //     $data['lr'] =  $this->m_purchasing_pl->tampil_lr_where($this->input->get('delete'));
    ...
    //         'ipaddress' => $ipaddress
    //     );
    //     $query = $this->m_purchasing_pl->simpan_do_sp($datahdr);
    ...
    // {
    //     $data['do'] =  $this->m_purchasing_pl->tampil_do_where($this->input->get('delete'));
    ...
    // {
    //     $docno = $this->input->post('docno');
    //     $query = $this->m_purchasing_pl->delete_delivery_order($docno);
    ...
    // {
    //     $data['book'] =  $this->m_purchasing_pl->tampil_bookref_where($this->input->get('bookref_no'));
    //     $this->template->display('purchasing/packing_do/book_order_show', $data);
    // }

    // public function book_order_all()
    // {
    //     $data['book'] =  $this->m_purchasing_pl->tampil_bookref_all($this->input->get('inv'));
    //     $this->load->view('purchasing/packing_do/book_order_all', $data);
    // }

    // public function add_container_po()
    // {
    //     $data['po'] =  $this->m_purchasing_pl->tampil_container_po($this->input->get('po'));
    //     $this->load->view('purchasing/packing_do/add_container_filter_po', $data);
    // }

    // public function add_container_get()
    // {
    //     $data['cont'] =  $this->m_purchasing_pl->tampil_cont_shp($this->input->get('cust'), $this->input->get('ship'), $this->input->get('cont'), $this->input->get('contno'));
    //     $this->load->view('purchasing/packing_do/get_add_container', $data);
    // }

    // public function add_container_po_dtl()
    // {
    //     $data['po'] =  $this->m_purchasing_pl->tampil_container_po($this->input->get('cust'), $this->input->get('po'));
    ...
    //     $query =  $this->m_purchasing_pl->simpan_book_ref_sp($datahdr);
    ...
    // {
    //     $data['book'] =  $this->m_purchasing_pl->tampil_bookref_where($this->input->get('bookref_no'));
    //     $data['cont'] =  $this->m_purchasing_pl->get_bookref_shp2($this->input->get('cust'), $this->input->get('ship'));
    ...
    //     $query =  $this->m_purchasing_pl->simpan_book_ref_shp_sp($datahdr);
    ...
    // {
    //     $data['po'] =  $this->m_purchasing_pl->tampil_po_hdr($this->input->get('remark'));
    ...
    //     $data['book'] = $this->m_purchasing_pl->get_shp_excel($this->input->get('bookref_no'));
    //     $data['whs']  = $this->m_purchasing_pl->get_shp_whs($this->input->get('bookref_no'));
