...
class Packing_do extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model(array('m_purchasing', 'M_packing_do', 'm_purchasing_so','m_purchasing_mon'));
    ...
    function mon_lr_filter()
    {
        $year = $this->input->get('year');
        $data['dtl'] =  $this->M_packing_do->get_mon_lr_filter($year);
