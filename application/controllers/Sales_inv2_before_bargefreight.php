...
class Sales_inv2 extends CI_Controller
{
    ...
    function get_detail2()
    {
        ...
        if ($invtype == 'lem' || $invtype == 'eim') {
            $data['_detail2'] = $this->M_Sales_inv2->get_isilclcont2_1($tgl, $bargedest); //local ship_vw_container_local2 
            ...
            $data['_detailtet']  = $this->M_Sales_inv2->get_isidetailTET($tgl, $bargedest); // ship_vw_trn_cont
            $data['_fttet']      = $this->M_Sales_inv2->get_2ftTET($tgl, $bargedest); //ship_vw_trn_cont
            $data['_detail2tet'] = $this->M_Sales_inv2->get_isidetailTET2($tgl, $bargedest); //local ship_vw_container_local2
            $data['_fttet2']     = $this->M_Sales_inv2->get_2ftTET2($tgl, $bargedest);  //ship_vw_container_local2 

        } else {
            $data['_detail']  = $this->M_Sales_inv2->get_isidetail2($tgl, $bargedest); // ship_vw_trn_cont
            ...
            $data['_ft1']     = $this->M_Sales_inv2->get_2ft($tgl, $bargedest); //ship_vw_trn_cont
