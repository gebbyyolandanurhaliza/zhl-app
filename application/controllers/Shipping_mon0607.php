...
//--------Logika EE
            if ($v->stuffing == 'EE'){
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K'.$counter, $v->stuffing);                
            }else{
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K'.$counter, $v->stuffing. ' - ' .$v->depot);                
            }
//--------
    ...
    public function container_stock_report(){
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('M7', 'Status Container');
         ...
         foreach($data as $v):
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('M'.$counter, $v->status);
             $counter++;
             //$C20 += $v->c20;$C40 += $v->c40;
         endforeach;
