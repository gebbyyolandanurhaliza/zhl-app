				...
				<div class="portlet light">
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject theme-font uppercase">Master Zht Customer Group</span>
						</div>
						<div class="actions">
							<?php echo anchor(site_url('marketing_zht/create_master/group_customer'), '<i class="fa fa-plus"></i> Create New Customer Group', 'class="btn btn-primary"'); ?>
						</div>
					</div>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<?php  
											echo anchor(site_url('marketing_zht/delete_master/group_customer/'.$master->customer_group_id),'<i class="fa fa-trash-o"></i>','class="btn default btn-xs red-stripe" onclick="javasciprt: return confirm(\'Are You Sure Delete Data '.$master->customer_group_name.'?\')"'); 
											echo anchor(site_url('marketing_zht/edit_master/group_customer/'.$master->customer_group_id),'<i class="fa fa-edit"></i>', 'class="btn default btn-xs green-stripe"'); 
										?>
										</td>
