...
foreach ($hdr as $gee) {
  ...
  $remarks = $gee->remarks;
  $by = $gee->by;
  $name_sign   = $gee->name_sign;
  $date  = $gee->date;
  $remark_dtl = $gee->remark_dtl;
  $title_hdr = $gee->title_hdr;
}
...
<div class="page-content">
  <form action="<?php echo site_url('eform/coa_gen_save'); ?>" method="post" role="form" name="my_form">
    <!-- Cek ID -->
    <input type="hidden" name="id_coa_gen" id="id_coa_gen" value="">
    <input type="hidden" name="shipid" id="shipid" value="<?php echo $shipid; ?>">
    <input type="hidden" name="po_hdr_id" id="po_hdr_id" value="<?php echo $po_hdr_id; ?>">
    <input type="hidden" name="ship_product_id" id="ship_product_id" value="<?php echo $ship_product_id; ?>">
    <input type="hidden" name="customer_id" id="customer_id" value="<?php echo $to_id; ?>">
    <!-- Cek ID -->
    <div class="container">
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet-body">
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <input type="text" class="form-control" name="cert_no" id="cert_no" placeholder="Input Certificate Number" value="<?php echo $cert_no; ?>" required />
                  </div>
                  <span class="help-inline"></span>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="lot_no" id="lot_no" value="<?php echo $lot_no; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" name="si_no" id="si_no" value="<?php echo $si_no; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
            ...
            <div class="portlet-body" id="package_detail">
              ...
              <?php foreach ($dtl1 as $h) { ?>
                ...
                <td class="text-center" width="50px"><input type="hidden" name="txtdtlid[]" id="txtdtlid" value="0" />
                  <input class="form-control text-center txt input-sm" type="text-center" name="no[]" id="no[]" value="<?php echo $h->no; ?>">
                </td>
                <td class="text-center"><input type="text" placeholder="Input production date" name="pro_date[]" id="pro_date" class="form-control txt nova" value="<?php echo $h->pro_date; ?>"></td>
                <td class="text-center"><input type="text" placeholder="Input expiry date" name="exp_date[]" id="exp_date[]" class="form-control txt" value="<?php echo $h->exp_date; ?>"></td>
                <td class="text-center"><input type="text" placeholder="Input Color" name="cap[]" id="cap[]" class="form-control txt" value="<?php echo $h->cap; ?>"></td>
                <td class="text-center"><input type="text" placeholder="Input Flavour and Odour" name="fo[]" id="fo[]" class="form-control txt" value="<?php echo $h->fo; ?>"></td>
              <?php } ?>
              </tbody>
              </table>
            </div>
          ...
          <div class="col-md-12">
            <div class="portlet light">
              ...
              <div class="portlet-body" id="package_detail">
                ...
                <?php foreach ($dtl2 as $i) { ?>
                  <td class="text-center"><input type="button" class="btn btn-sm btn-danger" onclick="hapus_baris_chemical(this)" value="hapus"></td>
                  <td class="text-center" width="50px"><input type="hidden" name="txtdtlid[]" id="txtdtlid" value="0" />
                    <input class="form-control text-center txt input-sm" type="text-center" name="no1[]" id="no1[]" value="<?php echo $i->no; ?>">
                  </td>
                  <td class="text-center"><input type="text" placeholder="Input production date" name="pro_date1[]" id="pro_date1[]" class="form-control txt yanti" value="<?php echo $i->pro_date1; ?>"></td>
                  <td class="text-center"><input type="text" placeholder="Input Expiry date" name="exp_date1[]" id="exp_date1[]" class="form-control txt" value="<?php echo $i->exp_date1; ?>"></td>
                  <td class="text-center"><input type="text" placeholder="Input Fat Content" name="fc[]" id="fc[]" class="form-control txt" value="<?php echo $i->fc; ?>"></td>
                  <td class="text-center"><input type="text" placeholder="Input pH Value" name="ph[]" id="ph[]" class="form-control txt" value="<?php echo $i->ph; ?>"></td>
                  <td class="text-center"><input type="text" placeholder="Input Dry Matter" name="dm[]" id="dm[]" class="form-control txt" value="<?php echo $i->dm; ?>"></td>
                <?php } ?>
                </tbody>
                </table>
              </div>
              ...
              <div class="portlet light">
                ...
                <div class="portlet-body" id="package_detail">
                  ...
                  <?php foreach ($dtl3 as $j) { ?>
                    ...
                    <td class="text-center" width="50px"><input type="hidden" name="txtdtlid[]" id="txtdtlid" value="0" />
                      <input class="form-control text-center txt input-sm" type="text-center" name="no2[]" id="no2[]" value="<?php echo $j->no; ?>">
                    </td>
                    <td class="text-center" width="250px"><input type="text" placeholder="Input Production date" name="pro_date2[]" id="pro_date2[]" class="form-control txt situmorang" value="<?php echo $j->pro_date2; ?>"></td>
                    <td class="text-center"><input type="text" placeholder="Input Expiry Date" name="exp_date2[]" id="exp_date2[]" class="form-control txt" value="<?php echo $j->exp_date2; ?>"></td>
                    <td class="text-center"><input type="text" placeholder="Input Commercial Sterility" name="cs[]" id="cs[]" class="form-control txt" value="<?php echo $j->cs; ?>"></td>
                  <?php } ?>
                  </tbody>
                  </table>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="by" id="by" value="<?php echo $by; ?>" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-4">Name</label>
                      <div class="col-md-8">
                        <input type="text" name="name_sign" id="name_sign" value="<?php echo $name_sign; ?>" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-4">Title</label>
                      <div class="col-md-8">
                        <input type="text" name="title_hdr" id="title_hdr" value="<?php echo $title_hdr; ?>" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-actions">
                      <div class="row">
                        <div class="form-group">
                          ...
                          <div class="col-md-10">
                            <textarea rows="3" class="form-control autosize" name="remark_dtl" id="remark_dtl"><?php echo $remark_dtl; ?></textarea>
                          </div>
                        </div>
                        <div class="portlet-body">
