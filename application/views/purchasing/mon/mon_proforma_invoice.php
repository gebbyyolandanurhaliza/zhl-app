        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject theme-font bold">Monitoring Proforma Invoice</span>
            </div>
            <div class="tools">
              ...
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="col-md-2 label-sm">Main PI / SO</label>
                        <div class="col-md-7">
...
<script>
  function refresh() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>purchasing_mon/mon_proforma_invoice_filter_po?from=" + $from + "&to=" + $to + "&vendor=" + $vendor + "&stat=" + $status + "&sono=" + $sono + "&item=" + $item + "",
  ...
  function excel() {
    ...
    javascript: location.href = "<?php echo base_url(); ?>purchasing_mon/proforma_invoice_excel?from=" + $from + "&to=" + $to + "&vendor=" + $vendor + "&stat=" + $status + "&sono=" + $sono + "&item=" + $item + "";
