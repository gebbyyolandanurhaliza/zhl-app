...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <a class="btn btn-danger" href="<?php echo site_url('purchasing_po/purchase_order_delete?po='.$mainpo); ?>" onclick="javasciprt: return confirm('Are you sure delete PO <?php echo $mainpo; ?> ?')">Delete</a>
