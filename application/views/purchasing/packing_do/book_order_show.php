...
<div class="page-content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <form action="<?php echo site_url('Packing_do/save_book_ref/update'); ?>" method="post" class="form-horizontal" role="form">
          <?php
                        ...
                        <tbody id="tblList_1">
                          <?php foreach ($book as $x) { ?>
                            <tr onclick="deleterow(this)">
                              ...
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" name="SeqNo[]" value="<?php echo $x->nourut; ?>" style="width: 60px;"></td>
                              <td nowrap onclick="event.stopPropagation();return false;"><textarea rows="3" class="form-control autosizeme" readonly="" style="width: 300px;"><?php echo $x->vendorcompany; ?></textarea></td>
                              <td nowrap onclick="event.stopPropagation();return false;"><textarea name="vendor_address[]" rows="3" class="form-control autosizeme" style="width: 300px;"><?php echo $x->vendoraddress; ?></textarea></td>
                              ...
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" id="txtmainpo" class="form-control" name="txtmainpo[]" value="<?php echo $x->mainpo; ?>" style="width: 150px;"></td>
                              ...
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control" name="txtdesc[]" value="<?php echo $x->description; ?>" style="width: 100px;"></td>
                  ...
                  <div class="form-actions">
                    ...
                    <div class="col-md-6">
                      ...
                      <div>
                        ...
                        <a type="button" class="col-md-2 col-md-push-2 btn btn-info" href="<?php echo site_url('Packing_do/book_order_excel?bookref_no=' . $bookref_no . '&cust=' . $cust); ?>" target="_blank">Print</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      if (chk_arr[k].checked == true) {
        $('table[id="tblList"]').append('<tr onclick="deleterow(this)">\n\
                        <td><button class="btn btn-sm btn-danger" type="button" ><i class="fa fa-trash" ></i></button></td>\n\
                            ...
                            <td nowrap onclick="event.stopPropagation();return false;"><textarea name="vendor_address[]" rows="3" class="form-control autosizeme" style="width: 300px;">' + getText(document.getElementById('tbl-po_dtl').rows[i].cells[4]) + '</textarea></td>\n\
