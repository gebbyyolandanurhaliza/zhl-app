...
// //PENGATURAN MERGE CELL          
    ...
    for($i=1;$i<6;$i++){
     ...
     $objPHPExcel->getActiveSheet()->mergeCells('C10:M10');
...
//     // Apply style header yang telah kita buat tadi ke masing-masing kolom header
    ...
    $objPHPExcel->getActiveSheet()->getStyle('C1:M1')->applyFromArray($header1);
    for($i=2;$i<6;$i++){
        $objPHPExcel->getActiveSheet()->getStyle('C'.$i.':M'.$i)->applyFromArray($header2);

    }
    $objPHPExcel->getActiveSheet()->getStyle('A6:M6')->applyFromArray($garisheader1);
    $objPHPExcel->getActiveSheet()->getStyle('A8:M8')->applyFromArray($garisheader2);
    $objPHPExcel->getActiveSheet()->getStyle('A10:M10')->applyFromArray($header3);
    $objPHPExcel->getActiveSheet()->getStyle('B12:M12')->applyFromArray($style_col);
    ...
    $objPHPExcel->getActiveSheet()->getStyle('M12')->applyFromArray($style_col);
     ...
     $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('D12', 'GR Date')
                ->setCellValue('E12', 'Vendor Company')
                ->setCellValue('F12', 'Item ID')
                ->setCellValue('G12', 'Item Name')
                ->setCellValue('H12', 'Uom')
                ->setCellValue('I12', 'Qty')
                ->setCellValue('J12', 'Qty DO')
                ->setCellValue('K12', 'Qty Out Standing')
                ->setCellValue('L12', 'NPBB No')
                ->setCellValue('M12', 'Customer');
        ...
        foreach ($record as $r) {
                ...
                ->setCellValue('E'.$counter, $r->vendorcompany) 
                ->setCellValue('F'.$counter, $r->itemid)     
                ->setCellValue('G'.$counter, $r->itemname) 
                ->setCellValue('H'.$counter, $r->uomname) 
                ->setCellValue('I'.$counter, $r->qty) 
                ->setCellValue('J'.$counter, $r->qty_out) 
                ->setCellValue('K'.$counter, $r->qty_outstanding) 
                ->setCellValue('L'.$counter, $r->npbbno) 
                ->setCellValue('M'.$counter, $r->custcompany) ;
                 $counter++;
        }
        $a=$counter+1;
            $objPHPExcel->getActiveSheet()->mergeCells('B'.$a.':M'.$a);
