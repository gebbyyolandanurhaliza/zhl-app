      ...
      <div class="col-md-12">
        ...
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo site_url('Packing_do/delivery_oder_save/update'); ?>" method="post" class="form-horizontal" role="form">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-body">
                    <div class="row">
                        ...
                        <tbody>
                          ...
                          foreach ($gr as $x) { ?>
                            <tr onclick="deleterow(this)">
                              ...
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 140px;" name="NPBB[]" value="<?php echo $x->npbbno; ?>" readonly></td>
                  ...
                  <div class="form-actions">
                    <div class="col-md-6">
                      <a type="button" class="col-md-2 btn btn-default" href="<?php echo site_url('Packing_do/add_delivery_oder'); ?>">Add</a>
