<?php foreach ($lr as $r) {
    echo '<tr >';
    echo '<td nowrap>';
    echo '<a class="btn-sm btn-warning" title="Edit" href="' . site_url('Packing_do/loading_report_show?lr=' . $r->lrno) . '"><i class="fa fa-pencil"></i></a>'; ?>
...
<?php
    echo '<a type="button" title="Print" class="btn-sm btn-info" href="' . site_url('Packing_do/print_report_lr?lr=' . $r->lrno) . '" target="_blank"><i class="fa fa-print"></i></a>';
    echo '</td>';
