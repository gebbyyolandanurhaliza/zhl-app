      ...
      <div class="col-md-12">
        ...
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo site_url('Purchasing_do/delivery_oder_save/add'); ?>" method="post" class="form-horizontal" role="form">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-body">
                    <div class="row">
...
<script>
        ...
        $('table[id="tblList"]').append('<tr onclick="deleterow(this)">\n\
                        <td><button class="btn btn-sm btn-danger" type="button" ><i class="fa fa-trash" ></i></button></td>\n\
                           ...
                           <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 80px;" name="QtyWhs[]" value="' + getText(document.getElementById('tbl-po').rows[i].cells[8]) + '" readonly></td>\n\
                            ...
                            <td hidden nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 140px;" name="NPBB[]" value="' + getText(document.getElementById('tbl-po').rows[i].cells[12]) + '" readonly></td>\n\
  ...
  function filterporeplace() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>Purchasing_do/delivery_oder_gr?po=" + $findpo + "",
