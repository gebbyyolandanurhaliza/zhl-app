      ...
      <div class="col-md-12">
        <div class="portlet light">
          ...
          <div class="portlet-body form">
            <form action="<?php echo site_url('purchasing/vendor_save/update'); ?>" method="post" class="form-horizontal" role="form">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="col-md-6">
                      <div class="form-group" style="margin-bottom:1px;">
                        ...
                        <div class="col-md-3">
                          <input class="form-control input-sm" name="vendorid" value="<?php echo $supp->supplierid; ?>" required>
                        </div>
                      </div>
                      <div class="form-group " style="margin-bottom:1px;">
              ...
              <div class="form-actions">
                <div class="col-md-3 col-md-push-9">
                  ...
                  <a type="button" class="col-md-5 btn btn-default" href="<?php echo site_url('purchasing/vendor'); ?>">Cancel</a>
                </div>
              </div>
            </form>
          </div>
