...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <a class="btn btn-danger" href="<?php echo site_url('purchasing_lr/loading_report_delete?lr=' . $lrno); ?>" onclick="javasciprt: return confirm('Are you sure delete LR <?php echo $lrno; ?> ?')">Delete</a>
