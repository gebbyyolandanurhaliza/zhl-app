      ...
      <div class="col-md-12">
        ...
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo site_url('purchasing_lr/save_lr/add'); ?>" method="post" class="form-horizontal" role="form">
              <div class="row">
                <div class="col-md-9">
                  <div class="form-body">
                    <div class="row">
...
<script>
  ...
  function filtercust() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>purchasing_lr/sales_order_cust?cust=" + $findcust + "",
  ...
  function filterporeplace() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>purchasing_lr/loading_report_po_pl?cust=" + $cust + "&po=" + $findpo + "",
      success: function(response) {
        $("#tblpo").html(response);
      },
      dataType: "html"
...
<script type="text/javascript">
  function filterremark() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>purchasing_lr/loading_report_remark?remark=" + $taxc + "",
      success: function(response) {
