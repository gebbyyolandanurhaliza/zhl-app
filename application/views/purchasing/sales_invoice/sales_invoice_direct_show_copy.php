              ...
              <div class="row">
                <div class="col-md-9">
                  ...
                  <div class="form-actions">
                    <div class="col-md-6">
                      <button type="submit" class="col-md-2 btn btn-primary" id="btn-add">Add</button>
                      <a type="button" class="col-md-2 btn btn-default" href="<?php echo site_url('purchasing_inv/sales_invoice_direct'); ?>">Cancel</a>
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="portlet light">
                    <div class="portlet body">
                      <div class="form-group" style="margin-bottom:1px;">
                        ...
                        <div class="col-md-8">
                          <input class="form-control input-sm" name="invno" value="" readonly>
                        </div>
                      </div>
                      <div class="form-group" style="margin-bottom:1px;">
