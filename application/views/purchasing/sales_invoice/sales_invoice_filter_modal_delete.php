...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <a class="btn btn-danger" href="<?php echo site_url('purchasing_inv/sales_invoice_delete?inv='.$invno); ?>" onclick="javasciprt: return confirm('Are you sure delete Invoice <?php echo $invno; ?> ?')">Delete</a>
