      ...
      <div class="col-md-12">
        ...
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo site_url('purchasing_inv/sales_invoice_direct_save/update'); ?>" method="post" class="form-horizontal" role="form">
              <div class="row">
                <div class="col-md-9">
                  <div class="form-body">
                    <div class="row">
                    ...
                    <div class="table-scrollable" style='overflow: auto; height:300px;'>
                      <table class="table table-bordered" id="tblList">
                        <thead>
                          <tr>
                            <th><button class="btn btn-sm btn-primary" type="button" onclick="fnDialogItem()" id="btn-po"><i class="fa fa-arrow-down"></i></button></th>
                            <th>Item ID</th>
                            <th>Item Name</th>
                            <th>UOM</th>
                            <th>Qty</th>
                        ...
                        <tbody id="tblList_1">
                          ...
                          foreach ($inv as $x) { ?>
                            <tr onclick="deleterow(this)">
                              ...
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 250px;" name="ItemName[]" value="<?php echo htmlspecialchars($x->itemname, ENT_QUOTES); ?>"></td>
                              ...
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 80px;" name="Qty[]" value="<?php echo number_format($x->qty, 2, '.', ''); ?>"></td>
                              ...
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 140px;" name="PONO[]" value="<?php echo $x->pono; ?>" readonly></td>
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 100px;" name="UnitPrice[]" value="<?php echo number_format($x->unitprice, 4, '.', ''); ?>" onkeyup="calculate()"></td>
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" name="Comission[]" value="<?php echo number_format($x->comission, 2, '.', ''); ?>" onkeypress="return isNumber(event)" onkeyup="calculate()"></td>
                              ...
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 100px;" name="Total[]" value="<?php echo number_format($x->total, 2, '.', ''); ?>" onkeyup="caltot()"></td>
                  ...
                  <div class="form-actions">
                    <div class="col-md-6">
                      <a type="button" class="col-md-2 btn btn-default" href="<?php echo site_url('purchasing_inv/sales_invoice_direct'); ?>">Add</a>
                    ...
                    <div class="col-md-6">
                      ...
                      <div>
                        ...
                        <a type="button" class="col-md-2 col-md-push-2 btn btn-info" href="<?php echo site_url('purchasing_inv/sales_invoice_print?inv=' . $invno); ?>" target="_blank">Print</a>
                      </div>
                    </div>
                    <!--                                        <div class="col-md-2 col-md-push-5 btn-group">
                                            <button id="btn-print" type="button" class="col-md-10 btn btn-info dropdown-toggle" data-toggle="dropdown">
                                             Print  <i class="fa fa-angle-down"></i>
                                            </button>
                                            <ul class="dropdown-menu" role="menu" aria-labelledby="btn-print">
                                                <li>
                                                    <a href="<?php // echo site_url('purchasing_inv/sales_invoice_print/'.str_replace("/", ".slash",$invno));
                                                              ?>" target="blank">Sales Invoice</a>
                                                </li>
                                                <li>
                                                    <a href="<?php // echo site_url('purchasing_inv/sales_contract_print/'.str_replace("/", ".slash",$invno));
                                                              ?>" target="blank">Sales Contract</a>
                                                </li>
                                            </ul>
                                        </div>-->
                  </div>
                  ...
                  <div class="portlet light">
                    <div class="portlet body">
                      <div class="form-group" style="margin-bottom:1px;">
                        ...
                        <div class="col-md-8">
                          <input class="form-control input-sm" name="invno" value="<?php echo $invno; ?>" readonly>
                        </div>
                      </div>
                      <!--                                            <div class="form-group" style="margin-bottom:1px;">
