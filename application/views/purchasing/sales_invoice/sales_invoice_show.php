      ...
      <div class="col-md-12">
        ...
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo site_url('purchasing_inv/sales_invoice_save/update'); ?>" method="post" class="form-horizontal" role="form">
              <div class="row">
                <div class="col-md-9">
                  <div class="form-body">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group" style="margin-bottom:1px;">
                          ...
                          <div class="col-md-4">
                            ...
                            <!-- <input type="text" id="taxcode1" value="<?php echo $tax; ?>" hidden> -->
