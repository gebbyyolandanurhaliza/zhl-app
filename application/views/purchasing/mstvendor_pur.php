        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject theme-font bold">Master Vendor Purchasing</span>
            </div>
            <div class="tools">
          ...
          <div class="portlet-body form">
            <form action="<?php echo site_url('purchasing/pur_vendor_save/add'); ?>" method="post" class="form-horizontal" role="form">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="col-md-6">
                ...
                <tbody id="tbl-mon">
                  ...
                  foreach ($vendor as $r) { ?>
                    <tr style="cursor: pointer;">
                      <td nowrap>
                        <a class="btn-sm btn-warning" href="<?php echo site_url('purchasing/pur_vendor_edit?vendor=' . $r->vendorid); ?>"><i class="fa fa-pencil"></i></a>
                        <a class="btn-sm btn-danger" href="<?php echo site_url('purchasing/pur_vendor_delete?vendor=' . $r->vendorid); ?>" onclick="javasciprt: return confirm('Are you sure delete Company <?php echo $r->vendorcompany; ?> ?')"><i class="fa fa-trash"></i></a>
                      </td>
                      <td nowrap><?php echo $r->vendorid; ?></td>
                      <td nowrap><?php echo $r->vendorcompany; ?></td>
...
<script>
  function search() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>purchasing/vendor_search_pur?vendor=" + $search + "",
