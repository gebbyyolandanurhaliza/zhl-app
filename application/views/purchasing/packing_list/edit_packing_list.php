...
foreach ($so as $r) {
  ...
  $shipdate_pl = date("d-m-Y",  strtotime($r->shipdate_pl));
  $term        = $r->term;
  $termdays    = $r->termdays;
      ...
      <div class="col-md-12">
        ...
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo site_url('purchasing_pl/simpan_pl'); ?>" method="post" class="form-horizontal" role="form">
              <div class="row">
                <div class="col-md-9">
                  <div class="form-body">
                    <div class="row">
                      ...
                      <table class="table table-bordered" id="tblList">
                        <thead>
                          <tr>
                            ...
                            <th>Item Name</th>
                            <th>UOM</th>
                            <th hidden>UOM Alias</th>
                            <th>Quantity</th>
                            <th hidden>Quantity Alias</th>
                        ...
                        <tbody id="tblList_1">
                          <?php foreach ($so as $x) { ?>
                            <tr onclick="deleterow(this)">
                              ...
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 150px;" name="txtItemId[]" value="<?php echo $x->itemid; ?>" readonly> <input type="hidden" class="txt" name="txtIdgr[]" value="<?php echo $x->sono; ?>"></td>
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 250px;" name="txtItemName[]" value="<?php echo htmlspecialchars($x->descriptions, ENT_QUOTES); ?>" readonly></td>
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 60px;" value="<?php echo $x->uomname; ?>" readonly></td>
                              <td hidden nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" name="UOM_Alias[]" style="width: 60px;" value="<?php echo $x->uom_alias; ?>"></td>
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 80px;" name="txtItemQty[]" value="<?php echo number_format($x->qty, 3, '.', ''); ?>" readonly></td>
                              <td hidden nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 80px;" name="txtItemQty_Alias[]" value="<?php echo number_format($x->qty_alias, 3, '.', ''); ?>"></td>
                              <td hidden="" nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 140px;" name="txtItemNPBB[]" value="<?php echo $x->npbbno; ?>" readonly></td>
                              <td hidden nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 140px;" name="txtmainpo[]" value="<?php echo $x->mainpo; ?>" readonly></td>
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 80px;" name="txtItemNW[]" value="<?php echo number_format($x->neetweight, 3, '.', ''); ?>" onkeypress="return isNumber(event)" required=""></td>
                              <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 80px;" name="txtItemGW[]" value="<?php echo number_format($x->grossweight, 3, '.', ''); ?>" onkeypress="return isNumber(event)" required=""></td>
                            </tr>
                          <?php
                          }
                          ?>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group" style="margin-bottom:1px;">
                          ...
                          <div class="col-md-9">
                            <textarea rows="8" class="form-control autosizeme" name="packing"><?php echo $packing; ?></textarea>
                          </div>
                        </div>
                        <div class="form-group" style="margin-bottom:1px;">
                          <label class="col-md-3 label-sm">Total Packing</label>
                          <div class="col-md-9">
                            <input type="text" class="form-control input-sm" name="ttlpack" value="<?php echo $totalpack; ?>" id="ttlpack">
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-actions">
                    ...
                    <div class="col-md-6">
                      ...
                      <div>
                        <button type="button" class="col-md-2 col-md-push-2  btn btn-warning" onclick="fnDialogPL()">Find</button>
                        <a type="button" class="col-md-2 col-md-push-2 btn btn-info" href="<?php echo site_url('purchasing_pl/print_report_pl?pl=' . $sono); ?>" target="_blank">Print</a>
                        <a type="button" class="col-md-2 col-md-push-2 btn btn-info" href="<?php echo site_url('purchasing_pl/print_report_do?pl=' . $sono); ?>" target="_blank">Print DO</a>
                      </div>
                  ...
                  <div class="portlet light">
                    <div class="portlet body">
                      ...
                      <div class="form-group" style="margin-bottom:1px;">
                        ...
                        <div class="col-md-8">
                          <input name="shipdate" class="form-control input-sm date date-picker" data-date="02-12-2012" data-date-format="dd-mm-yyyy" value="<?php echo $shipdate_pl; ?>" required>
                        </div>
                      </div>
                      <div class="form-group" style="margin-bottom:1px;">
...
<script>
  ...
  function fnDialogPL() {
    $("#formdialogPL").html(" <div class='portlet-body'>\n\
                        <div class='col-md-12'>\n\
                            <div class='form-group'>\n\
                                 ...
                                 <button type='button' class='col-md-1 btn blue' onclick='filterpl()'>Search</button>\n\
                            </div>\n\
                        </div>\n\
                        <br><hr>\n\
  ...
  function filterpl() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>Purchasing_pl/filter_pl?inv=" + $findinv + "",
