                      ...
                      <?php foreach ($cont as $r) { ?>
                        <tr onclick="deleterow(this)">
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;"><select name="stuffing[]" readonly="<?php echo $r->stuffing; ?>">
                              <option><?php echo $r->stuffing; ?></option><!--<option value="Export Container">Export Container<option value="Local Container">Local Container</select>--></td>
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 150px;" name="container[]" value="<?php echo $r->container; ?>" required=""></td>
