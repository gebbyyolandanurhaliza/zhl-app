...
class PDF extends FPDF
{
	...
	function Content($_getInv){
		foreach($_getInv AS $m)
		{
			...
			if($m->currency == 'USD'){
				$this->cell(15, 6, $m->total, 1, 0, 'C', 1);
			}else{
				$this->cell(15, 6, ' ', 1, 0, 'C', 1);
			}

			if($m->currency == 'USD'||$m->freight == '0'){
			...
			if($m->currency == 'SGD'){
				$this->cell(13, 6, $m->maintotal, 1, 0, 'C', 1);
			}else{
				$this->cell(13, 6, '-', 1, 0, 'C', 1);
			}
			...
			if($m->currency == 'SGD'){
				$this->cell(10, 6, $m->totalbalance, 1, 1, 'C', 1);
			}else{
