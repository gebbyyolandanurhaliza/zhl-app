...
class PDF2 extends FPDF {
        function Header(){
            ...
            $this->SetX(20);
            $this->Cell(40,5,'Shipper/Carrier',1,0,'C',1);
            $this->SetX(60);
            ...
            $this->SetX(210);
            $this->Cell(40,5,'Destination',1,0,'C',1);
            $this->SetX(250);
    ...
    foreach ($_getcont as $r){
            ...
            $pdf->SetXY(165,$y);
            $pdf->MultiCell(20,5,$r->depot,0,'C');
            $pdf->SetXY(185,$y);
            $pdf->MultiCell(25,5,$r->pod,0,'C');
            $pdf->SetXY(210,$y);
            $pdf->MultiCell(40,5,$r->destination,0,'C');
            $pdf->SetXY(250,$y);
