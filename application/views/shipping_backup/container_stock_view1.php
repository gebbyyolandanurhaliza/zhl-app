						...
						<form action="<?php echo site_url('shipping/container_stock_save'); ?>" method="post" class="form-horizontal" role="form">
							<div class="form-body">
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="container_number" id="container_number" placeholder="Container Number" value="" /> <?php echo $data['container_number']?>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="free_time" id="free_time" placeholder="Free Time" value="" /><?php echo $data['free_time']?>
									</div>
									<span class="help-inline"></span>
								</div>								
								<div class="form-group">
									<label class="col-md-3 control-label" for="int">Arrival Date</label>
									<div class="col-md-5"><?php echo $data['arrival_date']?>
								...
								<div class="form-group">
									...
									<div class="col-md-5"><?php echo $data['free_time']?>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="Remark" id="Remark" placeholder="Remark" value="" /><?php echo $data['Remark']?>
									</div>
									<span class="help-inline"></span>
								</div>								
