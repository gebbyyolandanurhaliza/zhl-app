                            ...
                            <div class="form-body row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-control"><?php echo $quotation_number ?></label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="varchar">Customer Code</label>
                                        <div class="col-md-10">
                                            <label class="form-control" name="customer_code"><?php echo $customer_code ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <div id="div_customer">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <label class="form-control" name="customer_name"><?php echo $customer_name; ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <label class="form-control" name="customer_contact_name"><?php echo $customer_contact_name; ?></label>
                                            </div>

                                            <label class="col-md-2 control-label" for="varchar">Customer Ref. No.</label>
                                            <div class="col-md-4">
                                                <label class="form-control" name="customer_reference"><?php echo $customer_reference; ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4" id="trading_term_container">
                                            <?php
                                            $extra_tradingterm = 'disabled="disabled" class="form-control" ';
                                            $option_tradingterm[''] = '';
                                        ...
                                        <div class="col-md-4">
                                            <?php
                                            $extra_ship_from = 'disabled="disabled" class="form-control"';
                                            $option_ship_from[''] = '';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group" data-date-format="mm/yyyy" >
                                                <div class="input-group input-daterange" data-date="<?php echo $current_date ?>" data-date-format="mm/yyyy"
                                                     data-date-viewmode="years" data-date-minviewmode="months">
                                                    <input readonly type="text" class="form-control" name="shipping_period1" value="<?php echo $shipping_period1 ?>" title="date format : mm/yyyy">
                                                    <span class="input-group-addon" style="background: transparent; border-color: transparent">to</span>
                                                    <input readonly type="text" class="form-control" name="shipping_period2" value="<?php echo $shipping_period2; ?>" title="date format : mm/yyyy">
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <?php
                                            $extra_destination = 'disabled="disabled" id="destination_id" class="form-control"';
                                            $option_destination[''] = '';
                                        ...
                                        <div class="col-md-4">
                                            <div id="div_port">
                                                <?php
                                                $extra_port = 'disabled="disabled" id="port_id" class="form-control"';
                                                $option_port[''] = '';
...
//                                            });
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <?php
                                            $extra_container = 'disabled="disabled" id="container_id" class="form-control"';
                                            $option_container[''] = '';
                                        ...
                                        <div class="col-md-4">
                                            <?php
                                            $extra_shipping_mode = 'disabled="disabled" id="container_id" class="form-control"';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <?php
                                            $extra_currency = 'disabled="disabled" id= "local_currency" class="form-control"';
                                            $option_currency[''] = '';
                                        ...
                                        <div id="div_rate">
                                            <div class="col-md-3">
                                                <div id="div_rate_usd" class="input-group">
                                                    ...
                                                    <input readonly type="text" rate-set='0' class="form-control text-right autofocus" name="rate_usd" id="rate_usd" placeholder="0.000000" value="<?php echo $rate_usd; ?>" title="6 digits decimal" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div id="div_rate_sgd" class="input-group">
                                                    <span class='input-group-addon'>SIN$</span>
                                                    <input readonly type="text" class="form-control text-right autofocus" name="rate_sgd" id="rate_sgd" placeholder="0.000000" value="<?php echo $rate_sgd; ?>" title="6 digits decimal" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
//                                                    $('#div_rate').html(msg);
//
//													if ($('#rate_usd').attr('rate-set') < 0){
//														$.bootstrapGrowl('<i class="fa fa-danger"></i> Please ask Accounting Department to set up the currency rate.', {
...
//														$('#rate_usd').val('');
//														$('#rate_sgd').val('');
//														$('#local_currency').val('').trigger('change');
////														$('#local_currency').select2('val', '');
//														return false;
//													}
//                                                }
//                                            });
//                                        });
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-8">
											<?php
											$extra_sales = 'disabled="disabled" id= "sales_id" class="form-control"';
											$option_sales[''] = '';
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group " data-date-format="dd/mm/yyyy" >
                                                ...
                                                <label class="form-control" name="document_date"><?php echo $document_date; ?></label>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group" data-date-format="dd/mm/yyyy" >
                                                ...
                                                <label class="form-control" name="validity_date"><?php echo $validity_date; ?></label>
                                    ...
                                    <div class="agent-scroll">
                                        <table width="100%" id="tbl_agent" class="table table-detail">
                                            <thead>
                                                <tr>
                                                    <th></th>
                                                    <th width="50%" class="text-left">Agent Name</th>
													...
													if ($agent_list) {
														...
														foreach ($agent_list as $ag) {
															...
															<tr>
																...
																<td class="bg-editable">
																	<input type="text" value="<?php echo $ag->com_percent ?>" onkeyup="agent_percent()" class="form-control autonum_com_percent text-right" name="agent_com_percent[<?php echo $agc ?>]" id="agent_com_percent" data-a-sign=" %" data-p-sign="s" data-v-max="100" placeholder="0.00 %" />
																</td>
																<td class="bg-editable">
																	<input type="text" value="<?php echo $ag->com_unit ?>" onkeyup="agent_unit()" class="form-control autonum_com_unit text-right" name="agent_com_unit[<?php echo $agc ?>]" id="agent_com_unit" data-p-sign="s" placeholder="0.00"/>
																</td>
...
//                                                            echo '<span class="input-group-addon input-table-group-addon bootstrap-touchspin-postfix num">' . $last_count . '</span>';
                                                            echo '<span class="input-group-addon input-table-group-addon num">' . $last_count . '</span>';
                                                            echo '</div>';
															...
															echo '<input name="brand_name[]" id="brn-'. $last_count .'" value="'.$d->detail_brand_name.'" class="form-control input-xs input-table" placeholder="Select Brand" readonly="readonly" >';
//															echo '<input name="brand[]" value="'.$d->brand_name.'" class="form-control input-xs input-table" readonly="readonly">';
															...
															echo '<td class="w-100"><input name="uom[]" value="' . $d->cma_uom_quantity_id . '" class="form-control input-xs input-table text-center" readonly="readonly"></td>';
                                                            echo '<td class="w-100"><input name="price[]" value="' . $d->price . '" type="text" class="form-control input-xs text-right input-table autonum_price autofocus" readonly="readonly"></td>';
                                                            echo '<td class="w-100"><input name="qty[]" value="' . $d->quantity . '" type="text" class="form-control input-xs text-right input-table autonum_qty autofocus" data-v-min="0" readonly="readonly"></td>';
...
<!--                                            <a href="#modal_create" id="create_payterm" data-toggle="modal" class="pull-right" title="Create New Payment Term">
                                        ...
                                        <div class="col-md-10" id="payterm_container">
                                            <?php
                                            $extra_payterm = 'disabled="disabled" id="payment_term_id" class="form-control"';
                                            $option_payterm[''] = '';
...
<!--                                            <a href="#modal_create" id="create_shelf_life" data-toggle="modal" class="pull-right" title="Create New Shelf Life">
                                        ...
                                        <div class="col-md-4" id="shelf_life_container">
                                            <?php
                                            $extra_shelf = 'disabled="disabled" id="product_shelf_life_id" class="form-control"';
                                            $option_shelf[''] = '';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <?php
                                            $extra_partial_shipment = 'disabled="disabled" id="partial_shipment" class="form-control"';
                                        ...
                                        <div class="col-md-4">
                                            <?php
                                            $extra_marine_insurance = 'disabled="disabled" id="marine_insurance" class="form-control"';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <?php
                                            $extra_shipping_line = 'disabled="disabled" id="shipping_id" class="form-control"';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <textarea disabled="disabled" rows="3" class="form-control autosizeme" name="shipment_schedule" id="shipment_schedule"><?php echo $shipment_schedule; ?></textarea>
                                        </div>
                                    </div>
...
<!--                                            <a href="#modal_previous" id="previous_remark" data-toggle="modal" class="pull-right" title="Previous Remark">
                                        ...
                                        <div class="col-md-10">
                                            <textarea disabled="disabled" rows="5" class="form-control autosizeme" name="quotation_remark" id="quotation_remark"><?php echo $quotation_remark; ?></textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3" style="padding-right: 2px">
                                            ...
                                            <input type="text" class="form-control autonumber text-right" name="discount" id="discount" data-a-sign=" %" data-p-sign="s" data-v-max="100" placeholder="0.00 %" value="<?php echo $discount; ?>" readonly="readonly"/>
                                            <!--</div>-->
                                        </div>
                                        <div class="col-md-6" style="padding-left: 2px">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="padding-left: 2px">
                                            <input type="text" class="form-control autonumber text-right" name="freight" id="freight" value="<?php echo $freight; ?>" readonly="readonly"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="padding-left: 2px">
                                            <input type="text" class="form-control autonumber text-right" name="tax" id="tax" value="<?php echo $tax; ?>" readonly="readonly"/>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php  echo $btn_print ?>
										<?php // echo $btn_delete ?>
                                        <!--<a href="<?php // echo site_url('sales-quotation/issue') ?>" type="button" class="btn red pull-right"><i class="fa fa-close"></i> Close</a>-->
...
//					count += 1;
                ...
                $('#tbl_quotation > tbody:last-child').append(
                        '<tr>\n\
								...
								<td class="w-150"><input name="packing_size[]" value="' + getText(document.getElementById('tbl_product').rows[i].cells[9]) + '" class="form-control input-xs input-table" readonly="readonly"></td>\n\
								<td class="w-100"><input name="uom[]" value="' + getText(document.getElementById('tbl_product').rows[i].cells[6]) + '" class="form-control input-xs input-table text-center" readonly="readonly"></td>\n\
...
//				}
	...
	function validate()
	{
		var product_count =  document.getElementById("tbl_quotation").getElementsByTagName("tbody")[0].getElementsByTagName("tr").length;
