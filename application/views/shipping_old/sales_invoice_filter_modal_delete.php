...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
                    ...
                    <tbody>
                        ...
                        foreach ($inv as $r){ 
                            echo '<tr>';
                                ...
                                echo '<td>'.htmlspecialchars($r->productname,ENT_QUOTES).'</td>';
                                echo '<td>'.$r->uom_quantity_name.'</td>';
                                echo '<td>'.number_format($r->qty,2).'</td>';
                                echo '<td>'.number_format($r->unitprice,4).'</td>';
                            echo '</tr>';
                        $i++;}
                        ?>
                    </tbody>
        ...
        <div class="modal-footer">
            <a class="btn btn-danger" href="<?php echo site_url('shipping_inv/sales_invoice_delete?inv='.$invno); ?>" onclick="javasciprt: return confirm('Are you sure delete Invoice <?php echo $invno; ?> ?')">Delete</a>
