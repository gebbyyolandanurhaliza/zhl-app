						...
						<form action="<?php echo site_url('shipping/container_stock_save'); ?>" method="post" class="form-horizontal" role="form">
							<div class="form-body">
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="container_number" id="container_number" placeholder="Container Number" value="<?php echo $container_number->container_number; ?>" />
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="free_time" id="free_time" placeholder="Free Time" value="<?php echo $container_number->loading_port; ?>" />
									</div>
									<span class="help-inline"></span>
								</div>								
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
                                <input type="text" name="free_time" class="form-control date date-picker" value="<?php echo $container_number->free_time; ?>" data-date="2016/01/01" data-date-format="yyyy/mm/dd" required/>
									</div>
									<span class="help-inline"></span>
								</div>								
								<div class="form-group">
