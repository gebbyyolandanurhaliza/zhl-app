                    ...
                    <tbody id="tblList_1">
                      <?php foreach ($cont as $r) { ?>
                        <tr onclick="deleterow(this)">
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;"><input type="Text" name="stuffing[]" class="form-control input-sm" style="width: 150px;" value="<?= $r->stuffing; ?>" readonly>
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 150px;" name="container[]" value="<?php echo $r->container; ?>"></td>
