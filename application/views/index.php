...
<head>
	...
	<meta http-equiv="refresh" content="0;URL='http://sambu-sg.com/'" />
	...
	<!-- BEGIN THEME STYLES -->
	<link href="<?php echo base_url(); ?>asset/global/css/components-rounded.css" id="style_components" rel="stylesheet" type="text/css" />
	...
	<link href="<?php echo base_url(); ?>asset/admin/layout/css/custom.css?v=3" rel="stylesheet" type="text/css" />
	<!-- END THEME STYLES -->
...
<body class="login">
	...
	<div class="logo">
		<a href="index.html">
			<img src="<?php echo base_url(); ?>asset/admin/layout3/img/logo-big.png" alt="" />
		</a>
	</div>
	<!-- END LOGO -->
	...
	<div class="content">
		...
		<form class="login-form" action="<?php echo base_url(); ?>login/sign_in" method="post">
			...
			<div class="forget-password">
				...
				<p>
					Please not use Internet Explorer for this application.
				</p>
...
<![endif]-->
	...
	<script src="<?php echo base_url(); ?>asset/global/plugins/jquery-migrate.min.js" type="text/javascript"></script>
	...
	<script>
		jQuery(document).ready(function() {
			...
			$.backstretch([
				"<?php echo base_url(); ?>asset/admin/pages/media/bg/1.jpg",
				"<?php echo base_url(); ?>asset/admin/pages/media/bg/2.jpg",
				"<?php echo base_url(); ?>asset/admin/pages/media/bg/3.jpg",
				"<?php echo base_url(); ?>asset/admin/pages/media/bg/4.jpg"
			], {
				fade: 1000,
				duration: 8000
			});
