                    ...
                    <tbody id="tblList_1">
                      <?php foreach ($cont as $r) { ?>
                        <tr onclick="deleterow(this)">
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;"><!-- <input type="Text" name="stuffing[]" class="form-control input-sm" style="width: 150px;" value="<?= $r->stuffing; ?>" readonly></td> -->
                            <select name="stuffing[]">
                              <option></option>
                              <option value="Export Container" <?php if ($r->stuffing === "Export Container") {
                                                                  echo 'selected';
                                                                } ?>>Export Container
                              <option value="Local Container" <?php if ($r->stuffing === "Local Container") {
                                                                echo 'selected';
                                                              } ?>>Local Container
                            </select>
...
<script>
      ...
      if (chk_arr[k].checked == true) {
        var $new_row = $('<tr onclick="deleterow(this)">\n\
                                    <td><button class="btn btn-sm btn-danger" type="button" ><i class="fa fa-trash" ></i></button></td>\n\
                                        ...
                                        <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 150px;" name="stuffing[]" readonly value="' + getText(document.getElementById("tbl-po").rows[i].cells[15]) + '"></td>\n\
  ...
  function run_disable_buttom() {
    ...
    // var p = document.getElementById("prosess").value;
                            ...
                            <div class='form-group'>\n\
                                <input class='col-md-1 label-sm' type='Radio' name='axx' id='cekboxx' onclick='run_disable_buttom()'/>\n\
                                 ...
                                 <div class='col-md-10' id='tes'>\n\
                                        ...
                                        <input type='hidden' class='form-control input-sm' name='idstock' id='idstock'>\n\
                                 </div>\n\
  ...
  function savechangestock(x) {
    $idstock = $("#idstock").val();
    $url = "<?php echo base_url(); ?>shipping/container_inward_changestock?idold=" + x + "&idnew=" + $idstock;
    console.log($url);
    $id = '#ci-' + x;
    // $a = '-';
