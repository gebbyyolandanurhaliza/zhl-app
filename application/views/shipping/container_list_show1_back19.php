      ...
      <div id="formdialogContEdit" hidden>
        <div class='portlet-body'>
          ...
          <div class='col-md-6'>
            ...
            <button type='button' class='col-md-3 btn grey' onclick='fnDialogCont()'>Close</button>
          </div>
        </div>
...
<script>
  function fnDialogContainerChange(x, y) {
    $("#formdialogCont").html(" <div class='portlet-body'>\n\
                        <div class='col-md-12'>\n\
                            <div class='form-group'>\n\
                                <input class='col-md-1 label-sm' type='Radio' name='axx' id='cekbox' onclick='run_disable_buttom()' />\n\
                        ...
                        <div class='col-md-12'>\n\
                            <div class='form-group'>\n\
                                <input class='col-md-1 label-sm' type='Radio' name='axx' id='cekboxx' onclick='run_disable_buttom()' />\n\
                                 ...
                                 <div class='col-md-8'>\n\
                                        <input class='form-control input-sm' name='cb' id='cb' ondblclick='fnDialogContainerStock()' disabled>\n\
                                 </div>\n\
                                 <button type='button' class='col-md-2 btn blue' onclick='fnDialogContainerStock()' id='cd' name='cd' disabled>Save</button>\n\
                            </div>\n\
                        </div>\n\
                        <div class='col-md-6'>\n\
...
<script>
  ...
  function filterCI() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>shipping/container_po_outward?po_cout=" + $findCI + "",
      success: function(response) {
        $("#tblCI").html(response);
      },
      dataType: "html"
