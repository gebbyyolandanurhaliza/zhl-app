                      ...
                      <div class="form-group" style="margin-bottom:1px;">
                        ...
                        <div class="col-md-3">
                          <select class="form-control select2me" name="tipe">
                            <option value="3" <?php if ($hdr->tipe === "3") {
                                                echo 'selected';
                                              } ?>> Local Container
                            <option value="4" <?php if ($hdr->tipe === "4") {
                                                echo 'selected';
                                              } ?>> Local Empty
                            <option value="5" <?php if ($hdr->tipe === "5") {
                                                echo 'selected';
                                              } ?>> Local Laden
                            <option value="6" <?php if ($hdr->tipe === "6") {
                                                echo 'selected';
                                              } ?>> Import Return
                            <option value="7" <?php if ($hdr->tipe === "7") {
                                                echo 'selected';
                                              } ?>> Loose Cargo
                          </select>
                        </div>
                    ...
                    foreach ($tampildatadtl as $r) { ?>
                      <tr>
                        <td>
                          <?php
                          if ($r->bargejurnal == '') { ?>
                            <button class="btn btn-sm btn-danger" type="button" id="btn-delete" onclick="deleterow1(<?php echo $r->id; ?>)"><i class="fa fa-trash"></i></button>
                          <?php } else { ?> <?php } ?>
                        </td>
                        <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 50px" name="urut[]" value="<?php echo $i++; ?>"></td>
                        <td nowrap onclick="event.stopPropagation();return false;"><select name="stuffing[]">
                            ...
                            <option id="LO" value="LO" <?php if ($r->stuffing === "LO") {
                                                          echo 'selected';
                                                        } ?>>Loose Cargo
                          </select></td>
                        ...
                        <td nowrap onclick="event.stopPropagation();return false;">
                          <select class="form-control input-sm" name="customer[]">
                            <option value="<?php echo $r->customer; ?>"><?php echo $r->customer_name; ?></option>
                            <?php foreach ($supp as $k) { ?>
                              <option value="<?php echo $k->customer_code; ?>"><?php echo $k->customer_name; ?></option>
                            <?php } ?>
                          </select>
                        </td>
                        <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="text-align: center;" name="bill[]" value="<?php echo $r->bargejurnal; ?>" readonly></td>
...
<script>
    ...
    for ($i = 0; $i < $rowcount; $i++) {
      var $new_row = $('<tr onclick="deleterow(this)">\n\
                                    <td align="center"><button class="btn btn-sm btn-danger" type="button" ><i class="fa fa-trash" ></i></button></td>\n\
                                        ...
                                        <td nowrap onclick="event.stopPropagation();return false;" style="width: 100px;"><select name="stuffing[]" id="stuffing"><option value="LE" id="LE" onclick="">Local Empty <option value="LL" id="LL">Local Laden <option value="EI" id="EI">Empty Import<option value="LO" id="LO">Loose Cargo</select></td>\n\
                                        ...
                                        <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" name="supplier[]" value="" required></td>\n\
  ...
  function deleterow1(x) {
    ...
    if (confirm("Are you sure remove this row?") == true) {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>shipping/container_local_delete_modal?stock=" + x,
        success: function(response) {
          location.reload();
        },
        dataType: "html"
