				...
				<div class="portlet light">
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject theme-font bold uppercase">Container Actual Seal</span>
						</div>
					</div>
							...
							<tbody class="tbl-pete" id="tbl-pete">
								...
								<tr>
									<td style="text-align:center" width="100px">
                                     <a class="btn-sm btn-warning" href="<?php echo site_url('shipping/container_actual_seal_show?cont='.$country->contid.'&shipmentdate='.$country->shipmentdate.'&factory='.$country->etd); ?>"><i class="fa fa-pencil"></i></a>
									</td>
