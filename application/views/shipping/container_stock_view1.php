						...
						<form action="<?php echo site_url('shipping/container_stock_save'); ?>" method="post" class="form-horizontal" role="form">
							<div class="form-body">
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="container_number" id="container_number" placeholder="Container Number" value="<?php echo $container_number->container_number; ?>" required/>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="loading_port" id="loading_port" placeholder="Free Time" value="<?php echo $container_number->loading_port; ?>" />
									</div>
									<span class="help-inline"></span>
								</div>								
								<div class="form-group">
									...
									<div class="col-md-5">
                                <input type="text" name="arrival_date" class="form-control date date-picker" value="<?php echo $container_number->arrival_date; ?>" data-date="2016/01/01" data-date-format="yyyy/mm/dd" required/>
									</div>
									<span class="help-inline"></span>
								</div>								
								<div class="form-group">
									...
									<div class="col-md-5">
                                <input type="Number" name="free_time" class="form-control" value="<?php echo $container_number->free_time; ?>" placeholder="Free Time" required/>
									</div>
									<span class="help-inline"></span>
								</div>								
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="Remark" id="Remark" placeholder="Remark" value="<?php echo $container_number->Remark; ?>" />
									</div>
									<span class="help-inline"></span>
								</div>								
								<div class="form-group">
									...
									<div class="col-md-5">
										<SELECT name="factory" class="form-control" value="<?php echo $container_number->factory; ?>">
										<option><?php echo $container_number->factory; ?></option>
