                                        ...
                                        foreach ($bukadatasolas as $x){?>
                                            <tr>
                                                <td align='center' style='vertical-align: top;'>
                                                    <a class="btn btn-success" id="btn-excel" name="action" target="_blank" href="<?php echo site_url('Solas/PrintSolas?Id='.$x->transID.'&Fac=RSUP'); ?>"><i class="fa fa-eye"> View Solas Detail</i></a>
                                                    <a class="btn btn-primary" id="btn-excel" name="action" target="_blank" href="<?php echo site_url('Solas/PrintSolasPDF?Id='.$x->transID.'&Fac=RSUP'); ?>"><i class="fa fa-print"> Print Solas</i></a>
                                                </td>
