                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          ...
                          <select name="etd" class="form-control input-sm" id="etd">
                            ...
                            <option id="PSKE" value="PSKE" <?php if ($r->etd === "PSKE") {
                                                              echo 'selected';
                ...
                <div class="table-scrollable" style="overflow: auto; height: 550px;">
                  <table class="table table-bordered" id="tblList">
                    ...
                    <tbody id="tblList_1">
                      ...
                      $i = 1;
                      foreach ($cont as $r) {
                        $weight1 = $r->total_gross_weight + $r->tare_weight;
                      ?>
      ...
      if (chk_arr[k].checked == true) {
        var $new_row = $('<tr onclick="deleterow1(this)">\n\
                                    <td><button class="btn btn-sm btn-danger" type="button" ><i class="fa fa-trash" ></i></button></td>\n\
                                        ...
                                        <td nowrap onclick="event.stopPropagation();return false;"><select name="stuffing[]" id="stuffing"><option value="EE" id="EE" onclick="">Export Empty <option value="EL" id="EL">Export Laden <option value="IL" id="IL">Import Laden <option value="IT" id="IT">Import Transhipment <option value="LC" id="LC">Local container <option value="RE" id="RE">Recall container <option value="ELTP" id="ELTP">Export Empty</select></td>\n\
