			...
			<div class="col-md-12">
				...
				<div class="portlet light">
					...
					<div class="portlet-body form">
						<form action="<?php echo site_url('shipping/container_stock_save_comeback'); ?>" method="post" class="form-horizontal" role="form">
							<?php foreach($tampildatahdr as $set):?>
							<div class="form-body">
									<div class="form-group">
									<label class="col-md-2 control-label" for="int">Loading Port</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="loading_port" id="loading_port" placeholder="Loading Port" value="<?php echo $set->loading_port?>" readonly/>
									</div>
                                ...
                                ?>
                                <input type="text" name="arrival_date" class="form-control date date-picker" value="<?php echo $tgl_arv; ?>" id="arrival_date" data-date-format="dd/mm/yyyy" placeholder="Arrival Date" required readonly/>
									</div>
									<span class="help-inline"></span>
								</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <SELECT name="factory" class="form-control" value="<?php echo $set->factory; ?>" readonly>
									...
									<div class="col-md-3">
                                <input type="text" class="form-control" id="free_time" name="free_time" id="free_time" value="<?php echo $set->free_time?>" placeholder="Free Time" class="form-control autonumber" onfocus="this.value = '';" onkeyup="hitungSelisihHari2()" onkeypress="return isNumber(event)" required readonly/>
									</div>
                                    <label class="col-md-2 control-label" for="int">Supplier</label>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="supplier" id="supplier" placeholder="Supplier" value="<?php echo $set->supplier; ?>" readonly/>
                                    </div>
                                    ...
                                    ?>
                                    <input type="text" name="free_time_expiry" class="form-control" value="<?php echo $tfr; ?>" id="free_time_expiry" readonly="" required readonly/>
                                    </div>
                                    <span class="help-inline"></span>
									<span class="help-inline"></span>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" name="import_bl_no" id="Remark" placeholder="BL NO" value="<?php echo $set->import_bl_no; ?>" readonly/>
									</div>
									<span class="help-inline"></span>
									<label class="col-md-2 control-label" for="date">Estimation Date Arrival</label>
									<div class="col-md-3">
                                    <?php 
                                        // set tanggal disini
                                    ...
                                    ?>
	                                <input type="text" name="eta" class="form-control date date-picker" value="<?php echo $tgl_eta; ?>" data-date-format="dd/mm/yyyy" required readonly/>
									</div>
									<span class="help-inline"></span>
								</div>
										...
										<input type="hidden" class="form-control" name="stock_id_hdr" id="stock_id_hdr" value="<?php echo $set->stock_id_hdr?>" />
										   <?php foreach ($tampildatadtl as $r){?>
                                                <tr onclick="deleterow(this)">
                                                    ...
                                                    <input type="hidden" class="form-control" name="container_id[]" id="container_id" value="<?php echo $r->container_id; ?>" readonly/>
                                                    
                                                    </td>
                                                    <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="" name="container_number[]" value="<?php echo $r->container_number; ?>" readonly>
                                                    </td>
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-offset-10 col-md-5">
                                        ...
                                        <a class="btn btn-primary green" href="<?php echo base_url(); ?>shipping/comeback_container_stock"><i class="fa fa-refresh"> Back </i></a>
<!--                                         <a class="btn btn-primary red" href="<?php echo base_url(); ?>shipping/container_print_stock?stock=<?php echo $this->input->get('stock'); ?>" target="_BLANK"><i class="fa fa-file-excel-o"> Print </i></a> -->
