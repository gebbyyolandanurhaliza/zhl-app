              ...
              <div class="row">
                <div class="col-md-9">
                  <div class="form-body">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group" style="margin-bottom:1px;">
                          ...
                          <div class="col-md-4 col-md-push-3">
                            <input type="text" name="duedate" id="duedate" onchange="Termdate()" class="form-control input-sm date date-picker" data-date="02-12-2012" data-date-format="dd-mm-yyyy" value="<?php echo $duedate; ?>" required>
                          </div>
                        </div>
                        <div class="form-group" style="margin-bottom:1px;">
                          ...
                          foreach ($inv as $x) {
                            if ($totalbefore != 0) { ?>
                              <tr>
                                ...
                                <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 100px;" name="UnitPrice[]" value="<?php echo number_format($x->unitprice, 2, '.', ''); ?>" onkeypress="return isNumber(event)" onkeyup="calculate()"></td>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group" style="margin-bottom:1px;">
                          <label class="col-md-12 label-sm">Remark</label>
                        </div>
                        <div class="form-group" style="margin-bottom:1px;">
                          <div class="col-md-12">
                        ...
                        <div class="form-group" style="margin-bottom:1px;">
                          <label class="col-md-12 label-sm">Bank Detail</label>
                        </div>
                        <div class="form-group" style="margin-bottom:1px;">
                          <div class="col-md-12">
                            <textarea rows="7" class="form-control" name="paymentto" id="paymentto"><?php echo $paymentto; ?></textarea>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-offset-1 col-md-5 well">
                        ...
                        <div class="form-group" style="margin-bottom:1px;">
                          <label class="col-md-6 col-md-push-1 label-sm">Advance Payment</label>
                  ...
                  <!--                                    <div class="form-actions">
                                        <div class="col-md-6">
                                            <a type="button" class="col-md-2 btn btn-default" href="<?php // echo site_url('shipping_inv'); 
                                                                                                    ?>">Add</a>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div>
                                                ...
                                                <a type="button" class="col-md-2 col-md-push-1 btn btn-info" href="<?php // echo site_url('shipping_inv/sales_invoice_print?inv='.$invno);
                  ...
                  <div class="portlet light">
                    <div class="portlet body">
                      ...
                      <div class="form-group" style="margin-bottom:1px;">
                        ...
                        <div class="col-md-8">
                          <textarea rows="3" class="form-control" name="term" style="resize: none;height: 167px;" id="term"><?php echo $term; ?></textarea>
                        </div>
                      </div>
                      <div class="form-group" style="margin-bottom:1px;">
    ...
    for (k = 0; k < chk_length; k++) {
      if (chk_arr[k].checked == true) {
        $('table[id="tblList"]').append('<tr onclick="deleterow(this)">\n\
                            ...
                            <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm text-right" style="width: 100px;" name="UnitPrice[]" value="' + getText(document.getElementById('tbl-po').rows[i].cells[8]) + '" onkeypress="return isNumber(event)" onkeyup="calculate()"></td>\n\
