                    ...
                    <div class="form-group" style="margin-bottom:1px;">
                      ...
                      <div class="col-md-3">
                        <select class="form-control select2me" name="tipe">
                          ...
                          <option value="4">Local Empty</option>
                          <option value="5">Local Laden</option>
                          <option value="6">Import Return</option>
                          <option value="7">Loose Cargo</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group" style="margin-bottom:1px;">
                    ...
                    <div class="form-group" style="margin-bottom:1px;">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <select class="form-control input-sm" name="etd" required>
                            <option></option>
                            <option value="SINGAPORE" id="SINetd">Singapore</option>
                            <option value="RSUP" id="RSUPetd">Riau Sakti United Plantation</option>
                            <option value="PSG" id="PSGetd">Pulau Sambu Guntung</option>
                          </select>
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <select class="form-control input-sm" name="eta">
                            <option></option>
                            <option value="SINGAPORE" id="SINeta">Singapore</option>
