                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group" style="margin-bottom:1px;">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input class="form-control input-sm" placeholder="ETD" name="etd">
                    ...
                    <div class="form-group" style="margin-bottom:1px;">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          <input class="form-control input-sm" placeholder="ETA" name="eta">
                          <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
      ...
      if (chk_arr[k].checked == true) {
        var $new_row = $('<tr onclick="deleterow(this)">\n\
                                    <td><button class="btn btn-sm btn-danger" type="button" ><i class="fa fa-trash" ></i></button></td>\n\
                                        ...
                                        <td nowrap onclick="event.stopPropagation();return false;"><select name="stuffing[]"><option></option><option value="Export Container">Export Container <option value="Local Container">Local Container</select></td>\n\
