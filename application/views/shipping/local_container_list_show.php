...
<div class="page-content" id="oke">
  <div class="container-fluid">
    ...
    <div class="row">
                    ...
                    <div class="form-group" style="margin-bottom:1px;">
                      ...
                      <div class="col-md-7">
                        <div class="input-group">
                          ...
                          <select name="etd" class="form-control input-sm">
                      ...
                      foreach ($cont as $r) { ?>
                        ...
                        <tr>
                          <td>
                            <?php
                            if ($r->proses != 1) { ?>
                              <button class="btn btn-sm btn-danger" type="button" id="btn-delete" onclick="deleterow(<?= $r->detail_id; ?>)"><i class="fa fa-trash"></i></button>
                              <button class="btn btn-sm green" type="button" id="btn-change-ship" onclick="changerow(<?= $r->id; ?>, <?= $r->flag; ?>)"><i class="fa fa-refresh"></i></button>
                            <?php } else { ?> <?php } ?>
                          </td>
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;"><select name="stuffing[]">
                              ...
                              <option id="LD" value="LD" <?php if ($r->stuffing === "LD") {
                                                            echo 'selected';
                                                          } ?>>Local Laden
                            </select></td>
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="width: 100px;" name="supplier_supp[]" value="<?php echo $r->supplier_supp; ?>"></td>
      ...
      <div id="formdialogContMove" hidden></div>
...
<script>
      ...
      if (chk_arr[k].checked == true) {
        var $new_row = $('<tr onclick="deleterow(this)">\n\
                                    <td><button class="btn btn-sm btn-danger" type="button" ><i class="fa fa-trash" ></i></button></td>\n\
                                        ...
                                        <td nowrap onclick="event.stopPropagation();return false;" style="width: 100px;"><select name="stuffing[]" id="stuffing"><option value="LE" id="LE" onclick="">Local Empty <option value="LD" id="LD">Local Laden </select></td>\n\
  ...
  function changerow(x, y) {
    $("#formdialogContMove").html(" <div class='portlet-body'>\n\
                        <div class='col-md-12'>\n\
                            <div class='form-group'>\n\
                                 ...
                                 <div class='col-md-10' id='tesss'>\n\
                                        <select class='form-control select2me' name='shipdate' id='shipdate'>\n\
                                            <?php foreach ($getship2 as $get) : ?>\n\
                                                  <option value='<?php echo $get->contid; ?>'><?php echo $get->shipmentdate; ?> / <?php echo $get->voyage; ?> / <?php echo $get->barge; ?> / <?php echo $get->etd; ?> To <?php echo $get->eta; ?> </option>\n\
                                            <?php endforeach; ?>\n\
                                        </select>\n\
                                 </div>\n\
                        ...
                        <div class='col-md-7'>\n\
                        <br>\n\
                            <button type='button' class='col-md-4 btn red' onclick='formdialogContMove()'>Close</button>\n\
                        </div>\n\
                </div>");
