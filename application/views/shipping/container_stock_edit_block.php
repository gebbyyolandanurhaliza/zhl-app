				...
				<div class="portlet light">
					...
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject theme-font bold uppercase">Container View</span>
						</div>
						<div class="tools">
						...
						<form action="<?php echo site_url('shipping/container_stock_save'); ?>" method="post" class="form-horizontal" role="form">
							...
							<div class="form-body">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="factory" id="factory" placeholder="factory" value="<?php echo $set->factory?>" readonly />
                                    </div>
										...
										<input type="hidden" class="form-control" name="stock_id_hdr" id="stock_id_hdr" value="<?php echo $set->stock_id_hdr?>" />
										   <?php foreach ($tampildatadtl as $r){?>
                                                <tr onclick="deleterow(this)">
                                                    ...
                                                    <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" style="" name="Remark[]" value="<?php echo $r->Remark; ?>" readonly>
                                                    </td>
                                                </tr>
                                           <?php } ?>
                                        </tbody>
