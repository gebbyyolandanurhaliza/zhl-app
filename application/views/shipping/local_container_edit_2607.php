                      ...
                      <div class="form-group" style="margin-bottom:1px;">
                        ...
                        <div class="col-md-3">
                          <select class="form-control select2me" name="tipe">
                            <option value="<?php echo $hdr->tipe; ?>">Local Container</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group" style="margin-bottom:1px;">
                      ...
                      <div class="form-group" style="margin-bottom:1px;">
                        ...
                        <div class="col-md-7">
                          <div class="input-group">
                            <input class="form-control input-sm" placeholder="ETD" name="etd" value="<?php echo $hdr->etd; ?>" readonly="">
                        ...
                        <div class="col-md-7">
                          <div class="input-group">
                            <select class="form-control input-sm" name="eta">
                              <option id="PSG" value="PSG" <?php if ($hdr->eta === "PSG") {
                                                              echo 'selected';
                                                            } ?>>PSG
                              <option id="RSUP" value="RSUP" <?php if ($hdr->eta === "RSUP") {
                                                                echo 'selected';
                                                              } ?>>RSUP
                            </select>
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
          ...
          <div class="portlet-body">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input type="text" class="form-control" data-placeholder="container" id="container">
                </div>
                <button type="button" class="col-md-2 btn blue" onclick="filterContainerLocal()">Search</button>
              </div>
            </div>
            <br>
            <hr>
      ...
      if (chk_arr[k].checked == true) {
        var $new_row = $('<tr onclick="deleterow(this)">\n\
                                    <td align="center"><button class="btn btn-sm btn-danger" type="button" ><i class="fa fa-trash" ></i></button></td>\n\
                                        ...
                                        <td nowrap onclick="event.stopPropagation();return false;"><input type="text" class="form-control input-sm" name="supplier[]" value=""></td>\n\
                                        <td hidden></td>\n\
                                        <td hidden></td>\n\
                                        <td hidden></td>\n\
                                </tr>');
