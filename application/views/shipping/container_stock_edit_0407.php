							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-offset-8 col-md-5">
                                        ...
                                        <a class="btn btn-primary green" href="<?php echo base_url(); ?>shipping/container_stock_excel?stock=<?php echo $this->input->get('stock'); ?>" target="_BLANK"><i class="fa fa-file-excel-o"> Excel </i></a>
