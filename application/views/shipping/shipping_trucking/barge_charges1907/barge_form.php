<script>
    function hidden_pricetag(){
        $invtype = $("#chargestype").val();
                    ...
                    <div class="portlet-body form">
                        <form action="<?php echo $action; ?>" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-default">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <label class="control-label col-md-2">Charges Type </label>
                                            <div class="col-md-4">
                                                <select name="chargestype" id="chargestype" class="form-control select2me" onclick="hidden_pricetag()" required>
                                                    <option value=" "></option>
                                                    <option value="ERTDIIT" <?php if($chargestype === 'ERTDIIT'){echo 'SELECTED';} ?>>Export Round Trip Dry - Including Import Transhipment</option>
                                                    <option value="ERTR" <?php if($chargestype === 'ERTR'){echo 'SELECTED';} ?>>Export Round Trip Reefer</option>
                                                    <option value="LCEL" <?php if($chargestype === 'LCEL'){echo 'SELECTED';} ?>>Local Container - Empty/Laden</option>
                                                    <option value="Loose" <?php if($chargestype === 'Loose'){echo 'SELECTED';} ?>>Loose Cargo</option>
                                                    <option value="RC" <?php if($chargestype === 'RC'){echo 'SELECTED';} ?>>Return Container</option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <?php
                                if ($chargestype ===''){ ?>
                                <div class="form-group" id="pricetag" hidden>
                                    <div class="col-md-6">
                                        <div class="panel panel-default">
