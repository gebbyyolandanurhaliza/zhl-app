			...
			<div class="col-md-12">
				...
				<div class="portlet light">
					<div class="portlet-title">
						...
						<div class="actions">
							<?php echo anchor(site_url('shipping_trucking/add'), '<i class="fa fa-plus"></i> Create New Trucking Prices', 'class="btn btn-primary"'); ?>
						</div>
					</div>
							...
							<table id="tblmst_barge" class="table table-bordered table-striped table-condensed" >
							    <thead>
                                    <tr>
                                        ...
                                        <th colspan="8">Vendor's Price</th>
                                        <th colspan="8">Customer's Price</th>
