						...
						<form action="<?php echo site_url('shipping/container_stock_save'); ?>" method="post" class="form-horizontal" role="form">
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
                                <input type="text" name="arrival_date" class="form-control date date-picker" value="<?php echo $set->arrival_date?>" id="arrival_date" data-date-format="dd/mm/yyyy" placeholder="Arrival Date" required/>
									</div>
									<span class="help-inline"></span>
								</div>								
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
	                                <input type="text" name="eta" class="form-control date date-picker" value="<?php echo $set->eta; ?>" data-date-format="dd/mm/yyyy" required/>
									</div>
									<span class="help-inline"></span>
								</div>								
								<div class="form-group">
									...
									<div class="col-md-5">
	                                <input type="text" name="free_time_expiry" class="form-control" value="<?php echo $set->free_time_expiry; ?>" id="free_time_expiry" readonly="" required/>
									</div>
									<span class="help-inline"></span>
								</div>
