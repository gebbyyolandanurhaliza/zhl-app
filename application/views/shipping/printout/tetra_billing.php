...
$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('B2', 'Vessel (Barge) - ' . $hdr->barge)
...
$counter++;
    ...
    $objPHPExcel->getActiveSheet()->getStyle('H'.$counter)->getFont()->setBold( true );
    $objPHPExcel->getActiveSheet()->getStyle('I' . $counter)->applyFromArray($style_col_right);
    $objPHPExcel->getActiveSheet()->getStyle('J' . $counter)->applyFromArray($style_col_right);
...
header('Content-Disposition: attachment;filename="TETRAPAK-LADEN ' . $hdr->shipmentdate . '.xlsx"');
