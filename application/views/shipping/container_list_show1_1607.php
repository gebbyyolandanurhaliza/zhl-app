                        ...
                        <tr onclick="deleterow(this)">
                          <td <?php
                              if ($r->proses != 1) {
                                ...
                                echo '<button class="btn btn-sm green" type="button" id="btn-change-ship"><i class="fa fa-refresh"></i></button>';
                              } else {
                          ...
                          ?>
                            <td nowrap onclick="event.stopPropagation();return false;"><input onclick="fnDialogContainerChange(<?= $r->detail_id; ?>, <?php echo "'" . $r->container . "'"; ?>)" type="text" class="form-control input-sm" style="width: 150px;" name="container[]" id="ci-<?= $r->detail_id; ?>" value="<?php echo $r->container; ?>" readonly=""></td>
                          <?php
                          }
                          ?>
