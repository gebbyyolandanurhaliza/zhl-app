                    ...
                    <tbody id="tblList_1">
                      ...
                      foreach ($cont as $r) { ?>
                        <tr onclick="deleterow(this)">
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;"><select name="stuffing[]" id="stuffing-<?= $i; ?>" class="form-control input-sm select2me">
                              ...
                              <option id="EE_TP-<?= $i; ?>" value="EE_TP" <?php if ($r->stuffing === "EE_TP") {
                                                                            echo 'selected';
                                                                          } ?>>Export Empty (TP)
                            </select></td>
