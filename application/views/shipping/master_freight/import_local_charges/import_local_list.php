				...
				<div class="portlet light">
					<div class="portlet-title">
						<div class="caption">
							...
							<span class="caption-subject theme-font uppercase">Master Import Local Charges</span>
						</div>
						<div class="actions">
							<?php echo anchor(site_url('master_import_local/add'), '<i class="fa fa-plus"></i> Create New Import Local Charges', 'class="btn btn-primary"'); ?>
						</div>
					</div>

					<div class="portlet-body flip-scroll">
						<div class="table-scrollable-borderless">
							<table id="tblmst_import_local" class="table table-bordered table-striped table-condensed" >
							    <thead>
                                    <tr>
                                        <th rowspan="2">ID</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        var t = $("#tblmst_import_local").dataTable({
            initComplete : function(){
                var api = this.api();
                $('#tblmst_import_local_filter input')
                    .off('.DT')
            ...
            serverside : true,
            ajax : {
                "url" : "<?php echo site_url('master_import_local/json');?>",
				"type" : "POST"
            },
            columns :
            [
