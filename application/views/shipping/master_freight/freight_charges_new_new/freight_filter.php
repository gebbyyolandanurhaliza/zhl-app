                                ...
                                <?php } ?>
                                   <td class="center" width='3%'><?php echo $xx->customer_name ?></td>
                                    ...
                                    <td width='6%' nowrap><?php echo $xx->container_name ?></td>
                                    <td width='6%'><?php echo $xx->cust_rates ?> </td>  
                                    <td align="center " width='6%'><b><a style="color: green"><?php echo $exp.' '.$comf; ?></td>                                   
                            <!--         <td width='6%'><?php echo $xx->cust_rates ?></td> -->
