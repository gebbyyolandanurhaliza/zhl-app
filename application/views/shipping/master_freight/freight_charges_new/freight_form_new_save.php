                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
				                                ...
				                                <div class="form-group">
				                                    ...
				                                    <div class="col-md-3">
			                                            <input type="checkbox" name="comfirm" id="comfirm_yes" value="1"><i style="color: green;"> Yes </i>
			                                           	<input type="checkbox" name="comfirm" id="comfirm_no" value="0"><i style="color: red;"> No </i>		 
				                                    </div>
				                                </div>
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-12">
										...
										<a href="<?php echo site_url('master-freight-new/edit/'.$freight_charges_id) ?>" class="btn red w-100"><i class="fa fa-close"></i> Cancel</a>
									</div>
								</div>
							</div>
                        </form>
...
<script>
    ...
    $(document).ready(function(){
        ...
        console.log(comfirm_yes);
        console.log(comfirm_no);

        if(comfirm_no == 0){
				$('#comfirm_no').prop('checked', true);
        }else{
				$('#comfirm_no').prop('checked', false);
        	}
    });
