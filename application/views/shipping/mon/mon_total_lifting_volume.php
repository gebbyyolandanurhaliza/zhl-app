...
foreach ($total as $r){
    ...
    echo '<tr style="cursor: pointer;background:#e0e0e8;">';}else{
        echo '<tr style="cursor: pointer;">';
    }

        if($r->urut==='1'){
                echo '<td nowrap class="text-center">'.$no++.'</td>';
        }else{
                echo '<td nowrap></td>';    
        }
        ...
        echo '<td nowrap class="text-center">'.$tot1.'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->jan1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->feb1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->mar1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->apr1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->mei1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->jun1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->jul1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->ags1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->sep1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->okt1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->nov1).'</td>';
        ...
        echo '<td nowrap class="text-center" width="100px">'.($r->dec1).'</td>';
