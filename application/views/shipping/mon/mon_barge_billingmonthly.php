                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-4">
                        ...
                        <a href="<?php echo base_url(); ?>shipping_mon/excel_stuffingmonthly?dari=<?php echo $dari; ?>&sampai=<?php echo $sampai; ?>&factory=<?php echo $factory; ?>&type=<?php echo $type; ?> " class="btn green col-md-3"><i class="fa fa-file-excel-o"></i>excel</a>
