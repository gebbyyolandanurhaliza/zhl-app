                    ...
                    <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <div class="input-group">
                              ...
                              <select class="form-control select2me" data-placeholder="Factory" name="factory" id="factory">
                                <option value="status">Status Container Stock</option>
                      ...
                      <div class="col-md-12" id="ref">
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <input class="form-control input-sm" type="text" value="<?php echo $container_number; ?>" id="container_number">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
...
<script>
  function refresh() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>shipping_mon/mon_container_stock_filter?factory_tipe=" + $factory_tipe + "&order_by=" + $order_by + "&dari=" + $dari + "&sampai=" + $sampai + "&container_number" + $container_number,
  ...
  function excel() {
    ...
    javascript: location.href = "<?php echo base_url(); ?>shipping_mon/container_stock_report?factory_tipe=" + $factory_tipe + "&order_by=" + $order_by + "&dari=" + $dari + "&sampai=" + $sampai + "&container_number=" + $container_number;
