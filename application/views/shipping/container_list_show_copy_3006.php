                    ...
                    <tbody id="tblList_1">
                      <?php foreach ($cont as $r) { ?>
                        <tr onclick="deleterow(this)">
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;"><input onclick="fnDialogContainerStock()" type="text" class="form-control input-sm" style="width: 150px;" name="container[]" value="<?php echo $r->container; ?>"></td>
