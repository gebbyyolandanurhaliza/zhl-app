                      ...
                      <?php foreach ($cont as $r) { ?>
                        <tr onclick="deleterow(this)">
                          ...
                          <td nowrap onclick="event.stopPropagation();return false;">
                            <input type="text" class="form-control input-sm" style="width: 150px;" onclick="fnDialogContainerChange(<?= $r->detail_id; ?>, <?php echo "'" . $r->container . "'"; ?>)" name="container[]" value="" id="ci-<?= $r->detail_id; ?>" readonly>
                            <input type="hidden" id="stock_id_dtl" value="">
                          </td>
...
<script>
  ...
  function save_change(x) {
    ...
    $url2 = "<?php echo base_url(); ?>shipping/container_inward_changestock2?container=" + ca + "&id=" + x + "&contid=" + countid + "&tipe=" + tipe;
    console.log($url2);

    $.ajax({
      url: "<?php echo base_url(); ?>shipping/container_inward_changestock2?container=" + ca + "&id=" + x + "&contid=" + countid + "&tipe=" + tipe,
      success: function(response) {
