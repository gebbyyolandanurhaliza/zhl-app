      ...
      <form action="<?php echo base_url(); ?>index.php/Receivable_recognition/save_receivable_rec" name="form1" id="form1" method="post">
        <div class="col-md-12">
          ...
          <div class="portlet light">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <input type="text" name="tgl_invoice" id="tanggal_invoice" class="form-control date date-picker" onchange="get_cur();Rate_notfound();" value="<?php echo $date_invoice; ?>" data-date-format="dd/mm/yyyy" <?php echo $readonly; ?> required />
                      </div>
                    </div>
                    <div class="form-group">
            ...
            <?php if ($this->input->get('id') <> '') { ?>
              <a class="btn btn-primary  kanan" id="cetak" href="<?php echo base_url(); ?>index.php/Receivable_recognition/print_report?id=<?php echo htmlspecialchars($this->input->get('id'), ENT_QUOTES); ?>&cur=<?php echo $currency_id; ?>&signature=Mr.Fok Yew Hon Henry" target="_blank"><i class="fa fa-print"></i> Print</a>
