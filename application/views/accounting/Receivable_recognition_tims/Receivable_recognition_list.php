    ...
    <div class="row">
      <div class="col-md-6">
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Receivable_recognition_tims/search" method="get">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      ...
                      <a href="<?php echo base_url('Receivable_recognition_tims/merged_pdf?dari='.$dari.'&sampai='.$sampai.'&invoice='.$invoice.'&supplier='.$supplier); ?>" class="btn btn-primary"
                          <?php echo empty($search_active) ? 'disabled' : ''; ?>>
                          <i class="fa fa-file-pdf-o"></i> Merged
                      </a>

                      <a href="<?php echo base_url('Excel/toExcelRRGT?dari='.$dari.'&sampai='.$sampai.'&invoice='.$invoice.'&supplier='.$supplier); ?>" class="btn btn-success"
                          <?php echo empty($search_active) ? 'disabled' : ''; ?>>
      ...
      <div class="col-md-6">
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Receivable_recognition_tims/edit" method="get">
              <div class="row">
                <div class="col-md-12">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption">
              <span class="caption-subject theme-font">Receivable Recognition List TIMS</span>
            </div>
            <div class="form-group">
              <a type="reset" class="btn btn-primary kanan" href="<?php echo base_url(); ?>Receivable_recognition_tims/add_new"><i class="fa fa-plus"></i> Create New</a>
            </div>
          </div>
          <div class="portlet-body">
              ...
              <tbody>
                ...
                ?>
                    <tr onclick="pilih(this)" style="cursor: pointer;">
                      ...
                      <td><?php echo $s->namacustomer; ?></td>
                      <td><?php echo $s->currency; ?></td>
                      <td style="text-align: right"><?php echo $s->rate; ?></td>
                      <td style="text-align: right"><?php echo number_format($s->piutang, 2, ".", ","); ?></td>
                      <td style="text-align: right"><?php echo number_format($s->piutang * $s->rate, 2, ".", ","); ?></td>
