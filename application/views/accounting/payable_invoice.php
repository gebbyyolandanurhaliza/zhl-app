...
<div class="page-head">
  <div class="container-fluid">
    ...
    <div class="page-title">
      <h1>Accounting Report <small>Accounts of Payable Invoice</small></h1>
    </div>
    <!-- END PAGE TITLE -->
  </div>
</div>
            ...
            <table class="table table-bordered" id="tabel">
              ...
              <tbody>
                ...
                foreach ($GroupSupplierID as $row_suplier) {
                  echo "<tr><td colspan='10' nowrap='' style='text-align:left;font-weight:bold;background-color:#ddd;'>$row_suplier->suppliercompany</td></tr>";
                  echo "<tr><td colspan='10' nowrap='' style='text-align:left;font-weight:bold;background-color:#ddd;'>$row_suplier->address</td></tr>";
