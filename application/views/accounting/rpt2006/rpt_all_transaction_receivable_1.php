...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->setFillColor(255, 255, 255);
        $this->Cell(90);
        $this->cell(25, 6, 'Receivable Invoice Transaction For Period '.date('d-m-Y', strtotime($this->dari)).' to '.date('d-m-Y', strtotime($this->sampai)), 0, 0, 'C', 1);
        $this->Ln();
    ...
    function Content($_tampil_item) {        
        ...
        foreach ($_tampil_item as $m) {
            ...
            $this->cell(37, 6, $m->namacustomer, 'BTRL', 0, 'L', 1);
            $this->cell(11, 6, $m->currency, 'BTRL', 0, 'L', 1);
            ...
            $this->cell(15, 6, number_format($m->piutang, 2), 'BTRL', 0, 'R', 1);
        ...
        $this->cell(15, 6, number_format($total_piutang, 2), 'BTRL', 0, 'R', 1);
