...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->setFillColor(255, 255, 255);
        $this->Cell(90);
        $this->cell(25, 6, 'Accounts Payable Invoice '.date('m-Y', strtotime($this->periode)), 0, 0, 'C', 1);
        $this->Ln();
        $this->setFont('Arial', 'B', 6);
    ...
    function Content($get_data_detail) {        
        ...
        foreach ($get_data_detail as $key) {
            ...
            $this->cell(15, 6, number_format($key->hutang, 2), 'BTRL', 0, 'R', 1);
            $this->cell(13, 6, number_format($key->rate_awal, 6, ',', '.'), 'BTRL', 0, 'R', 1);
