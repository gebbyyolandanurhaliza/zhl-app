              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <a type="reset" class="btn btn-primary kanan" href="<?php echo base_url(); ?>Sales_invoice_journal_pur/addnew"><i class="fa fa-plus"></i> Create New</a>
                  </div>
                </div>
              </div>
              <hr />
                ...
                <tbody>
                  ...
                  if (!empty($getList)) {
                    foreach ($getList as $s) {
                      ...
                      $tgl_tempo = date_format(date_create($s->tanggal_tempo), "F, d Y");
...
<script>
  function pilih(x) {
    ...
    window.location.href = url + "sales_invoice_journal_pur/edit?id=" + InvoiceNumber + "&supp=" + vendor + "&cur=" + currency;
  }
</script>