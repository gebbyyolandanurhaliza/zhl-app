                ...
                <div class="form-body ">
                  <div class="row">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <a target="_blank" href="<?php echo base_url(); ?>Gst_report\toExcelGst_report?dari=<?php echo $this->input->get('dari'); ?>&sampai=<?php echo $this->input->get('sampai'); ?>&client=<?php echo $this->input->get('client'); ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
