  ...
  <div class="col-md-12">
    <div class="portlet light">
      ...
      <div class="portlet-body">
        <form action="<?php echo site_url(); ?>KursNew/update_kurs_sgd_new" method="post">
          <section class="">
            ...
            <table class="table table-bordered " id="tabel_coa" width="100%">
              ...
              <!-- <tbody>
                <tr>
                  ...
                  foreach ($_cur as $r) {
                    $usd = $this->M_KursNew->get_ratesgd($r->currency_id, $this->uri->segment(3));
                  ...
                  <tr>
                    ...
                    foreach ($_cur as $r) {
                        if (in_array($r->currency_id, $allowed_currencies)) {
                            $usd = $this->M_KursNew->get_ratesgd($r->currency_id, $this->uri->segment(3));
                            echo "<td width='9%'>
                                    <input type='text' id='period' name='$r->currency_id' class='txt' value='" . (!empty($usd) ? $usd->rate_kurs : '0') . "' onkeypress='return isNumber(event)' required>
                                  </td>";
                        }
                    }
                    ?>
