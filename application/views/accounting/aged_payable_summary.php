...
<div class="page-head">
  <div class="container-fluid">
    ...
    <div class="page-title">
      <h1>Accounting Report <small>Aged Payable Summary</small></h1>
    </div>
    <!-- END PAGE TITLE -->
  </div>
</div>
        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject theme-font">Aged Payable Summary</span>
            </div>
            <div class="tools">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Aged_Payable_Summary/search" method="get">
              <div class="portlet-body">
                <div class="form-body">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <a href="<?php echo base_url(); ?>Excel/toExcelAgedPayableSummary?period=<?php echo $this->input->get('period'); ?>&supplier=<?php echo $this->input->get('supplier'); ?>&currency=<?php echo $this->input->get('currency'); ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
                      <a href="<?php echo base_url(); ?>Aged_Payable_Summary/print_report?period=<?php echo $this->input->get('period'); ?>&supplier=<?php echo $this->input->get('supplier'); ?>&currency=<?php echo $this->input->get('currency'); ?>" class="btn btn-primary" target="_blank"><i class="fa fa-print"></i> Print</a>
                      <hr />
                    </div>
