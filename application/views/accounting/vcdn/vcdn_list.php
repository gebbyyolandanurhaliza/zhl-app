...
<div class="page-content">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>vcdn/search" method="get">
              <div class="row">
                <div class="col-md-12">
                  <div class="col-md-6">
      ...
      <form action="<?php echo base_url(); ?>index.php/vcdn/save_payable_rec" method="post">
        <div class="col-md-12">
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption">
            ...
            <div class="portlet-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <a type="reset" class="btn btn-primary kanan" href="<?php echo base_url(); ?>index.php/vcdn/add_new"><i class="fa fa-plus"></i> Create New</a>
                  </div>
                </div>
              </div>
              <hr />
                ...
                <tbody>
                  ...
                  ?>
                      <tr onclick="pilih(this)" style="cursor: pointer;">
                        ...
                        <td style="text-align: right"><?php echo number_format($s->total, 2, ".", ","); ?></td>
                        <td style="text-align: right"><?php echo number_format($s->total * $s->currency_rate, 2, ".", ","); ?></td>
...
<script>
  function pilih(x) {
    ...
    window.location.href = url + "index.php/vcdn/edit?id=" + encodeURIComponent(InvoiceNumber) + "&jenis=" + encodeURIComponent(Jenis);
  }
</script>