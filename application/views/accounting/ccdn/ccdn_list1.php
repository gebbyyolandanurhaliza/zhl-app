                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-2">
                        ...
                        <a href="<?php echo base_url(); ?>ccdn/print_ccdn?invoice=<?php echo $this->input->get('invoice'); ?>&dari=<?php echo $this->input->get('dari'); ?>&sampai=<?php echo $this->input->get('sampai'); ?>" target='_blank' class="btn btn-primary"><i class="fa fa-print"></i> Print PDF</a>
                      </div>
                    </div>
                  </div>
                </div>
