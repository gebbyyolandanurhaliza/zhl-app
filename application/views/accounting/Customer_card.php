              ...
              <div class="form-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url(); ?>Customers_card/toPrintCustomerCard?supplier=<?php echo $supplier; ?>&coa=<?php echo $coa; ?>&currency=<?php echo $cur; ?>&dari=<?php echo $awal; ?>&sampai=<?php echo $akhir; ?>" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                    <hr />
                  </div>
                </div>
              </div>
