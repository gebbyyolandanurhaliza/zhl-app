              ...
              <div class="form-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url(); ?>Receivable_statement/toExcel?period=<?php echo $period; ?>&supplier=<?php echo $this->input->get('supplier'); ?>&currency=<?php echo $this->input->get('currency'); ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
                    <a href="<?php echo base_url(); ?>Receivable_statement/print_report?period=<?php echo $period; ?>&supplier=<?php echo $this->input->get('supplier'); ?>&currency=<?php echo $this->input->get('currency'); ?>" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                    <hr />
          ...
          ?>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped table-condensed flip-content" id="tabel">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td style="text-align: left;"><?php if (!empty($v->tmp_inv_date)) {
                                                    echo date('d-M', strtotime($v->tmp_inv_date));
                                                  } ?></td>
                    <td><?php echo $v->tmp_invno; ?></td>
                    <td style="text-align: left;"><?php if (!empty($v->tmp_due_date)) {
                                                    echo date('d-M', strtotime($v->tmp_due_date));
                                                  } ?></td>
                    ...
                    <td style="text-align: right;"><?php if (!empty($v->tmp_realisasi_date)) {
                                                      echo $tanggal;
                                                    } ?></td>
