    ...
    <div class="row">
      <div class="col-md-6">
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Payable_recognition/search" method="get">
              <div class="row">
                <div class="col-md-12">
      ...
      <div class="col-md-6">
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Payable_recognition/edit" method="get">
              <div class="row">
                <div class="col-md-12">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption">
              <span class="caption-subject theme-font">Payable Recognition List</span>
            </div>
            <div class="form-group">
              <a type="reset" class="btn btn-primary kanan" href="<?php echo base_url(); ?>payable_recognition/add_new"><i class="fa fa-plus"></i> Create New</a>
            </div>
          </div>
          <div class="portlet-body">
...
<script>
  function pilih(x) {
    ...
    //window.open(url + "Payable_recognition/edit?id=" + InvoiceNumber + "");
    window.location.href = url + "Payable_recognition/edit?id=" + InvoiceNumber + "";
  }
</script>