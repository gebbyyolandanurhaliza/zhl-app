<div class="page-content">
  <div class="container">
    ...
    <div class="row">
      <form action="<?php echo base_url(); ?>index.php/AP_invoice/save_payable_rec" method="post">
        ...
        <div class="col-md-12">
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption">
                <span class="caption-subject theme-font">A/P Invoice List</span>
              </div>
              <div class="tools">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <a type="reset" class="btn btn-primary kanan" href="<?php echo base_url(); ?>index.php/AP_invoice/add_new"><i class="fa fa-plus"></i> Create New</a>
                  </div>
                </div>
              </div>
              <hr />
...
<script>
  function pilih(x) {
    ...
    window.location.href = url + "index.php/AP_invoice/edit?id=" + InvoiceNumber + "&sup=" + sup + "&cur=" + cur;
  }
</script>