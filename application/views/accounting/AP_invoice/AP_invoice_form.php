...
<script>
  ...
  function ambil_tabel() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>index.php/AP_invoice/cek_tabel?id=" + refno,
...
<div class="page-content">
  <div class="container">
    ...
    <div class="row">
      <form action="<?php echo base_url(); ?>index.php/AP_invoice/save_ap_invoice" method="post">
        <div class="col-md-12">
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption">
                <i class="fa fa-credit-card theme-font"></i>
                <span class="caption-subject theme-font">A/P Invoice</span>
              </div>
              <div class="tools">
            ...
            <div class="portlet-body">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><input type="text" class="txt jr_rate" style="text-align: right;" name="rate[]" onkeypress="isNumber()" value="<?php echo number_format($v->Rate, 6, '.', ','); ?>" /></td>
                        ...
                        <td style="display:none"><input type="text" class="txt jr_bruto" onkeypress="return isNumber(event)" style="text-align: right;" id="bruto[]" name="bayarin[]" value="<?php echo number_format($v->rate * $v->hutang, 2, '.', ','); ?>" /></td>
                      </tr>
              ...
              <a class="btn btn-warning" href="<?php echo base_url(); ?>index.php/AP_invoice"><i class="fa fa-warning"></i> Cancel</a>
              <?php if ($this->input->get('id') <> '') { ?>
                <a class="btn btn-primary  kanan" href="<?php echo base_url(); ?>index.php/AP_invoice/print_report?id=<?php echo $this->input->get('id'); ?>" target="_blank"><i class="fa fa-print"></i> Print</a>
                <a class="btn btn-danger kanan" href="<?php echo base_url(); ?>index.php/AP_invoice/delete_transaction?id=<?php echo $this->input->get('id'); ?>" onclick="return confirm('Are you sure to delete this transaction?')"><i class="fa fa-trash"></i> Delete</a>
              <?php } ?>
          ...
          <tbody>
            ...
            ?>
                <tr id="sour<?php echo $no++; ?>" onclick="hitung_total()">
                  ...
                  <td width="100px"><input type="text" class="txt jr_rate" onkeypress="isNumber()" style="text-align: right;" name="rate[]" value="<?php echo number_format($v->rate, 6, '.', ','); ?>" /></td>
                  <td width="110px"><input type="hidden" class="txt jr_hutang" onkeypress="isNumber()" style="text-align: right;" name="hutang[]" value="<?php echo $v->hutang; ?>" /><?php echo number_format($v->hutang, 2, '.', ','); ?></td>
                  <td width="110px"><input type="text" class="txt jr_bayar" onkeypress="isNumber()" name="bayar[]" style="text-align: right;" onkeyup="hitung_bayar()" value="<?php echo number_format($v->TotalPayment, 2, '.', ','); ?>" /></td>
                  <td style="display:none"><input type="text" class="txt jr_bruto" onkeypress="isNumber()" style="text-align: right;" value="<?php echo $v->rate * $v->hutang; ?>" /></td>
                </tr>
            <?php
              }
            }
