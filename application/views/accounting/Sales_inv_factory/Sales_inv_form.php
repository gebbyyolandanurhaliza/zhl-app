...
<script>
  ...
  function gettanggal() {
    ...
    if ($inv === 'bar') {
      ...
      // get_port();            
    } else if ($inv === 'lem' || $inv === 'eim' || $inv === 'tet') {
      $ft = $('#dest_barge').val();
      $ur = "<?php echo base_url(); ?>Sales_inv/getAjaxTanggal?jeninv=" + $inv + "&bargedest=" + $ft;
      console.log($ur);
      $.ajax({
  ...
  function getDetailContainer() {
    ...
    var url3 = "<?php echo base_url(); ?>Sales_inv/get_detail3?date=" + $tgl + "&invtype=" + $invtype + "&bargedest=" + $bargedest + "&sup=" + $sup;
  ...
  function getDetailContainertrucking() {
    ...
    var url3 = "<?php echo base_url(); ?>Sales_inv/get_detail4?date=" + $tgl + "&invtype=" + $invtype + "&bargedest=" + $bargedest + "&sup=" + $sup;
    console.log(url3);
    $.ajax({
      url: url3,
      success: function(response) {
  ...
  function getsup() {
    ...
    if ($jenis === 'bar') {
      if (!$('#dest_barge').val() && $("#tanggal_invoice").val()) {
        ...
        var url2 = "<?php echo base_url(); ?>Sales_inv/get_detail2?date=" + tgl + "&invtype=" + $invtype + "&bargedest=" + $bargedest + "&sup=" + $sup;
  ...
  function cekbarge() {
    $inv = $("#invtype").val();
    if ($inv === 'bar' || $inv === 'lem' || $inv === 'eim' || $inv === 'tet') {
      $("#bargedest").show();
      $("#diveta").show();
      $("#divetd").show();
      // $("#divbuyer").hide();
  ...
  function geteta2() {
    $destbarge = $("#dest_barge").val();
    $tglshipment = $("#tanggal_shipment").val();
    $url = "<?php echo base_url(); ?>Sales_inv/geteta2?destbarge=" + $destbarge + "&shipdate=" + $tglshipment;
  ...
  function getetd2() {
    $destbarge = $("#dest_barge").val();
    $tglshipment = $("#tanggal_shipment").val();
    $url = "<?php echo base_url(); ?>Sales_inv/getetd2?destbarge=" + $destbarge + "&shipdate=" + $tglshipment;
  ...
  function getbarge2() {
    $destbarge = $("#dest_barge").val();
    $tglshipment = $("#tanggal_shipment").val();
    $url = "<?php echo base_url(); ?>Sales_inv/getbarge2?destbarge=" + $destbarge + "&shipdate=" + $tglshipment;
  ...
  function printfre() {
    ...
    $url = "<?= base_url(); ?>Sales_inv/printpreview_detail?tgl=" + $tgl;
    console.log($url);
...
<div class="page-content">
  <div class="container">
    ...
    <div class="row">
      <form action="<?php echo base_url(); ?>Sales_inv/save_sales_inv" onsubmit="return validate(this);" method="post">
              ...
              <div class="form-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <?php
                    if ($jenis_in === 'bar' || $jenis_in === 'lem' || $jenis_in === 'eim' || $jenis_in === 'tet') {
                ...
                <div class="modal-dialog modal-full">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a id="cetak" href="<?php echo base_url(); ?>Sales_inv/print_cont?id=<?= $nofaktur; ?>" class="btn btn-success" target="_blank"><i class="fa fa-print"></i> Print</a>
                    </div>
                  </div>
                  <!-- /.modal-content -->
                </div>
 ...
 -->
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          <?php $sales = "sales";
                          if ($r->NoCOA == '400103') {
                            $sales = "Handling Income (Transfort)";
                          } ?>
                        ...
                        <td>
                          <input type="text" name="unit[]" class="txt unit number" id="unit-<?= $i; ?>" value="<?= $r->unit; ?>" onchange='hitung_total(<?= $i; ?>)'>
                        </td>
            ...
            <a id="cetak" href="<?php echo base_url(); ?>Sales_inv/printerin?id=<?= $nofaktur; ?>&inv=<?= $jenis_in; ?>&signature=Mr. Tahir Aziz" class="btn btn-success" target="_blank"><i class="fa fa-print"></i> Print</a>
            <?php if ($this->input->get('id') <> '') { ?>
              ...
              <script type="text/javascript">
                function ganti_signature() {
                  ...
                  cetak.href = locSnip + "printerin?id=<?= $nofaktur; ?>&signature=" + locAppend;
                }
              </script>
            <?php } ?>
          </div>
