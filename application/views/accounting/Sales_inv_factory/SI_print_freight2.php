...
<page oreintation="portrait" format="A4">
    <img src="<?=base_url(); ?>assets/zhl-kop.PNG" style="width: 100%; height: 130px;">
    <table cellpadding="0" cellspacing="0" style="border: 0px; width:740px;">
        ...
        <tr>
            <td style="width:100px; text-align: left; vertical-align: top; font-weight: bold;" rowspan="4">Addres</td>
