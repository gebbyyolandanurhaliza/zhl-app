    ...
    <div class="row">
      <div class="col-md-6">
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Sales_inv/search" method="get">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      ...
                      echo form_dropdown('supplier', $customer, "$supplier", $style_kategori);
                      ?>
                    </div>
                  </div>
                  <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Sales_inv_factory/edit" method="get">
              <div class="row">
                <div class="col-md-12">
      ...
      <div class="col-md-12">
        <div class="portlet light">
          <div class="portlet-title">
            ...
            <div class="form-group">
              <a type="reset" class="btn btn-primary kanan" href="<?php echo base_url(); ?>Sales_inv/add_new"><i class="fa fa-plus"></i> Create New</a>
            </div>
          </div>
          <div class="portlet-body">
...
<script>
  function pilih(x) {
    ...
    window.location.href = url + "Sales_inv/edit?id=" + InvoiceNumber + "";
  }
</script>