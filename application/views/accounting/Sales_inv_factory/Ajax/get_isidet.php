...
?>
            ...
            foreach ($_detail as $r) {
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            $stuff = '';
                            if($r->stuffing == 'EE'){$stuff = 'Export Empty';}else if($r->stuffing == 'EL'){$stuff = 'Export Laden';}else if($r->stuffing == 'IT'){$stuff = 'Import Transhipment';}else if($r->stuffing == 'IL'){$stuff = 'Import Laden';}else if($r->stuffing == 'RE'){$stuff = 'Recall Container';}else if($r->stuffing == 'LO'){$stuff = 'Loose Cargo';}
                            echo $stuff;
                        ?>
                    ...
                    <td>
                        <input type="text" name="unit[]" class="txt unit" id="unit-<?=$i; ?>" value="<?=$r->Jumlah_container; ?>" onchange="hitung_total(<?=$i;?>)" > </td>
                    </td>
                    <td>
            ...
            foreach ($_detail2 as $r) {
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            $stuff = '';
                            if($r->stuffing == 'LE'){$stuff = 'Local Empty';}else if($r->stuffing == 'LL'){$stuff = 'Local Laden';}else if($r->stuffing == 'EI'){$stuff = 'Empty Import';}else if($r->stuffing == 'LO'){$stuff = 'Loose Cargo';}
                            echo $stuff;
                        ?>
                        <input type="hidden" name="jenisbarge[]" value='<?=$r->stuffing; ?>' id="jenisbarge-<?=$i; ?>" class='jenisbarge'>
                    </td>
    ...
    ?>
                <tr>
                    <td>
                        ...
                        <input type="text" name="accNum[]" class="txt accNum" id="accNum-<?=$i; ?>" value="400103">
                    </td>
                    <td>
                        <input type="text" name="accName[]" class="txt accName" id="accName-<?=$i; ?>" value="Handling Income (Transfort)">
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="text" name="unit[]" class="txt unit" id="unit-<?=$i; ?>" value="<?=$ft20; ?>" readonly> </td>
                    </td>
                    <td>
                        <div id="isi-<?=$i; ?>"><input type="text" name="txtHarga[]" class="txt number txtHarga" id="txtHarga-<?=$i; ?>" onchange="hitung_total(<?=$i; ?>)" value="0" ></div>
                    </td>
    ...
    ?>
                <tr>
                    ...
                    <td>
                        <input type="text" name="unit[]" class="txt unit" id="unit-<?=$i; ?>" value="<?=$ft40; ?>" readonly> </td>
                    </td>
                    <td>
                        <div id="isi-<?=$i; ?>"><input type="text" name="txtHarga[]" class="txt number txtHarga" id="txtHarga-<?=$i; ?>" onchange="hitung_total(<?=$i; ?>)" value="0" ></div>
                    </td>
            ...
            foreach ($_detail2 as $r) {
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            $stuff = '';
                            if($r->stuffing == 'LE'){$stuff = 'Local Empty';}else if($r->stuffing == 'LL'){$stuff = 'Local Laden';}else if($r->stuffing == 'EI'){$stuff = 'Empty Import';}
                            echo $stuff;
                        ?>
                        <input type="hidden" name="jenisbarge[]" value='<?=$r->stuffing; ?>' id="jenisbarge-<?=$i; ?>" class='jenisbarge'>
                    </td>
