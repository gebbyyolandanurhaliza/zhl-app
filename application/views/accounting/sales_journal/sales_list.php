        ...
        <div class="col-md-12">
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption">
                <span class="caption-subject theme-font">Sales Invoice Journal (Customer) List</span>
              </div>
              <div class="tools">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <a type="reset" class="btn btn-primary kanan" href="<?php echo base_url(); ?>Sales_invoice_journal/addnew"><i class="fa fa-plus"></i> Create New</a>
                  </div>
                </div>
              </div>
              <hr />
                ...
                <tbody>
                  ...
                  ?>
                      <tr onclick="pilih(this)" style="cursor: pointer;">
                        ...
                        <td><?php echo $tgl_tempo; ?></td>
                        <td><?php echo $s->namacustomer; ?></td>
                        <td><?php echo $s->currency; ?></td>
                        <td><?php echo $s->rate; ?></td>
                        <td><?php echo $s->piutang; ?></td>
                        <td><?php echo $s->piutang * $s->rate; ?></td>
...
<script>
  function pilih(x) {
    ...
    var currency = getText(document.getElementById('tabel').rows[$r].cells[5]);

    window.location.href = url + "sales_invoice_journal/edit?id=" + InvoiceNumber + "&supp=" + vendor + "&cur=" + currency;
  }
</script>