                    ...
                    <table class="table table-bordered" id="tabel">
                      ...
                      <tbody>
                        ...
                        foreach ($Get_supplier as $key_supplier) {
                          echo "<tr><td colspan='14' nowrap='' style='text-align:left;font-weight:bold;background-color:#ddd;'>$key_supplier->namavendor</td></tr>";
                          echo "<tr><td colspan='14' nowrap='' style='text-align:left;font-weight:bold;background-color:#ddd;'>$key_supplier->address</td></tr>";
                          $no = 1;
                          $totalpajak = 0;
                          $totaldiskon = 0;
                          $totalbiayalain = 0;
