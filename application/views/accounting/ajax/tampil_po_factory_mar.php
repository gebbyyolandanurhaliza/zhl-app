        ...
        $("#tabel_gl tbody tr").on("click", function (event) {
            ...
            if (!ok) {
                ...
                $('#tabel tr:last').after('<tr id="dest' + theid + '"><td><button class="tombol" onclick="hapus_dp(this)" >Remove</button></td>\n\
                    ...
                    <td><input type="text" class="txt number quantity" onKeyup="hitung_amount()" name="txtQty[]" value="' + $(this).find("td").eq(3).html() + '"></td>\n\
                    <td hidden><input type="text" class="txt txtRate " name="txtRate[]" value="' + $(this).find("td").eq(10).html() + '"></td>\n\
                    ...
                    <td><input type="text" class="txt number prices" name="txtunitprice[]" onKeyup="hitung_amount()" value="' + $(this).find("td").eq(4).html() + '"></td>\n\
                    <td><input type="text" class="txt number amount" name="txtamount[]" onKeyup="hitung_total()" value="' + $(this).find("td").eq(5).html() + '"></td>\n\
