...
if (!empty($currency)) {
    foreach ($currency as $ve) {
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" id="rate_sgd" name="rate_sgd" class="form-control" value="<?php echo $ve->rate_kurs; ?>"  onkeypress="return isNumber(event)" readonly/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3">SGD Rate Nego</label>
            <div class="col-md-3">
                <input type="text" id="rate_sgd_nego" name="rate_sgd_nego" class="form-control" value="<?php echo $ve->rate_kurs; ?>"  onkeypress="return isNumber(event)" />
            </div>
        </div>
        <?php
    }
    ...
    <div class="form-group">
        <label class="control-label col-md-3">SGD Rate</label>
        <div class="col-md-3">
            <input type="text" id="rate_sgd" name="rate_sgd" class="form-control" value="0"  onkeypress="return isNumber(event)" readonly/>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-3">SGD Rate Nego</label>
        <div class="col-md-3">
            <input type="text" id="rate_sgd_nego" name="rate_sgd_nego" class="form-control" value="0"  onkeypress="return isNumber(event)" />
        </div>
    </div>
    <?php
}
...
<script>
    $(document).ready(function () {
        ...
        var cur_sgd_nego = document.getElementById('rate_sgd_nego').value;
        ...
        document.getElementById('rate_sgd_nego').value = cur_sgd_nego;
