            ...
            <div class="portlet-body">
              ...
              <table class="table table-bordered" id="tabel">
                <thead>
                  <tr>
                    <th width="3%">
                      <a class="btn green" data-toggle="modal" id="co" onclick="tambah_detail()" title="Serch COA number"><i class="fa fa-plus"></i></a>
                    </th>
                    <th width="8%">
                      PO Number
                    </th>
        ...
        <section class="">
          <div class="contain">
            <table cellspacing="0" cellpadding="0" border="0" id="tbl_coa" width="100%">
              <thead>
                <tr class="header">
                  <th width='15%'>Port<div>Port</div>
                  </th>
                  <th width='25%'>Container Type<div>Container Type</div>
                  </th>
                  <th width='25%'>Price<div>Price</div>
                  </th>
                  <th width='35%'>Exp. Date<div>Exp. Date</div>
                  </th>
                </tr>
