        ...
        <div class="col-md-12">
          ...
          <div class="portlet light">
            ...
            <div class="portlet-body">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td style="width: 7%;"><input type="text" class="txt" name="Detail_po[]" value="<?php echo $v->no_po; ?>" /></td>
                        <td style="width: 7%;">
              ...
              <button type="submit" name="sbt" class="btn btn-primary btn-update" id="btn_update" value="<?php echo $submit_value; ?>"><i class="fa fa-save"></i> <?php echo $submit_value; ?></button>
...
<script>
  $(document).ready(function() {
    ...
    var tgl_inv = $('#tanggal_invoice').val();
    var tgl_tempo = $('#tgl_tempo').val();

    if(tgl_inv){
        var partsDateTempo = tgl_tempo.split('/');
  ...
  function ambilnew(x) {
    ...
    for (var i = 0; i < num; i++) {
      $('table[id="tabel"]').append('<tr><td style="text-align: center;"><button class="tombol" onclick="hapus_dp(this)" >Remove</button></td>\n\
                ...
                <td><textarea name="txtBlCode[]" rows="1" cols="30" class="txt txtBlCode"></textarea></td>\n\
