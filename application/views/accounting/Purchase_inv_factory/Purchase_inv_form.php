<script>
  ...
  function getsup() {
    ...
    if ($jenis === 'bar') {
      ...
      var url2 = "<?php echo base_url(); ?>Purchase_inv/get_detail2?date=" + tgl + "&invtype=" + $invtype;
      console.log(url2);
      console.log(2);
      $.ajax({
        url: url2,
      ...
      var urll = "<?php echo base_url(); ?>Purchase_inv/get_sup?date=" + tgl + "&type=" + $invtype;
      console.log(1);
      // alert(urll);
  ...
  function ambil_harga(x) {
    ...
    $url1 = "<?php echo base_url(); ?>Purchase_inv/getharga?idcont=" + $idcont + "&jen=" + $idjenis + "&x=" + x;
      ...
      <form action="<?php echo base_url(); ?>Purchase_inv/save_receivable_rec" method="post">
        <div class="col-md-12">
          ...
          <div class="portlet light">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <div id="gantiincust">
                          <?php
                          if ($supplier_id === '') {
                            $style_kategori = "class='select2me form-control' onchange='get_isi()' id='buyer' $disable";
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        ...
                        echo form_dropdown('supplier', $supplier, $kode_sup, $style_kategori);
                        ?>
                      </div>
            ...
            <a href="<?php echo base_url(); ?>Purchase_inv/printerin?id=<?= $nofaktur; ?>" class="btn btn-success" target="_blank"><i class="fa fa-print"></i> Print</a>
            <?php if ($this->input->get('id') <> '') { ?>
