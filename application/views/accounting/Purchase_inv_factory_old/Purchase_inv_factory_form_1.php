  ...
  function ambil(x) {
    ...
    for (var i = 0; i < num; i++) {
      $('table[id="tabel"]').append('<tr><td><button class="tombol" onclick="hapus_dp(this)" >Remove</button></td>\n\
                ...
                <td><input type="text" name="txtAmount[]" class="txt number amount autonumber" value="0"  onkeypress="return isNumber(event)"  value="0" /></td>\n\
          ...
          <div class="portlet light">
            ...
            <div class="portlet-body">
              <div class="form-body">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <div id="cur_id">
                          <?php
                          $style_currency = "class='select2me form-control' id='currency' onchange='Rate_notfound();'";
                ...
                <hr />
                <a class="btn green" data-toggle="modal" id="po" href="#po_v" title="Search PO Factory"><i class="fa fa-search"></i> Searh PO Factory</a>
                  ...
                  ?>
                      <tr id="coa<?php echo $no++; ?>">
                        <td style="text-align: center;">
                          <a href="<?php echo base_url(); ?>Purchase_inv_factory/delete?id=<?php echo $v->DetailID; ?>&nofaktur=<?php echo $v->HeaderID; ?>&ship_product_id=<?php echo $v->sono; ?>"><i class="fa fa-trash"></i></a>
                        </td>
                        ...
                        <td><input type="text" class="txt number amount" name="txtamount[]" onkeypress="return isNumber(event);" value="<?php echo number_format($v->Qty * $v->price, 2, '.', ','); ?>" /></td>
                ...
                <tbody>
                  ...
                  <tr id="ds1">
                    ...
                    <td>
                      ...
                      <input type="text" name="JenisJurnal[0]" value="COGS" class="txt">
