    ...
    <div class="row">
      <div class="col-md-6">
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Purchase_inv_vendor/search" method="get">
              <div class="row">
                <div class="col-md-12">
      ...
      <div class="col-md-6">
        <div class="portlet light">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Purchase_inv_vendor/edit" method="get">
              <div class="row">
                <div class="col-md-12">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption">
              <span class="caption-subject theme-font">Purchase Invoice Journal for Vendor List</span>
            </div>
            <div class="form-group">
              <a type="reset" class="btn btn-primary kanan" href="<?php echo base_url(); ?>Purchase_inv_vendor/add_new"><i class="fa fa-plus"></i> Create New</a>
            </div>
          </div>
          <div class="portlet-body">
            ...
            <table class="table table-bordered" id="tabel1">
              ...
              <tfoot>
                <tr>
                  ...
                  <td style="text-align: right; font-weight: bold" width="10%"><?php echo number_format($hutang, 2, ".", ","); ?></td>
...
<script>
  function pilih(x) {
    ...
    //        window.open(url + "Purchase_inv_vendor/edit?id=" + InvoiceNumber + "");
    window.location.href = url + "Purchase_inv_vendor/edit?id=" + InvoiceNumber + "";
  }
</script>