...
<div class="page-content">
 ...
 -->
            ...
            <a id="cetak" href="<?php echo base_url(); ?>Sales_inv/printerin?id=<?= $nofaktur; ?>&signature=Mr. Tahir Aziz" class="btn btn-success" target="_blank"><i class="fa fa-print"></i> Print</a>
            <?php if ($this->input->get('id') <> '') { ?>
