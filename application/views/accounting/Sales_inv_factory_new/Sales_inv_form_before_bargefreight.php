...
<script>
  ...
  function gettanggal() {
    ...
    if ($inv === 'bar') {
      $ft = $('#dest_barge').val();
      $ur = "<?php echo base_url(); ?>Sales_inv2/getAjaxTanggal?jeninv=" + $inv + "&bargedest=" + $ft;
      $.ajax({
        url: $ur,
        success: function(response) {
          $("#tlga").html(response);
  ...
  function ambil_harga(x) {
    ...
    $url1 = "<?php echo base_url(); ?>Sales_inv2/getharga?idcont=" + $idcont + "&jen=" + $idjenis + "&x=" + x;
    console.log('ambil harga : ' + $url1);
    $.ajax({
      url: $url1,
  ...
  function geteta() {
    ...
    $url = "<?php echo base_url(); ?>Sales_inv2/geteta?destbarge=" + $destbarge + "&shipdate=" + $tglshipment;
  ...
  function getetd() {
    $destbarge = $("#dest_barge").val();
    $tglshipment = $("#tanggal_shipment").val();
    $url = "<?php echo base_url(); ?>Sales_inv2/getetd?destbarge=" + $destbarge + "&shipdate=" + $tglshipment;
  ...
  function getbarge() {
    $destbarge = $("#dest_barge").val();
    $tglshipment = $("#tanggal_shipment").val();
    $url = "<?php echo base_url(); ?>Sales_inv2/getbarge?destbarge=" + $destbarge + "&shipdate=" + $tglshipment;
  ...
  function geteta2() {
    $destbarge = $("#dest_barge").val();
    $tglshipment = $("#tanggal_shipment").val();
    $url = "<?php echo base_url(); ?>Sales_inv2/geteta2?destbarge=" + $destbarge + "&shipdate=" + $tglshipment;
  ...
  function getetd2() {
    $destbarge = $("#dest_barge").val();
    $tglshipment = $("#tanggal_shipment").val();
    $url = "<?php echo base_url(); ?>Sales_inv2/getetd2?destbarge=" + $destbarge + "&shipdate=" + $tglshipment;
  ...
  function getbarge2() {
    $destbarge = $("#dest_barge").val();
    $tglshipment = $("#tanggal_shipment").val();
    $url = "<?php echo base_url(); ?>Sales_inv2/getbarge2?destbarge=" + $destbarge + "&shipdate=" + $tglshipment;
  ...
  function get_detail_freigth() {
    ...
    $url = "<?php echo base_url(); ?>Sales_inv2/get_detail_freigth?tgl=" + $tgl;
  ...
  function get_detail_freigthcont() {
    ...
    $url = "<?php echo base_url(); ?>Sales_inv2/get_detail_freigthcont?tgl=" + $tgl;
  ...
  function printfre() {
    ...
    $url = "<?= base_url(); ?>Sales_inv2/printpreview_detail?tgl=" + $tgl;
    console.log($url);
  ...
  function printfreexcel() {
    ...
    $url = "<?= base_url(); ?>Sales_inv2/freight_excel?tgl=" + $tgl;
    console.log($url);
    window.open($url, '_blank');
  }
</script>
