<page orientation="landscape" format="A4">
    <img src="assets/zhl-kop.PNG" style="width: 100%; height: 80px;">
    ...
    <table cellpadding="0" cellspacing="0" style="border: 1px solid #000; width:700px;">
        ...
        <?php
            if(!empty($tampil_item)){
                $sum=0;foreach($tampil_item as $r){
                    $sum+=$r->jumlah_container*$r->Harga;
                    ?>
                ...
                echo "<tr>
                <td colspan='5' style='background-color: coral; border: 0.1px solid #000; text-align:center; width:50px; heigth:30px;'>AMOUNT</td>
                <td style='background-color: coral; border: 0.1px solid #000; width:50px; heigth:30px;'>$sum</td></tr>";
            }
