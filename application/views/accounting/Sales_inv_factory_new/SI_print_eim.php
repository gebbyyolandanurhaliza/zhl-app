...
class PDF extends TFPDF
{
    ...
    function Footer()
    {
        ...
        if ($this->paymentto=='') {
            ...
            $this->multicell(125, 5, 'All business transactions are in accordance with the Singapore Logistics Association (SLA) Standard Trading Condition, copy is available upon request. ', 0, 1, 'L');
        }else{
