...
class PDF extends FPDF {
    ...
    //Page header
    function Header() {
        $titel = 'Account Outstanding Payable Report';
        ...
        $this->setFillColor(255, 255, 255);
        $this->Cell(90);
        $this->cell(25, 6, 'Account Payable Outstanding Report '.date('d-m-Y', strtotime($this->periode)), 0, 0, 'C', 1);
        $this->Ln(10);

        $this->setFont('Arial', 'B', 8);
        $this->setFillColor(255, 255, 255);
        $this->cell(130, 6, 'Supplier', 'BTRL', 0, 'C', 1);;
        $this->cell(60, 6, 'Total ('.$this->cur.')', 'BTRL', 0, 'C', 1);
    ...
    function Content($Get_aging, $GroupSupplierID) {        
        ...
        $this->cell(60, 6, number_format($totgt, 2), 'BTRL', 0, 'R', 1);
