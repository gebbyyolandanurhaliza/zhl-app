    ...
    function Content($get_data_detail,$GroupSupplier, $periode) {        
        ...
        if (!empty($get_data_detail)) {
            ...
            foreach ($GroupSupplier as $m){
                ...
                $this->cell(193, 6, $m->suppliercompany, 'TRL', 1, 'L', 1);
                $this->cell(193, 6,str_replace("<br />"," ","$m->address").' '.$m->postalcode , 'BRL', 1, 'L', 1);
                ...
                foreach ($get_data_detail as $key) {
                    ...
                    if ($key->tmp_supplier_name == $m->suppliercompany) {
                        ...
                        $this->cell(25, 6, $key->tmp_invno, 'BTRL', 0, 'C', 1);            
                        $this->cell(15, 6, $key->tmp_due_date, 'BTRL', 0, 'C', 1);
                        $this->cell(10, 6, $key->tmp_currency, 'BTRL', 0, 'C', 1);
                        $this->cell(14, 6, str_replace("$", "", money_format('%(#6n', $key->tmp_not_due_date+$key->tmp_0sd30+$key->tmp_31sd60+$key->tmp_61sd90+$key->tmp_91sd120+$key->tmp_more120)), 'BTRL', 0, 'R', 1);
                        $this->cell(14, 6, str_replace("$", "", money_format('%(#6n', $key->tmp_not_due_date)), 'BTRL', 0, 'R', 1);
                        $this->cell(14, 6, str_replace("$", "", money_format('%(#6n', $key->tmp_0sd30)), 'BTRL', 0, 'R', 1);
                        $this->cell(14, 6, str_replace("$", "", money_format('%(#6n', $key->tmp_31sd60)), 'BTRL', 0, 'R', 1);
                        $this->cell(14, 6, str_replace("$", "", money_format('%(#6n', $key->tmp_61sd90)), 'BTRL', 0, 'R', 1);
                        $this->cell(14, 6, str_replace("$", "", money_format('%(#6n', $key->tmp_91sd120)), 'BTRL', 0, 'R', 1);
                        $this->cell(14, 6, str_replace("$", "", money_format('%(#6n', $key->tmp_more120)), 'BTRL', 1, 'R', 1);
                        $NO ++;
                    }
                }
                ...
                $this->cell(95, 6, "Grand Total", 'BTRL', 0, 'R', 1);
                $this->cell(14, 6, str_replace("$", "", money_format('%(#5n', $amount)), 'BTRL', 0, 'R', 1);
                $this->cell(14, 6, str_replace("$", "", money_format('%(#5n', $current)), 'BTRL', 0, 'R', 1);
                $this->cell(14, 6, str_replace("$", "", money_format('%(#5n', $tiga)), 'BTRL', 0, 'R', 1);
                $this->cell(14, 6, str_replace("$", "", money_format('%(#5n', $enam)), 'BTRL', 0, 'R', 1);
                $this->cell(14, 6, str_replace("$", "", money_format('%(#5n', $sembilan)), 'BTRL', 0, 'R', 1);
                $this->cell(14, 6, str_replace("$", "", money_format('%(#5n', $lebih)), 'BTRL', 0, 'R', 1);
                $this->cell(14, 6, str_replace("$", "", money_format('%(#5n', $more)), 'BTRL', 1, 'R', 1);
            }
        }
