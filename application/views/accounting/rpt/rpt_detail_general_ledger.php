...
class PDF extends FPDF {
    ...
    function Header() {
       // $ecm = $this->ecm;
        ...
        $this->cell(230, 6, 'ZHENGHE LOGISTICS PTE LTD', 0, 1, 'C', 1);
        ...
        $this->Cell(20, 5, 'No COA', 'BTLR', 0, 'L', 0);
        $this->Cell(18, 5, 'Date of Jurnal', 'BTLR', 0, 'C', 0);
        $this->Cell(25, 5, 'Check Number', 'BTLR', 0, 'C', 0);
        $this->Cell(30, 5, 'Description', 'BTLR', 0, 'C', 0);
        $this->Cell(17, 5, 'Debit (LC)', 'BTLR', 0, 'C', 0);
        $this->Cell(17, 5, 'Credit (LC)', 'BTLR', 0, 'C', 0);
        $this->Cell(17, 5, 'Balance (LC)', 'BTLR', 0, 'C', 0);
        $this->Cell(17, 5, 'Debit (FC)', 'BTLR', 0, 'C', 0);
        $this->Cell(17, 5, 'Credit (FC)', 'BTLR', 0, 'C', 0);
        $this->Cell(24, 5, 'Balance (FC)', 'BTLR', 1, 'C', 0);


    }

    function Content($detail_trans,$noCOA) {
        ...
        foreach ($detail_trans as $s) {
            ...
            $this->SetWidths(array(20,20, 18,25, 30, 17, 17, 17, 17, 17, 24));
            ...
            $this->Row(array(str_replace(".","/", $s->tmp_nojurnal),$noCOA,$tgl_jurnal,$s->tmp_check_bank,$s->tmp_uraian, $tmp_debet, $tmp_kredit,
            ...
            $this->SetWidths(array(20,20, 18,25, 30, 17, 17, 17, 17, 17, 24));
            $this->Row(array("","","","","Total ", number_format($tDebet, 2), number_format($tKredit, 2), number_format($tBalance,2), number_format($tDebetSGD, 2), number_format($tKreditSGD, 2), "SGD ".str_replace("$", "", money_format('%(#10n', $tBalanceSGD)) ));
    }
    private $widths;
    private $aligns;
...
$pdf->Content($_dataContent,$noCOA);
$pdf->Output();
