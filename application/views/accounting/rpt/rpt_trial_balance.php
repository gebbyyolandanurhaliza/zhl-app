...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->cell(200, 6, 'ZHENGHE LOGISTIC PTE LTD', 0, 1, 'C', 1);
        ...
        $this->Cell(25, 5, 'No COA', 'LTR', 0, 'C', 0);
        $this->Cell(80, 5, 'Account Name', 'LTR', 0, 'C', 0); 
        ...
        $this->Cell(25, 5, '', 'LBR', 0, 'C', 0);
        $this->Cell(80, 5, '', 'LBR', 0, 'C', 0); 
    ...
    function Content($get_data_detail) {
        ...
        foreach ($get_data_detail as $v) {
                ...
                $this->Cell(25, 6, $v->no_coa, 1, 0, 'R', 1);
                $this->Cell(80, 6, strtoupper($v->nama_akun), 1, 0, 'L', 1);
