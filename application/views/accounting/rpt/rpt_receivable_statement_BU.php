...
class PDF extends FPDF {
    ...
    function Content($get_data_detail, $SupplierID, $get_total, $get_data_footer) {
        ...
        foreach ($SupplierID as $s) {
            ...
            $this->cell(60, 5, $address, 0, 1, 'L', 1);
        ...
        foreach ($get_data_detail as $key) {
            ...
            $this->cell(40, 6, number_format($key->piutang, 2), 0, 0, 'R', 1);
            $this->cell(40, 6, number_format($key->piutang * $key->rate_awal - $key->bayar, 2), 0, 1, 'R', 1);
            $NO ++;
        }
        ...
        foreach ($get_total as $v) {
            ...
            $this->cell(40, 6, number_format($v->piutang - $v->bayar, 2), 0, 1, 'R', 1);
        }
