...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(90);
        $this->cell(25, 20, 'Vendor Card For Period '.date('d-m-Y', strtotime($this->from)).' to '.date('d-m-Y', strtotime($this->to)), 0, 0, 'C', 0);
        $this->Ln();
        // $this->Cell(90);
        ...
        $this->cell(35, 6, 'Reference', 'BT', 0, 'C', 1);
