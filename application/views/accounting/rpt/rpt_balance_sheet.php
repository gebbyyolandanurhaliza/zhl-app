        ...
        foreach ($GroupCOA as $value) {
            ...
            foreach ($get_profit as $x) {
                if ($value->id_sub_group == $x->id_sub_group) {
                    ...
                    if ($x->id_group !== '214') {
                        if ($x->id_group !== '213') {
                            $this->setFont('Arial', '', 8);
                             ...
                             $this->cell(80, 5, /*str_replace("$", "", number_format('%(#10n', $ammount))*/ number_format($ammount, 2,',','.'), 'BTLR', 1, 'R', 1);   
                        if ($x->id_sub_group == '1' || $x->id_sub_group == '2') {
                        ...
                        $this->cell(100, 5, $x->nama_group, 'BTLR', 0, 'L', 1);
                        $this->cell(80, 5, /*str_replace("$", "", number_format('%(#10n', $PL))*/number_format($PL, 2,',','.'), 'BTLR', 1, 'R', 1);  
                    }
                    ...
                    $this->cell(100, 5, $x->nama_group, 'BTLR', 0, 'L', 1);
                    $this->cell(80, 5, /*str_replace("$", "", number_format('%(#10n', $CY))*/number_format($CY, 2,',','.'), 'BTLR', 1, 'R', 1);    
                }
            }
        }
        if ($id_group == '2') {
            ...
            $this->cell(80, 5, /*str_replace("$", "", number_format('%(#10n', $ttl_asset))*/number_format($ttl_asset, 2,',','.'), 'BTLR', 1, 'R', 1);
        } else if ($id_group == '3') {  
            $this->setFont('Arial', 'B', 8);
            $this->cell(100, 5, 'TOTAL CURRENT LIABILITIES', 'BTLR', 0, 'L', 1);
            $this->cell(80, 5, /*str_replace("$", "", number_format('%(#10n', $ttl_other))*/number_format($ttl_other, 2,',','.'), 'BTLR', 1, 'R', 1);
        } else if ($id_group == '4') {
            $this->setFont('Arial', 'B', 8);
            $this->cell(100, 5, 'TOTAL EQUITY', 'BTLR', 0, 'L', 1);
            $this->cell(80, 5, /*str_replace("$", "", number_format('%(#10n', $ttl_equity + $PL + $CY ))*/number_format($ttl_equity+$PL+$CY, 2,',','.'), 'BTLR', 1, 'R', 1);
            $this->cell(100, 5, 'TOTAL CURRENT LIABILITIES AND EQUITY', 'BTLR', 0, 'L', 1);
            $this->cell(80, 5, /*str_replace("$", "", number_format('%(#10n', $ttl_other + $ttl_equity + $PL + $CY))*/number_format($ttl_other + $ttl_equity + $PL + $CY, 2,',','.'), 'BTLR', 1, 'R', 1);
        }
        //}
    }
}
