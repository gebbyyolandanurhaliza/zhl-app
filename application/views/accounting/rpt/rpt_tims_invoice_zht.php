...
class PDF extends FPDF
{
  ...
  function Header()
  {
    ...
    $this->Cell(20, 5, $this->judul, 0, 0, 'R', 0);
...
if ($rec_hdr->type_trans=='INV') {
  $pdf->judul       = 'TAX INVOICE';
}else if ($rec_hdr->type_trans=='CCN') {
  $pdf->judul       = 'CREDIT NOTE';
}else if ($rec_hdr->type_trans=='CDN') {
  $pdf->judul       = 'DEBIT NOTE';
}
