...
$coa=$_GET['jenis_coa'];
        ...
        $this->Cell(30, 5, 'Check Number', 'BTLR', 0, 'C', 0);
    ...
    function Content($detail_trans) {
        ...
        foreach ($detail_trans as $s) {
            ...
            $this->SetWidths(array(20,15, 18,30, 30, 17, 17, 17, 17, 17, 24));
            ...
            $this->Row(array(str_replace(".","/", $s->tmp_nojurnal),$s->tmp_no_coa,$tgl_jurnal,$s->tmp_check_bank,$s->tmp_uraian, $tmp_debet, $tmp_kredit,
