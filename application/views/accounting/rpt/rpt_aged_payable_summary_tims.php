...
class PDF extends FPDF {
    ...
    //Page header
    function Header() {
        $titel = 'Aged Payable Summary ZHT';
        $this->Image('assets/zhl.png', 18, 8, 32, 0, 'PNG');
        $this->setFont('Arial', 'B', 18);
        $this->SetTextColor(0, 51, 153);
        $this->setFillColor(255, 255, 255);
        $this->Cell(90);
        $this->cell(30, 6, ' ZHENGHE LOGISTICS PTE LTD', 0, 1, 'C', 1);
        $this->setFont('Arial', 'B', 9);
        $this->Cell(90);
        $this->cell(25, 6, 'Reg. Number : 201734570K', 0, 1, 'C', 1);

        $this->setFont('Arial', 'B', 9);
        $this->Cell(90);
        $this->cell(25, 6, '75 Bukit Timah Road, #05-01 Boon Siew Building, Singapore 229833', 0, 1, 'C', 1);
        ...
        $this->setFillColor(255, 255, 255);
        $this->Cell(90);
        $this->cell(25, 6, 'Aged Payable Summary For Period ZHT'.date('d-m-Y', strtotime($this->periode)), 0, 0, 'C', 1);
        $this->Ln();
