...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Image('assets/ZHL-Report.png', 50, 8, 31, 0, 'PNG');
        $this->setFont('Arial', 'B', 18);
        $this->SetTextColor(0, 51, 153);
        $this->setFillColor(255, 255, 255);
        $this->Cell(90);
        $this->cell(90, 6, 'ZHENGHE LOGISTIC PTE LTD', 0, 1, 'C', 1);
        $this->setFont('Arial', 'B', 9);
        $this->Cell(90);
        $this->cell(85, 6, 'Reg. Number : 201734570K', 0, 1, 'C', 1);

        $this->setFont('Arial', 'B', 9);
        $this->Cell(90);
        $this->cell(85, 6, '75 Bukit Timah Road, #05-01 Boon Siew Building, Singapore 229833', 0, 1, 'C', 1);
