...
class PDF extends FPDF {
    ...
    function Content($_tampil_item) {
        ...
        $this->cell(70, 6, 'USA AND AUSTRALIA', 0, 0, 'C', 1);
        $this->cell(70, 6, 'REST OF THE WORLD', 0, 1, 'C', 1);

        $this->Line(60, 65, 240 - 40, 65);


        $this->cell(50, 6, '', 0, 0, 'C', 1);
        $this->cell(35, 6, 'CWP 1', 0, 0, 'C', 1);
        $this->cell(35, 6, 'CWP 2', 0, 0, 'C', 1);
        $this->cell(35, 6, 'CWP 1', 0, 0, 'C', 1);
        $this->cell(35, 6, 'CWP 2', 0, 1, 'C', 1);
       ...
       foreach ($_tampil_item as $data) {
            ...
            $this->cell(35, 6, number_format($data->tmp_total_cwp1_USA_AUS, 2 , '.',','), 0, 0, 'R', 1);
            $this->cell(35, 6, number_format($data->tmp_total_cwp2_USA_AUS, 2 , '.',','), 0, 0, 'R', 1);
            $this->cell(35, 6, number_format($data->tmp_total_cwp1_OTHER, 2 , '.',','), 0, 0, 'R', 1);
            $this->cell(35, 6, number_format($data->tmp_total_cwp2_OTHER, 2 , '.',','), 0, 1, 'R', 1);
            $this->Ln(0);
            $NO++;
        }
        ...
        $this->setFont('Arial', 'B', 8);
        $this->cell(50, 6, 'TOTAL', 0, 0, 'C', 1);
        $this->cell(35, 6, number_format($cwp1_USA, 2 , '.',','), 0, 0, 'R', 1);
        $this->cell(35, 6, number_format($cwp2_USA, 2 , '.',','), 0, 0, 'R', 1);
        $this->cell(35, 6, number_format($a_cwp1_USA, 2 , '.',','), 0, 0, 'R', 1);
        $this->cell(35, 6, number_format($a_cwp2_USA, 2 , '.',','), 0, 1, 'R', 1);
    }
