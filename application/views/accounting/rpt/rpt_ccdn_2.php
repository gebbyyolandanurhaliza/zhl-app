...
class PDF extends TFPDF {
    ...
    function Content($nota, $get_gst, $detail_print, $detail_sgd) {
        ...
        $this->Line(10, 85, 250 - 50, 85);
        $this->cell(10, 20, 'No.', 0, 0, 'L', 1);
        $this->cell(155, 20, 'Description', 0, 0, 'C', 1);
        $this->cell(0, 20, 'Amount (' . $cur . ')', 0, 1, 'C', 1);
...
// $pdf->AddFont('times', '', 'Arial.ttf', true);
