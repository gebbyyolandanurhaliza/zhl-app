...
<script>
  ...
  function hitung_total() {
    ...
    var selisih = sum_dbt.toFixed(2) - sum_crt.toFixed(2);

    if (selisih != 0) {
      jur_credit[0].value = Number(data_ar.toFixed(2)) - Number(selisih.toFixed(2));
    }
    var sum_credit_selisih = sum_crt.toFixed(2) - Number(selisih.toFixed(2))

    total_credit.value = sum_credit_selisih.toFixed(2);
  ...
  function buat_faktur() {
    ...
    var id = document.getElementById('rate_currency'); //rate_currency
    var today = new Date();
    var b = ("0" + (today.getMonth() + 1)).slice(-2);
    var y = today.getFullYear();
    if (refno.value === "INV") {
      $.ajax({
        url: "<?php echo base_url(); ?>Receivable_recognition/buat_nofak",
        success: function(e) {
      ...
      <form action="<?php echo base_url(); ?>index.php/Receivable_recognition/save_receivable_rec" name="form1" id="form1" method="post">
        <div class="col-md-12">
          ...
          <div class="portlet light">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" id="refno" name="nofaktur" value="<?php echo $nofaktur; ?>" onkeyup="buat_faktur()" class="form-control" onchange="cek_nofak()" <?php echo $readonly; ?> required />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <div id="cur_id">
                          <?php
                          $style_currency = "class='select2me form-control' id='currency' onchange='get_cur()'";
                  ...
                  ?>
                      <tr id="coa<?php echo $no++; ?>">
                        <td style="text-align: center;">
                          ...
                          <a href="<?php echo base_url(); ?>index.php/Receivable_recognition/delete?id=<?php echo $v->DetailID; ?>&nofaktur=<?php echo $v->HeaderID; ?>"><i class="fa fa-trash"></i></a>
                        </td>
                        ...
                        <td><input type="text" class="txt number txtGSTValue" name="txtGSTValue[]" value="<?php echo number_format($v->gst_value, 2, '.', ','); ?>" /></td>
                      </tr>
                  <?php
                    }
                  }
            ...
            <?php if ($this->input->get('id') <> '') { ?>
              <a class="btn btn-primary  kanan" href="<?php echo base_url(); ?>index.php/Receivable_recognition/print_report?id=<?php echo htmlspecialchars($this->input->get('id'), ENT_QUOTES); ?>&cur=<?php echo $currency_id; ?>" target="_blank"><i class="fa fa-print"></i> Print</a>
