...
<script>
  function Rate_notfound() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>General_Journal/not_rate?cur=" + $cur + "&date=" + $docdate + "",
  ...
  function ganti_ref() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>General_Journal/get_refnumber1?tgl=" + c + "",
      success: function(response) {
        $('#ganti').html(response);
      },
      dataType: "html"
  ...
  function get_cur_gj() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>General_Journal/ambil_currency?kurs=" + currency + "&tgl=" + tgl,
      success: function(response) {
  ...
  function get_cur_error() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>General_Journal/ambil_currency2?kurs=" + currency + "&tgl=" + tgl,
      success: function(response) {
        ...
        <div class="col-md-12">
          ...
          <div class="portlet light">
            ...
            <div class="portlet-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" onchange="ganti_ref();" id="tgl_tempo" name="tanggal" class="form-control target" onkeypress="return valid_enter(event)" value="<?php echo "$tgl"; ?>" data-date-format="dd/mm/yyyy" <?php echo $readonly; ?> required />
                      </div>
                    </div>
                    <div class="form-group">
              ...
              <a class="btn btn-primary" href="<?php echo base_url(); ?>General_Journal/print_gj?id=<?php echo $this->input->get('id'); ?>" target="_BLANK"><i class="fa fa-print"></i> Print</a>
              <a class="btn btn-default" href="<?php echo base_url(); ?>General_Journal/add_new"><i class="fa fa-plus"></i> New Transaction</a>
              ...
              <?php if ($this->input->get('id') <> '') { ?>
                <a class="btn btn-warning kanan" href="<?php echo base_url(); ?>General_Journal"><i class="fa fa-warning"></i> Cancel</a>
                <a class="btn red kanan" href="<?php echo base_url(); ?>General_Journal/hapus?id=<?php echo $this->input->get('id'); ?>"><i class="fa fa-trash"></i> Delete</a>
              <?php } ?>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    if(dateTempo){
        ...
        console.log('closing date : '  + yearClosing);
        console.log('date tempo : ' + yearDateTempo);
...
<script type="text/javascript">
  $("#btnFindRecord").click(function() {
    $.post("<?php echo site_url(); ?>General_Journal/selectInvoiceGJ", function(data) {
