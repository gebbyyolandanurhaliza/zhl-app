              ...
              <div class="form-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url(); ?>Excel/toExcel7?supplier=<?php echo $supp; ?>&currency=<?php echo $cur; ?>&from=<?php echo $awal; ?>&to=<?php echo $akhir; ?>&coa=<?php echo $coa; ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
                    <a href="<?php echo base_url(); ?>Supplier_card/print_report?supplier=<?php echo $supp; ?>&currency=<?php echo $cur; ?>&dari=<?php echo $awal; ?>&sampai=<?php echo $akhir; ?>&coa=<?php echo $coa; ?>" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                    <hr />
                  </div>
                </div>
                <hr />
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        //     
                        ?>
                        <!-- <td style="text-align:center;"><a href="<?php echo base_url() . "Supplier_card/reviewAPdownpayment?id=" . $v->tmp_nojurnal; ?>" style="background-color:green;color:#fff;padding: 0 15px 0 15px;text-decoration: none;" target="_BLANK">Deposit</a></td> -->
                        <?php
                        // }else{
