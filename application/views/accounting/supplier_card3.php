                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="col-md-12">
                        ...
                        <a href="<?php echo base_url(); ?>Excel/toExcel7?supplier=<?php echo $supp; ?>&currency=<?php echo $cur; ?>&periode=<?php echo $period; ?>&coa=<?php echo $coa; ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
                        <a href="<?php echo base_url(); ?>Supplier_card/print_report?supplier=<?php echo $supp; ?>&currency=<?php echo $cur; ?>&periode=<?php echo $period; ?>&coa=<?php echo $coa; ?>" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                      </div>
                    </div>
                  </div>
                </div>
