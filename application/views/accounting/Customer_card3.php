                  ...
                  <div class="col-md-3  col-md-push-5">
                    <div class="form-group">
                      <div class="col-md-12">
                        ...
                        <button type="submit" class="btn purple   col-md-4  col-md-push-4"><i class="fa fa-refresh"></i> Refresh</button>
                        <!-- <button type="button" class="btn green"><i class="fa fa-file-excel-o"></i> Excell</button> -->
                        <a href="<?php echo base_url(); ?>Excel/toExcel8?supplier=<?php echo $supplier; ?>&coa=<?php echo $coa; ?>&currency=<?php echo $cur; ?>&from=<?php echo $awal; ?>&to=<?php echo $akhir; ?>" class="btn green   col-md-4  col-md-push-4"><i class="fa fa-file-excel-o"></i> Excel</a>

                        <!--<a href="<?php // echo base_url(); 
                                      ?>Customers_card/toPrintCustomerCard?supplier=<?php // echo $supplier; 
                                                                                                              ?>&coa=<?php // echo $coa; 
                                                                                                                                              ?>&currency=<?php // echo $cur; 
                                                                                                                                                                              ?>&dari=<?php // echo $akhir; 
                                                                                                                                                                                                          ?>&sampai=<?php // echo $akhir; 
