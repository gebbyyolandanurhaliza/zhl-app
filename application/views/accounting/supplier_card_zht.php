...
<div class="page-content">
  <div class="container">
    ...
    <div class="row">
      <form action="<?php echo base_url(); ?>Supplier_card_zht/search" method="get">
        <div class="col-md-12">
              ...
              <div class="form-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url(); ?>Excel/vendor_zht?supplier=<?php echo $supp; ?>&currency=<?php echo $cur; ?>&from=<?php echo $awal; ?>&to=<?php echo $akhir; ?>&coa=<?php echo $coa; ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
                    <a href="<?php echo base_url(); ?>Supplier_card_zht/print_report?supplier=<?php echo $supp; ?>&currency=<?php echo $cur; ?>&dari=<?php echo $awal; ?>&sampai=<?php echo $akhir; ?>&coa=<?php echo $coa; ?>" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                    <hr />
                  </div>
                </div>
                <hr />
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        // if( $huruf == 'AP'){
                        ?>
                        <!-- <td style="text-align:center;"><a href="<?php echo base_url() . "Supplier_card_zht/reviewAPpayment?id=" . $v->tmp_nojurnal; ?>" style="background-color:red;color:#fff;padding: 0 15px 0 15px;text-decoration: none;" target="_BLANK">Paid</a></td> -->
                        <?php
                        // } else if($huruf == 'PDP'){
                        //     
                        ?>
                        <!-- <td style="text-align:center;"><a href="<?php echo base_url() . "Supplier_card_zht/reviewAPdownpayment?id=" . $v->tmp_nojurnal; ?>" style="background-color:green;color:#fff;padding: 0 15px 0 15px;text-decoration: none;" target="_BLANK">Deposit</a></td> -->
                        <?php
                        // }else{
