...
<div class="page-content">
  <div class="container">
    ...
    <div class="row">
      <form action="<?php echo base_url(); ?>Customers_zht/search" method="get">
        <div class="col-md-12">
              ...
              <div class="form-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url(); ?>Excel/cus_zht?supplier=<?php echo $supplier; ?>&coa=<?php echo $coa; ?>&currency=<?php echo $cur; ?>&from=<?php echo $awal; ?>&to=<?php echo $akhir; ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
                    <a href="<?php echo base_url(); ?>Customers_zht/toPrintCustomerCard?supplier=<?php echo $supplier; ?>&coa=<?php echo $coa; ?>&currency=<?php echo $cur; ?>&dari=<?php echo $awal; ?>&sampai=<?php echo $akhir; ?>" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                    <hr />
                  </div>
                </div>
              </div>
              <hr />
              <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped table-condensed flip-content" id="tabel1">
                <thead>
                  <tr>
                    <th>
                      Date
                  ...
                  ?>
                    <tr>
                      ...
                      <!-- <td style="text-align:right;">
                        <?php echo ($v->tmp_debet == 0 || $v->tmp_debet === null) ? "" : number_format($v->tmp_debet, 2, ".", ","); ?>
                      </td>
                      <td style="text-align:right;">
                        <?php echo ($v->tmp_kredit == 0 || $v->tmp_kredit === null) ? "" : number_format($v->tmp_kredit, 2, ".", ","); ?>
                      </td> -->
