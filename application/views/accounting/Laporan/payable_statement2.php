                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <div class="row">
                          <div class="control-label col-md-9">
                            <a href="<?php echo base_url(); ?>Payable_statement/print_report?periode=<?php echo $this->input->get('periode'); ?>&supplier=<?php echo $this->input->get('supplier'); ?>&currency=<?php echo $this->input->get('currency'); ?>" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td style="text-align: center;"><?php echo date('d/m/Y', strtotime($v->tanggal)); ?></td>
                    <td style="text-align: center;"><?php echo date('d/m/Y', strtotime($v->tanggal_tempo)); ?></td>
                    <!-- <td style="text-align: center;"><?php echo "$v->currency_id"; ?></td> -->
                    <td style="text-align: center;"><?php echo "USD"; ?></td>
                    <td style="text-align: right;"><?php echo number_format($v->hutang * $v->rate_awal, 2); ?></td>
                    <td style="text-align: right;"><?php echo number_format($v->hutang * $v->rate_awal - $v->bayar, 2); ?></td>
                  </tr>
                <?php
                }
                ?>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped table-condensed flip-content" id="tabel">
              ...
              <tbody>
                ...
                foreach ($get_agings as $v) {
                  if ($v->tmp_payment == 0) {
                    $balance = $v->tmp_hutang;
                    $tanggal = "-";
                  } else {
                    $balance = 0;
                    $tanggal = date('d-M', strtotime($v->tmp_realisasi_date));
                  }
                ?>
                  <tr>
                    ...
                    <td style="text-align: right;"><?php echo number_format($v->tmp_hutang, 2); ?></td>
              ...
              <tfoot>
                <tr>
                  ...
                  <td style="text-align: right; color:red"><?php echo number_format($bayari, 2, '.', ','); ?></td>
                  <td style="text-align: right"><?php echo ""; ?></td>
                  <td style="text-align: right"><?php echo number_format($piutang - $bayari, 2, '.', ','); ?></td>
