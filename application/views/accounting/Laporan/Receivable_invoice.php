                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          ...
                          <a href="<?php echo base_url(); ?>Excel/toExcel6?supplier=<?php echo $supp; ?>&currency=<?php echo $cur; ?>&dari=<?php echo $this->input->get('dari'); ?>&sampai=<?php echo $this->input->get('sampai'); ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
                          <a href="<?php echo base_url(); ?>Receivable_invoice/print_report?dari=<?php echo $this->input->get('periode'); ?>&supplier=<?php echo $this->input->get('supplier'); ?>&currency=<?php echo $this->input->get('currency'); ?>" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                        </div>
                      </div>
                    </div>
          ...
          ?>
            <table class="table table-bordered" id="tabel">
              ...
              <tbody>
                ...
                //     echo "<tr><td colspan='9' nowrap='' style='text-align:left;font-weight:bold;background-color:#ddd;'>$row_suplier->customer_name</td></tr>";
                //     echo "<tr><td colspan='9' nowrap='' style='text-align:left;font-weight:bold;background-color:#ddd;'>$row_suplier->customer_address</td></tr>";
                ...
                ?>
                  ...
                  <tr>
                    <td><?php echo $row_invoice->customer_name; ?></td>
                    ...
                    <td style="text-align: left;"><?php echo wordwrap($row_invoice->PO, 50, "\n"); ?></td>
                  </tr>
                <?php
                  //  }
                }
