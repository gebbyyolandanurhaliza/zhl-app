          ...
          ?>
            <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped table-condensed flip-content" id="tabel">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <!--  <td><a href="<?php echo base_url(); ?>Receivable_invoice/cetak?id=<?php echo $v->nofaktur; ?>&cust=<?php echo $v->customer_code; ?>&cur=<?php echo $v->currency_id; ?>" target="_BLANK"><i class="fa fa-print" ></i></a></td> -->
                    ...
                    <td style="text-align:right;"><?php echo number_format($v->sisa_piutang, 2, ',', '.'); ?></td>
                    <td style="text-align:center;"><?php echo $v->currency_id; ?></td>
                    <td style="text-align:right;"><?php echo number_format($v->rate, 6, ',', '.'); ?></td>
