        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject theme-font">Monitoring Profit and Loss</span>
            </div>
            <div class="tools">
          ...
          <div class="portlet-body">
            <form action="<?php echo base_url(); ?>Profit_and_lost/search" method="get">
              <div class="form-body">
                <div class="row">
                  <!--/span-->
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" id="tgl_tempo" name="period" class="form-control date date-picker" value="<?php echo $this->session->userdata('periode_1'); ?>" data-date="2016-02" data-date-format="yyyy-mm" required />
                      ...
                      <div class="col-md-4">
                        <div class="row">
                          <div class="control-label col-md-9">
                            ...
                            <a href="<?php echo base_url(); ?>Excel/toExcelProfit_Lost?period=<?php echo $period; ?>&type=<?php echo $type; ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
                ...
                foreach ($GroupCOA as $value) {
                  ...
                  foreach ($get_invoice as $v) {
                    if ($value->id_group == $v->tmp_coa_groupid) {
                      ...
                      $mutasi = $v->tmp_balance_last_periode;
                      if ($begining < 0) {
                        $b = str_replace("-", "", $begining);
                        $begining = "(" . number_format($b, 2, '.', ',') . ")";
                      } else {
