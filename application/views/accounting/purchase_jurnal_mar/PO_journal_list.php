              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <a type="reset" class="btn btn-primary kanan" href="<?php echo base_url(); ?>PO_journal_mar/addnew"><i class="fa fa-plus"></i> Create New</a>
                  </div>
                </div>
              </div>
              <hr />
...
<script>
  function pilih(x) {
    ...
    window.location.href = url + "PO_journal_mar/edit?id=" + InvoiceNumber + "&ve=" + vendor + "&cur=" + cur + "";
  }
</script>