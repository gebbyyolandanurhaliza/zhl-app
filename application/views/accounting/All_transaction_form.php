        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject theme-font">Accounting Report Payable Invoice Transaction</span>
            </div>
            <div class="tools">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <a href="<?php echo base_url(); ?>All_Transaction/print_report?dari=<?php echo $this->input->get('dari'); ?>&sampai=<?php echo $this->input->get('sampai'); ?>&jenis_trans=<?php echo $this->input->get('jenis_trans'); ?>" target='_blank' class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                      </div>
                    </div>
                  </div>
                  <hr>
                    ...
                    <table class="table table-bordered" id="tabel">
                      ...
                      <tbody>
                        ...
                        foreach ($Get_supplier as $key_supplier) {
                          echo "<tr><td colspan='13' nowrap='' style='text-align:left;font-weight:bold;background-color:#ddd;'>$key_supplier->namavendor</td></tr>";
                          echo "<tr><td colspan='13' nowrap='' style='text-align:left;font-weight:bold;background-color:#ddd;'>$key_supplier->address</td></tr>";
                          $no = 1;
                          $totalpajak = 0;
                          $totaldiskon = 0;
                          $totalbiayalain = 0;
                        ...
                        ?>
                              <tr>
                                ...
                                <!-- <td><?php echo $key_item->namavendor;; ?></td> -->
                                <td><?php echo $key_item->currency_id; ?></td>
                                ...
                                <td style="text-align: right;"><?php echo number_format($key_item->hutang, 2, ".", ","); ?></td>
                                <td style="text-align: right;"><?php echo number_format($key_item->bayar, 2, ".", ","); ?></td>
                              </tr>
                        <?php
                            }
                          }
                          echo "<tr style='background: #ffffcc'><td colspan='5' style='text-align:right;'><b>Total</b></td>"
