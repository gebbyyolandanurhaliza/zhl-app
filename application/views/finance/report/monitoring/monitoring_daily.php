                ...
                <div class="form-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <a href="<?php echo base_url(); ?>Excel/toExcelDailyReport?dari=<?php echo $this->input->get('dari'); ?>&sampai=<?php echo $this->input->get('sampai'); ?>&coa=<?php echo $this->input->get('coa'); ?>&currency=<?php echo $this->input->get('cur'); ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Excel</a>
                      <a href="<?php echo base_url(); ?>Monitoring_finace/print_report?dari=<?php echo $this->input->get('dari'); ?>&sampai=<?php echo $this->input->get('sampai'); ?>&coa=<?php echo $this->input->get('coa'); ?>&currency=<?php echo $this->input->get('cur'); ?>" class="btn green"><i class="fa fa-file-excel-o"></i> Print</a>
                    </div>
                  </div>
