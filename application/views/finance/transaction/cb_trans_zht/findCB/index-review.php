...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      <form id="form-transCashBank" role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('CBtrans_zht/updateTransactionCB'); ?>" class="form-horizontal">
                  ...
                  <div class="col-md-12">
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="txtFromTo" value="<?php echo $_selectHeader->from_to; ?>" class="form-control input-sm" required />
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-8">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="txtInputRateUSD" name="txtRateCurr" value="<?php echo number_format($_selectHeader->currency_rate, 6); ?>" class="form-control input-sm txtnumRate" required />
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="txtInputRateSGD" name="txtRateCurrSGD" class="form-control input-sm txtnumRate" value="<?php echo number_format($_selectHeader->rate_sgd, 6); ?>" required />
                        </div>
                      </div>
                    </div>
            ...
            <div class="portlet-body table-responsive">
              <table class="table-ismo" id="tbl-cashGeneral">
                ...
                <tbody>
                  ...
                  ?>
                  <?php if($dtl->coa == '300504' || $dtl->coa == '300701' || $dtl->coa == '300702') {?>
                  <tr id="rowSetCOA">
                    ...
                    <td nowrap style="width: 25%;"><textarea type="text" name="txtBlCode[]" id="txtInputBlCodeSuppRow-1" class="txt" rows="1" cols="30"><?php echo $dtl->containerNo; ?></textarea></td>
                  ...
                  <tr id="rowGSTlast-1">
                    ...
                    <td nowrap><textarea name="txtBlCode[]" id="txtInputBlCodeRow-GSTlast-1" rows="1" cols="30" class="txt"><?php echo $dtl->containerNo; ?></textarea></td>
                  ...
                  <?php } else if($dtl->coa == '700011') {?>
                    <tr id="addCostRow1">
                      ...
                      <td nowrap><input type="text" name="txtDeptCode[]" id="txtInputDeptCodeRow-addCostRow-1" class="txt" value="<?php echo $dtl->dept_code; ?>" readonly /></td>
                       <td nowrap><textarea type="text" name="txtBlCode[]" id="txtInputBlCodeRow-addCostRow-1" rows="1" cols="30" class="txt"><?php echo $dtl->containerNo; ?></textarea></td>
                  ...
                  <?php } else { ?>
                    <tr id="secendRowCashGeneral">
                      ...
                      <td nowrap><textarea id="txtBlCodesuppRow-2" type="text" name="txtBlCode[]" rows="1" cols="30" class="txt"><?php echo $dtl->containerNo; ?></textarea></td>
            ...
            <div class="portlet-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <button class="btn btn-sm btn-primary" type="reset" onclick="window.location='<?php echo site_url('CBtrans_zht'); ?>'">
                      <i class="fa fa-plus"></i> New Transaction
                  </button>
                  <button id="update_btn" type="button" onclick="confirmSubmit('update')" class="btn btn-success btn-sm">
...
<script type="text/javascript">
  ...
  function convertToUSD() {
    ...
    if (selisih != 0) {
      if (selisih > 0) {
        i_cret[1].value = addCommas((parseFloat(i_cret[1].value) + Math.abs(selisih)).toFixed(2));
  ...
  function finalCalculate() {
    ...
    if ($('#poTXTtypeIO').val() == "O" || $('#poTXTtypeIO').val() == "o") {
      ...
      // console.log("xxxCredit: " + xxxCredit);
