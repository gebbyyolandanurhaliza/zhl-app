<table id="tbl-MasterCOA" class="table table-hover table-striped">
    <thead>
        <tr>
            <th>COA Number - - INI DI CASH BANK</th>
            <th>Account Name</th>
            <th>COA Group</th>
            <th>Reg Number</th>
            <th>addClass</th>
    ...
    <tbody>
        ...
        <tr onclick="Pilih_MCOA(this)" data-id="mcoa-row-<?php echo $no++;?>">
            <td class="text-center"><?php echo $row->NoCOA . "-" . $row->kode_department . "-002" ;?></td>
...
<script>
    $(document).ready(function() {
        ...
        $('#tbl-MasterCOA tbody tr').on('click', function (){
