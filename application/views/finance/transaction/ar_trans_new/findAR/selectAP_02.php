        ...
        <div class="table-responsive">
            <table id="tbl-selectAP-hasRecorded" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr data-id="<?php echo encode_str($row->header_id);?>" class="ap-is-<?php echo ($row->is_draf == 1 ? 'draft': 'paid');?>">
                        ...
                        <td class="text-right"><?php echo number_format($row->rate_nego, 6);?></td>
    ...
    $(document).ready(function() {
        ...
        $("#tbl-selectAP-hasRecorded tbody tr").click( function (){
            ...
            if ($(this).hasClass('ap-is-paid') === true) {
                window.location = "<?php echo site_url();?>APtrans/reviewAPpayment/" +header;
            }else{
                window.location = "<?php echo site_url();?>APtrans/reviewAPforDraft/" +header;
            }
        });
