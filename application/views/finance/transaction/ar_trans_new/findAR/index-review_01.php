                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input id="txtInputRateVoucher" value="<?php echo $_selectHeaderAP->currency_rate; ?>" name="txtRateVoucher" type="text" class="form-control input-sm txt-ismo-back-null txtnum" data-date-format="yyyy-mm-dd" readonly />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateWeekly" value="<?php echo number_format($_selectHeaderAP->rate_nego, 2); ?>" name="txtRateBayar" class="form-control input-sm txtnum" required />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateNego" value="<?php echo number_format($_selectHeaderAP->rate_nego, 2); ?>" name="txtRateNego" class="form-control input-sm txtnum" required />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
