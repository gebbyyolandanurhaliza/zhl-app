...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      ...
      <form role="form" method="post" id="form-APtrans" action="<?php echo site_url('APtrans/payAPfromDraft'); ?>" class="form-horizontal">
        <div class="col-md-12">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $.post("<?php echo site_url('APtrans/selectSuppliertForAPbySuppCode'); ?>", {
    ...
    $.post("<?php echo site_url('APtrans/selectCurrencyAP'); ?>", {
    ...
    $('#btnPrint').click(function() {
      ...
      //alert(noAP);
      window.open('<?php echo site_url(); ?>APtrans/paymentAdvice/' + noAP + '?sup=' + suppNm + '&adr=' + suppAd + '&adr2=' + suppDr, '_blank');
    });
  });
</script>
