<table class="success" style="width: 100%; background-color: transparent; border: none;">
    ...
    <tbody >
        <?php foreach ($_selectAPdetailAc as $r): ?>
        <tr>
            <td><?php echo $r->NoInvoice;?></td>
            <td class="text-right" style="width: 15%;"><?php echo number_format($r->Rate, 2);?></td>
            <td class="text-right" style="width: 15%;"><?php echo number_format($r->Total, 2);?></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
</table>
...
<table style="width: 100%; background-color: transparent; border: none;">
    ...
    <tbody>
        <?php foreach ($_selectAPjurnal as $j): ?>
        <tr>
...
<!-- <table style="width: 100%; background-color: transparent; border: none;">
    ...
    <tbody>
        <?php //foreach ($_selectAPdetail as $row): ?>
        <tr>
