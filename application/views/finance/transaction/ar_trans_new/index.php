...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      ...
      <form role="form" method="post" id="form-APtrans" action="<?php echo site_url('ARtransNew') . $_actionFrom; ?>" class="form-horizontal">
        <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    ...
                    <script>
                      $('#inputNoReff').on('blur', function() {
                        ...
                        $.ajax({
                          type: "POST",
                          url: "<?php echo base_url(); ?>ARtransNew/cekNumReffAR",
                          data: {
                            value: val
                          },
                          dataType: "json",
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#btn-generate-noreff").click(function() {
      $.ajax({
        url: "<?php echo site_url('ARtransNew/generateReffNumAR'); ?>",
        dataType: 'json',
    ...
    $("#inputCOA").click(function() {
      if ($('#inputTotalVoucher').val() === '') {
        ...
        $.ajax({
          url: "<?php echo site_url('ARtransNew/selectCOA'); ?>",
          type: "POST",
          datatype: "json",
          cache: false,
          success: function(respon) {
    ...
    $("#txtInputSuplierID, #txtInputSuplierName").click(function() {
      ...
      if (!txtTglTrn) {
        ...
        $.ajax({
          url: "<?php echo site_url('ARtransNew/selectCustomerForAR'); ?>",
          data: {
    ...
    $("#btnSelectInvoice").click(function() {
      if (inSuppID === '') {
        ...
        if ($('#modal-invoice').hasClass('has-ismo-modal')) {
          ...
          $.ajax({
            url: "<?php echo site_url('ARtransNew/selectInvoiceForAR'); ?>",
            type: "POST",
            data: {
    ...
    $("#btnFindRecord").click(function() {
      $.post("<?php echo site_url(); ?>ARtransNew/selectARpayment", function(data) {
...
<script>
  ...
  function Pilih_MCOA(x) {
    ...
    if (valCUR != 'ALL') {
      $.post("<?php echo site_url('ARtransNew/getCurrBank'); ?>", {
        txtCurrency: valCUR,
