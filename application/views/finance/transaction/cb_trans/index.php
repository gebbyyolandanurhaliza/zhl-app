                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input id="txtInputDateTrans" name="txtDate1" type="text" class="form-control input-sm target" data-date-format="dd-mm-yyyy" value="<?php //echo date('d-m-Y');
                    ...
                    <div class="col-sm-8">
                      <div class="form-group">
                        ...
                        <div class="col-sm-11">
                          ...
                          <textarea type="text" cols="30" rows="3" name="txtDescription" class="form-control input-sm" required></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <table class="table-ismo" id="tbl-cashGeneral">
                ...
                <tbody>
                  <tr id="rowSetCOA">
                    ...
                    <td nowrap style="width: 7%;"><input type="text" name="txtNameCOA[]" id="txtInputNameSuppRow-1" class="txt" value="" readonly /></td>
                ...
                <tfoot id="detailRowForAddCost">
                  ...
                  <tr id="addCostRow1">
                    ...
                    <td nowrap><input type="text" name="txtDeptCode[]" id="txtInputDeptCodeRow-addCostRow-1" class="txt" value="001" readonly /></td>
              ...
              <div class="row">
                <div class="col-md-6">
                  <button class="btn btn-sm btn-primary" id="btnFindRecord" type="button">
                    Find <i class="fa fa-sm fa-search fa-fw" aria-hidden="true"></i> 
                  </button>

                  <button id="btnExcelRecord" class="btn btn-sm btn-success" type="button" onclick="fnExportExcel()"> Excel <i class="fa fa-file-excel-o" aria-hidden="true"></i></button>
                </div>
