                      ...
                      <div id="div-ReffNum" class="form-group">
                        ...
                        <div class="col-sm-8">
                          <div class="input-icon input-icon-sm right">
                            ...
                            <input type="text" id="inputNoReff" name="txtNoReff" placeholder="Input or Generate Referance Number" maxlength="20" class="form-control input-sm" required />
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="txtInputRate" name="txtRateCurr" onblur="javascript: checkGST();" class="form-control input-sm hanya-baca txtnum" data-m-dec="6" required />
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="txtInputRateSGD" name="txtRateCurrSGD" class="form-control input-sm hanya-baca txtnum" data-m-dec="6" required />
                        </div>
                      </div>
                    </div>
                  </div>
