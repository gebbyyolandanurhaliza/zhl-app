                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="txtInputRateUSD" name="txtRateCurr" onblur="javascript: checkGST();" class="form-control input-sm hanya-baca txtnumRate" data-m-dec="6" required />
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-12">
                ...
                <tbody>
                  ...
                  <tr id="secendRowCashGeneral">
                    <td id="rowSelectCOArow2" class="text-center" style="vertical-align: middle;">
                      <button id="btnSelectCOArow2" class="btn btn-xs btn-link baik" type="button" onclick="selectModalCOArow2();">
    ...
    $('#txtInputDateTrans, #txtInputCurr, #txtInputRateUSD, #inputIOCest').on('change blur', function() {
      if ($('#txtInputDateTrans').val() && $('#txtInputRateUSD').val() && $('#poTXTtypeIO').val()) {
        var goRefreshNum = setInterval(function() {
          if ($('#txtInputCurr').val() == 'USD' || $('#txtInputCurr').val() == 'SGD') {
...
<script type="text/javascript">
        ...
        pay: {
          ...
          callback: function() {
            ...
            $('table[id="tbl-cashGeneral"] tfoot[id="detailRowForAddCost"]').append('<tr class="' + cls + ' added-row-ismo">\n\
                            ...
                            <td nowrap><input type="text" name="txtDebit[]" onKeyup="calculateAmountDebit(); checkGST();" class="ac-col-debit col-deb txt txtnum ' + cls + 'xx" /></td>\n\
                            <td nowrap><input type="text" name="txtCredit[]" readonly onKeyup="calculateAmountDebit(); checkGST();" class="ac-col-credit col-cre txt txtnum ' + cls + 'xx"/></td>\n\
        ...
        review: {
          ...
          callback: function() {
            ...
            $('table[id="tbl-cashGeneral"] tfoot[id="detailRowForAddCost"]').append('<tr class="' + cls + ' added-row-ismo">\n\
                            ...
                            <td nowrap><input type="text" name="txtNoCOA[]" class="txt" value="' + getText(document.getElementById('tbl-MasterCOAforAddCost').rows[$r].cells[0]) + '" readonly/></td>\n\
                            <td nowrap><input type="text" name="txtNameCOA[]" class="txt" value="' + getText(document.getElementById('tbl-MasterCOAforAddCost').rows[$r].cells[1]) + '" readonly/></td>\n\
                            <td nowrap><input type="text" name="txtDebit[]" readonly onKeyup="calculateAmountDebit(); checkGST();" class="ac-col-debit col-deb txt txtnum ' + cls + 'xx" /></td>\n\
                            <td nowrap><input type="text" name="txtCredit[]" onKeyup="calculateAmountDebit(); checkGST();" class="ac-col-credit col-cre txt txtnum ' + cls + 'xx"/></td>\n\
                            <td nowrap><input type="text" name="txtDebitUSD[]" class="col-debit-usd txt txtnum ' + cls + 'xx" /></td>\n\
                            <td nowrap><input type="text" name="txtCreditUSD[]" class="col-credit-usd txt txtnum ' + cls + 'xx"/></td>\n\
                            <td nowrap><input type="text" name="txtRemark[]" class="txt"/></td>\n\
                            <td nowrap><input type="text" name="txtGST[]" class="txt"/></td>\n\
  ...
  function convertToUSD() {
    var rateUSD = parseFloat($('#txtInputRateUSD').val().replace(/,/g, ''));
