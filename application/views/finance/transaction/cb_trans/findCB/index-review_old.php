...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      <form id="form-transCashBank" role="form" method="post" action="<?php echo site_url('CBtrans/deleteCashBankTransaction'); ?>" class="form-horizontal">
                    ...
                    <div class="col-sm-8">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <select class="form-control input-sm" name="selCBCode" id="selInputCBCode" disabled>
                            <option value="">Choose...</option>
                            <?php foreach ($_selectMasterCOA as $row) : ?>
                    ...
                    <div class="col-sm-8">
                      <div class="form-group">
                        ...
                        <div class="col-sm-11">
                          ...
                          <textarea type="text" cols="30" rows="3" name="txtDescription" class="form-control input-sm" required readonly><?php echo $_selectHeader->trans_description; ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <tbody>
                  <?php foreach ($_selectDetail as $dtl) : ?>
                    <tr id="rowSetCOA">
                      ...
                      <?php } ?>
                      <td nowrap style="width: 25%;"><textarea type="text" cols="30" rows="1" name="txtBlCode[]" class="txt"><?php echo $dtl->blCode; ?></textarea></td>
              ...
              <div class="portlet-body">
                <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                    ...
                    <button class="btn btn-sm btn-default" type="reset" onclick="javascript: window.location = '<?php echo site_url("CBtrans"); ?>';">
