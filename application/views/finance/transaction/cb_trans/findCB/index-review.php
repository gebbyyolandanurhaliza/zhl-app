...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      <form id="form-transCashBank" role="form" method="post" action="<?php echo site_url('CBtrans/updateTransactionCB'); ?>" class="form-horizontal">
        ...
        <div class="col-md-12">
          ...
          <div class="portlet light">
            ...
            <div class="portlet-body form">
                  ...
                  <div class="col-md-12">
                    <div class="col-sm-4">
                      <div id="div-ReffNum" class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="txtNoReff" value="<?php echo $_selectHeader->no_reff; ?>"  placeholder="Auto Generate" maxlength="20" class="form-control input-sm" required readonly />
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input id="txtInputDateTrans" name="txtDate1" type="text" class="form-control input-sm target" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($_selectHeader->date1)); ?>" data-yesterday="<?php echo date('d-m-Y',  mktime(0, 0, 0, date('m'), date('d') - 1, date('Y'))); ?>" data-now="<?php echo date('d-m-Y'); ?>" readonly>
                        </div>
                      </div>
                    ...
                    <div class="col-sm-8">
                          ...
                          <select class="form-control input-sm" name="selCBCode" id="selInputCBCode" onchange="changeCodeCB(this)">
                            <option value=""></option>
                             <?php foreach ($_selectMasterCOA as $row) : ?>
                                <option value="<?= $row->NoCOA ?>"
                                    <?= ($_selectedCOA && $_selectedCOA->NoCOA == $row->NoCOA) ? 'selected' : '' ?>>
                                    <?= $row->NoCOA ?> ~ <?= $row->AccountName ?>
                                </option>
                            <?php endforeach; ?>

                            <!-- <?php foreach ($_selectMasterCOAOld as $row) : ?>
                                <option value="<?= $row->NoCOA?>"
                                    <?= ($_selectedCOA && $_selectedCOA->NoCOA == $row->NoCOA) ? 'selected' : '' ?>>
                                    <?= $row->NoCOA ?> ~ <?=$row->AccountName ?>
                                </option>
                      ...
                      <script>
                        function changeCodeCB(val) {
                          ...
                          var coaNoTrim = nameCOA.substr(0, pemisah - 1);
                          var noCOA = coaNoTrim.trim();
              ...
              //               let test = noCOA.split('\n')
              //  .filter(item => item && item.trim() !== '')
              //  .map(item => item.trim());
                            console.log(noCOA.trim());
                            ...
                            $.ajax({
                              type: "POST",
                              url: "<?php echo base_url(); ?>CBtrans/getRateByBankAccount",
                              data: {
                                txtBankAccount: id,
                  ...
                  <div class="col-md-12">
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="txtFromTo" class="form-control input-sm" value="<?php echo $_selectHeader->from_to; ?>" required />
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-8">
                      <div class="form-group">
                        ...
                        <div class="col-sm-11">
                          ...
                          <textarea type="text" cols="30" rows="3" name="txtDescription" class="form-control input-sm" required><?php echo $_selectHeader->trans_description; ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="txtInputRateUSD" value="<?php echo number_format($_selectHeader->currency_rate, 6); ?>" name="txtRateCurr" class="form-control input-sm hanya-baca" required readonly/>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="txtInputRateSGD" value="<?php echo number_format($_selectHeader->rate_sgd, 6); ?>" name="txtRateCurrSGD" class="form-control input-sm hanya-baca" required readonly/>
                        </div>
                      </div>
                    </div>
              ...
              <table class="table-ismo" id="tbl-cashGeneral">
                <thead>
                  <tr>
                    ...
                    <th style="width: 7%;">Debit[USD]</th>
                    <th style="width: 7%;">Credit[USD]</th>
                    <th>Remark</th>
                ...
                <tbody>
                  <?php
                   foreach ($_selectDetail as $dtl) : 
                    $history_id = '';
                    foreach ($_selectHistory as $his) {
                      if ($his->coa_code == $dtl->coa) { 
                        $history_id = $his->detail_id;
                        break; 
                      }
                    } 
                    
                    $jurnal_id = '';
                    foreach ($_selectJurnal as $jur) {
                      if ($jur->NoCOA == $dtl->coa) { 
                        $jurnal_id = $jur->DetailID;
                        break; 
                      }
                    }
                    
                    // TAMBAHAN FAUZI, kalau ada eror bisa update ke Fauzi
                    $coaList = array_map(function ($row) {
                      return $row->NoCOA;
                    }, $_selectMasterCOA);
                    ?>
                    <?php if (in_array($dtl->coa, $coaList, true)) { ?>
                      <tr id="rowSetCOA">
                        <td class="text-center" style="vertical-align: middle;">
                          <button class="btn btn-xs btn-link biasa" type="button">
                            <i class="fa fa-arrow-down"></i></button>
                        </td>
                        <td nowrap><input type="text" name="txtNoCOA[]" id="txtInputCOAsuppRow-1" class="txt" value="<?php echo $dtl->coa; ?>" readonly />
                        <input type="hidden" name="txtDetailID[]" value="<?php echo $dtl->detail_id; ?>"></td>
                        <input type="hidden" name="detailIDHistory[]" value="<?php echo $history_id; ?>"></td>
                        <input type="hidden" name="detailIDJurnal[]" value="<?php echo $jurnal_id; ?>"></td>
                        <td nowrap id="txtDeptCodesuppRow-1"><input type="text" name="txtDeptCode[]" class="txt" value="<?php echo $dtl->dept_code; ?>" readonly /></td>
                        <td nowrap style="width: 25%;"><textarea type="text" name="txtBlCode[]" id="txtInputBlCodeSuppRow-1" class="txt" rows="1" cols="30"><?php echo $dtl->blCode; ?></textarea></td>
                        <td nowrap style="width: 7%;"><input type="text" name="txtNameCOA[]" id="txtInputNameSuppRow-1" class="txt" value="<?php echo $dtl->coa_description; ?>" readonly /></td>
                        <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-1" value="<?php echo number_format($dtl->debit, 2); ?>" onKeyup="calculateAmountDebit(); checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-debit col-deb txt txtnum" /></td>
                        <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-1" value="<?php echo number_format($dtl->credit, 2); ?>" onKeyup="calculateAmountCredit(); checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-credit col-cre txt txtnum" /></td>

                        <td nowrap><input type="text" name="txtDebitUSD[]" value="<?php echo number_format($dtl->debit_usd, 2); ?>" id="txtInputDebitCBdetailRow-1-USD" class="col-debit-usd txt txtnum" /></td>
                        <td nowrap><input type="text" name="txtCreditUSD[]" value="<?php echo number_format($dtl->credit_usd, 2); ?>" id="txtInputCreditCBdetailRow-1-USD" class="col-credit-usd txt txtnum" /></td>
                        ...
                        <td nowrap><input type="text" id="txtInputGSTvalue1st" value="<?php echo number_format($dtl->gst_value, 2); ?>" name="txtGSTvalue[]" class="txt txtnum gst-value display-none" /></td>
                      </tr>
                    <?php } else if($dtl->coa == '300106') {?>
                      ...
                      <tr id="rowGSTlast-1">
                        ...
                        <td nowrap><input type="text" name="txtNoCOA[]" id="txtInputCOAsuppRow-GSTlast-1" value="<?php echo $dtl->coa; ?>" class="txt" readonly />
                        <input type="hidden" name="txtDetailID[]" value="<?php echo $dtl->detail_id; ?>"></td>
                        <input type="hidden" name="detailIDHistory[]" value="<?php echo $history_id; ?>"></td>
                        <input type="hidden" name="detailIDJurnal[]" value="<?php echo $jurnal_id; ?>"></td>
                        <td nowrap><input type="text" name="txtDeptCode[]" id="txtDeptCodesuppRow-GSTlast-1" class="txt" value="<?php echo $dtl->dept_code; ?>" readonly /></td>
                        <td nowrap><textarea name="txtBlCode[]" id="txtInputBlCodeRow-GSTlast-1" rows="1" cols="30" class="txt"><?php echo $dtl->blCode; ?></textarea></td>
                        <td nowrap><input type="text" name="txtNameCOA[]" id="txtInputNameSuppRow-GSTlast-1" class="txt" value="<?php echo $dtl->coa_description; ?>" readonly /></td>
                        <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-GSTlast-1" value="<?php echo number_format($dtl->debit, 2); ?>" readonly class="col-debit col-deb txt txtnum" /></td>
                        <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-GSTlast-1" value="<?php echo number_format($dtl->credit, 2); ?>" readonly class="col-credit col-cre txt txtnum" /></td>

                        <td nowrap><input type="text" name="txtDebitUSD[]" value="<?php echo number_format($dtl->debit_usd, 2); ?>" id="txtInputDebitCBdetailRow-1-GSTlastUSD" class="col-debit-usd txt txtnum" /></td>
                        <td nowrap><input type="text" name="txtCreditUSD[]" value="<?php echo number_format($dtl->credit_usd, 2); ?>" id="txtInputCreditCBdetailRow-1-GSTlastUSD" class="col-credit-usd txt txtnum" /></td>
                        <td nowrap><input type="text" value="<?php echo $dtl->remark; ?>" name="txtRemark[]" class="txt" /></td>
                        <td nowrap>
                          <select name="txtGST[]" class="txt gst-name display-none"  onchange="checkGST()">
                            <option value=""> -- Select --</option>
                      ...
                      <?php } else if($dtl->coa == '700011') { ?>
                      <tr id="addCostRow1">
                        <td class="text-center" style="vertical-align: middle;">
                          <button class="btn btn-xs btn-link biasa" type="button">
                            <i class="fa fa-arrow-up"></i></button>
                        </td>
                        <td nowrap><input type="text" name="txtNoCOA[]" id="txtInputCOAsuppRow-addCostRow-1" class="txt" value="<?php echo $dtl->coa; ?>" readonly />
                        <input type="hidden" name="txtDetailID[]" value="<?php echo $dtl->detail_id; ?>"></td>
                        <input type="hidden" name="detailIDHistory[]" value="<?php echo $history_id; ?>"></td>
                        <input type="hidden" name="detailIDJurnal[]" value="<?php echo $jurnal_id; ?>"></td>
                        <td nowrap><input type="text" name="txtDeptCode[]" id="txtInputDeptCodeRow-addCostRow-1" class="txt" value="<?php echo $dtl->dept_code; ?>" readonly /></td>
                        <td nowrap><textarea type="text" name="txtBlCode[]" id="txtInputBlCodeRow-addCostRow-1" rows="1" cols="30" class="txt"><?php echo $dtl->blCode; ?></textarea></td>
                        <td nowrap><input type="text" name="txtNameCOA[]" id="txtInputNameSuppRow-addCostRow-1" class="txt" value="<?php echo $dtl->coa_description; ?>" readonly /></td>
                        <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-addCostRow-1" value="<?php echo number_format($dtl->debit, 2); ?>" class="col-deb txt txtnum" /></td>
                        <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-addCostRow-1" value="<?php echo number_format($dtl->credit, 2); ?>" class="col-credit col-cre txt txtnum" /></td>

                        <td nowrap><input type="text" name="txtDebitUSD[]" id="txtInputDebitCBdetailRow-1-addCostRowUSD" value="<?php echo number_format($dtl->debit_usd, 2); ?>" class="col-debit-usd txt txtnum" /></td>
                        <td nowrap><input type="text" name="txtCreditUSD[]" id="txtInputCreditCBdetailRow-1-addCostRowUSD" value="<?php echo number_format($dtl->credit_usd, 2); ?>" class="col-credit-usd txt txtnum" /></td>
                        <td nowrap><input type="text" value="<?php echo $dtl->remark; ?>" name="txtRemark[]" class="txt" /></td>
                        <td nowrap>
                          <select name="txtGST[]" class="txt gst-name display-none" onchange="checkGST()">
                            <option value=""> -- Select --</option>
                    ...
                    <?php } else { ?>
                      <tr id="secendRowCashGeneral">
                        <td class="text-center" style="vertical-align: middle;">
                          <button class="btn btn-xs btn-link buruk" type="button" onclick="delete_MCOA(this)">
                            <i class="fa fa-trash-o"></i></button>
                        </td>
                        <td nowrap><input id="txtInputCOAsuppRow-2" type="text" name="txtNoCOA[]" class="txt" value="<?php echo $dtl->coa; ?>" required="" />
                        <input type="hidden" name="txtDetailID[]" value="<?php echo $dtl->detail_id; ?>"></td>
                        <input type="hidden" name="detailIDHistory[]" value="<?php echo $history_id; ?>"></td>
                        <input type="hidden" name="detailIDJurnal[]" value="<?php echo $jurnal_id; ?>"></td>
                        <td nowrap><input type="text" name="txtDeptCode[]" id="txtDeptCodesuppRow-2" class="txt" value="<?php echo $dtl->dept_code; ?>" /></td>
                        <td nowrap><textarea id="txtBlCodesuppRow-2" type="text" name="txtBlCode[]" rows="1" cols="30" class="txt"><?php echo $dtl->blCode; ?></textarea></td>
                        <td nowrap><input id="txtInputNameSuppRow-2" type="text" name="txtNameCOA[]" class="txt" value="<?php echo $dtl->coa_description; ?>" required="" /></td>
                        <td nowrap><input id="txtInputDebitRow-2" type="text" name="txtDebit[]" value="<?php echo number_format($dtl->debit, 2); ?>" onKeyup="calculateAmountDebit(); checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-debit col-deb txt txtnum" /></td>
                        <td nowrap><input id="txtInputCreditRow-2" type="text" name="txtCredit[]" value="<?php echo number_format($dtl->credit, 2); ?>" onKeyup="calculateAmountCredit(); checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-credit col-cre txt txtnum" /></td>

                        <td nowrap><input type="text" name="txtDebitUSD[]" id="txtInputDebitCBdetailRow-2-USD" value="<?php echo number_format($dtl->debit_usd, 2); ?>" class="col-debit-usd txt txtnum" /></td>
                        <td nowrap><input type="text" name="txtCreditUSD[]" id="txtInputCreditCBdetailRow-2-USD" value="<?php echo number_format($dtl->credit_usd, 2); ?>" class="col-credit-usd txt txtnum" /></td>
                        <td nowrap><input type="text" name="txtRemark[]" class="txt" value="<?php echo $dtl->remark; ?>" /></td>
                        <td nowrap>
                      ...
                      <?php
                        ...
                        if ($dtl->debit > 0) {
                            $gstClass = 'gst-value-debit';
                        } elseif ($dtl->credit > 0) {
                            $gstClass = 'gst-value-kredit';
                        }
                      ?>
                      <td nowrap><input type="text" value="<?php echo number_format($dtl->gst_value, 2); ?>" name="txtGSTvalue[]" class="txt txtnum gst-value <?php echo $gstClass; ?>" /></td>
            ...
            <div class="portlet-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <button class="btn btn-sm btn-primary" type="reset" onclick="javascript: window.location = '<?php echo site_url("CBtrans"); ?>';"> <i class="fa fa-plus"></i> New Transaction</button>
                  <button type="button" id="update_btn" onclick="confirmSubmit('update')" class="btn btn-success btn-sm">
                    <i class="fa fa-pencil"></i> Update
                  </button>
                </div>
                <div class="col-md-6 text-right">
                  <button type="button" onclick="confirmSubmit('delete')" class="btn btn-danger btn-sm">
...
<div id="formdialogExportRecord"></div>
...
<script>
  function confirmSubmit(actionType) {
    let message = actionType === 'update'
      ? "Apakah kamu yakin ingin mengupdate transaksi ini?"
      : "Apakah kamu yakin ingin menghapus transaksi ini?";

    bootbox.confirm(message, function(result) {
      if (result) {
        document.getElementById('formAction').value = actionType;
        document.getElementById('form-transCashBank').submit();
      }
    });
  }
</script>
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var cbDate = $('#txtInputDateTrans').val();

    if(cbDate){
        var partsCbDate = cbDate.split('-');
        var partsClosing = tgl.split('/');

        var yearCbDate = parseInt(partsCbDate[2], 10);
        var yearClosing = parseInt(partsClosing[2], 10);

        if(yearCbDate < yearClosing){
            $('#txtInputDateTrans').prop('disabled', true);
  ...
  $(document).ready(function() {
    ...
    $('#chkInterBank').on('click', function() {
      if ($(this).prop('checked')) {
        ...
        $('#form-transCashBank').attr('action', '<?php echo site_url('CBtrans/insertTransactionCBinterBank'); ?>');
        ...
        $('#form-transCashBank').attr('action', '<?php echo site_url('CBtrans/insertTransactionCB'); ?>');
      }
      checkGST();
    });
      ...
      if ($('#txtInputDateTrans').val() && $('#txtInputRateUSD').val() && $('#poTXTtypeIO').val()) {
        var goRefreshNum = setInterval(function() {
          if ($('#txtInputCurr').val() == 'USD' || $('#txtInputCurr').val() == 'SGD' || $('#txtInputCurr').val() == 'IDR') {
            ...
            // $.get("<?php echo base_url(); ?>CBtrans/newGenerateReffNumber", {
            ...
            if ($jen === 'CI' || $jen === 'CO') {
              $.get("<?php echo base_url(); ?>CBtrans/newGenerateReffNumberForCash", {
                txtTypeForGen: $('#poTXTtypeIO').val(),
                txtCurrForGen: $('#txtInputCurr').val(),
                txtDateForGen: $('#txtInputDateTrans').val()
              }, function(data, statuss) {
...
<script type="text/javascript">
  ...
  function fnExportExcel() {
    const dari = "<?php echo $dari; ?>";
    const sampai = "<?php echo $sampai; ?>";
      ...
      <div class="portlet-body">
        <div class="col-md-12">
          <div class="form-group row">
            <div class="form-group row">
              <label class="col-md-1 control-label label-sm">Find</label>
              <div class="col-md-7">
                <div class="input-group">
                  <input type="date" class="form-control" id="from" name="dari" value="${dari}" required>
                  <span class="input-group-addon">to</span>
                  <input type="date" class="form-control" id="to" name="sampai" value="${sampai}" required>
                </div>
              </div>
            </div>

            <div class="form-group row">
              <label class="col-md-1 control-label label-sm">Trans Type</label>
              <div class="col-md-7">
                <select name="trans_type" id="trans_type" class="form-control select2me">
                  <option value="">Select Transaction</option>
                  <option value="BI">Bank In</option>
                  <option value="BO">Bank Out</option>
           ...
           <div class="form-group row">
            <div class="col-md-offset-1 col-md-7">
              <button type="button" class="btn btn-primary" onclick="filtercashbank()">Search <i class="fa fa-search" aria-hidden="true"></i></button>
              <button type="button" class="btn btn-success" onclick="excelcashbank()" disabled id="excelcashbank">Excel <i class="fa fa-file-excel-o" aria-hidden="true"></i></button>
            </div>
          </div>
        </div><hr>
        <div class="table-scrollable" style="overflow: auto; height: 490px;">
          <table id="tbl-cashbank" class="table table-bordered">
            <thead>
              <tr>
                <th nowrap>Reff Number</th>
                <th nowrap>Date</th>
                <th nowrap>Code</th>
    ...
    $("#formdialogExportRecord").html(htmlContent);

    $("#formdialogExportRecord").dialog({
      resizable: false,
      modal: true,
      title: "List Cash Bank",
      height: 650,
      width: 1200
    }); 
  }

  function filtercashbank() {
    $awal = document.getElementById("from").value;
    $akhir = document.getElementById("to").value;
    $trans = document.getElementById("trans_type").value;
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>CBtrans/selectCBMonthly?from=" + $awal + "&to=" + $akhir + "&trans_type=" + $trans,
      success: function(response) {
        $("#tblcashbank").html(response);
        document.getElementById("excelcashbank").disabled = false;
      },
      dataType: "html"
    });
    return false;
  ...
  function excelcashbank() {
    var awal = document.getElementById("from").value;
    var akhir = document.getElementById("to").value;
    var trans = document.getElementById("trans_type").value;
    ...
    var url = "<?php echo base_url(); ?>Excel/selectReportCBMonthly?from=" + awal + "&to=" + akhir + "&trans_type=" + trans;
        ...
        pay: {
          ...
          callback: function() {
            ...
            $('table[id="tbl-cashGeneral"]').append('<tr class="' + cls + ' added-row-ismo">\n\
                                ...
                                <td nowrap><input type="text" name="txtBlCode[]" class="txt"/></td>\n\
...
console.log('value after addCommas:', i_debt[i].value);
    ...
    if (selisih != 0) {
      if (selisih > 0) {
        ...
        i_cret[1].value = addCommas((parseFloat((i_cret[1].value || '0').replace(/,/g, '')) + Math.abs(selisih)).toFixed(2));
        t_cret += parseFloat(Math.abs(selisih).toFixed(2));
      } else {
        ...
        i_debt[1].value = addCommas((parseFloat((i_debt[1].value || '0').replace(/,/g, '')) + Math.abs(selisih)).toFixed(2));
        t_debt += parseFloat(Math.abs(selisih).toFixed(2));
      }
    }
