                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input id="txtInputTransDate" name="txtTransDate" type="text" class="form-control input-sm date-picker" value="<?php echo date('d-m-Y'); ?>" data-yesterday="<?php echo date('d-m-Y',  mktime(0, 0, 0, date('m'), date('d') - 1, date('Y'))); ?>" data-now="<?php echo date('d-m-Y'); ?>" data-date-format="dd-mm-yyyy" readonly />
                      </div>
                    </div>
                    <div class="form-group ismo-hidden">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input id="txtInputRateVoucher" name="txtRateVoucher" type="text" class="form-control input-sm txt-ismo-back-null txtnum" data-date-format="yyyy-mm-dd" readonly />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateWeekly" name="txtRateBayar" class="form-control input-sm txtnum" required />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                ...
                <div class="col-md-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateNego" name="txtRateNego" class="form-control input-sm txtnum" required />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateEqui" name="txtRateEqui" class="form-control input-sm txtnum" required />
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-12">
                  <div class="col-sm-8">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" id="txtInputcekbank" name="txtcekbank" class="form-control input-sm txtnum" required />
                      </div>
                    </div>
                  </div>
                </div>
  ...
  $(document).ready(function() {
    ...
    $("#txtCUR2").change(function() {
      ...
      if ($('#inputCOA').val() === '') {
        ...
        //alert(noInvoice);
        var url = "<?php //echo site_url('ARtrans/getCurrOnDateInvoice');
                    ?>";
        $.post(url, {
          txtCurrency: valCUR,
        ...
        var url = "<?php //echo site_url('ARtrans/selectCurrencyAR');
                    ?>";
        $.ajax({
          url: url,
          data: {
    ...
    //     var rate2nd = parseFloat($('#txtInputRateWeekly').val().replace(/,/g, ''));

    //     var inByCurr1st = inUSD*rate1st;
    //     var inByCurr2nd = inUSD*rate2nd;
    //     var selisih     = (rate2nd-rate1st)*inUSD;
    ...
    //     }else{
    //         bootbox.confirm("Are you really want to submit this transaction?", function(result){
    //             if(result){
    //                 currentForm.submit();
    //             }
    //         });
...
<!-- <script>
  ...
  function Pilih_Invoice(x) {
    ...
    $('#tbl-detail-invoice tbody').append('<tr class="' + cls + ' added-row-ismo">\n\
            ...
            <td><input data-max="' + getText(document.getElementById('tbl-selectInvoice').rows[rr].cells[3]) + '" \n\
                ...
                class="txt col-ptot txtnum ' + cls + 'ar" onkeyup="CountPayTotal(); isNumber(); HitungPayment();"/></td>\n\
        </tr>');
  ...
  function HitungPayment() {
    ...
    amount_payment.value = total.toFixed(2);
    // alert("ini ibu budi");
  }
