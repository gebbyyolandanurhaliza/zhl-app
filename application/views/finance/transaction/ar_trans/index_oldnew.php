                  ...
                  <table class="table-ismo" id="tbl-detail-invoice">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td class="txtnum">
                          <input name="txtAvgRateVaucher" id="rateToCurr" class="txt txtnumRate txt-ismo-back-null" readonly="true" />
                        </td>
                        <td class="txtnum">
              ...
              <table class="table-ismo" id="tbl-cashGeneral">
                ...
                <tbody>
                  <tr id="rowSetCOA">
                    ...
                    <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-1" onKeyup="checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-credit col-cre txt txtnum" readonly value="0.00" /></td>
                  ...
                  <tr id="secendRowCashGeneral">
                    ...
                    <td nowrap><input id="txtInputDebitRow-2" type="text" name="txtDebit[]" onKeyup=" checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-debit col-deb txt txtnum" readonly value="0.00" /></td>
...
<script>
  ...
  function Pilih_Invoice(x) {
    ...
    $('#tbl-detail-invoice tbody').append('<tr class="' + cls + ' added-row-ismo">\n\
            ...
            <td hidden><input value="' + getText(document.getElementById('tbl-selectInvoice').rows[rr].cells[6]) + '" name="txtjenis[]" class="txt col-no-invoice"/></td>\n\
        </tr>');
  ...
  function convertToUSD() {
    ...
    if ($('#selInputCurrencyVoucher').val() == 'USD') {
      rateUSD = parseFloat($('#txtInputRateVoucher').val().replace(/,/g, ''));
    } else {
      rateUSD = parseFloat($('#txtInputRateNego').val().replace(/,/g, ''));
    }
