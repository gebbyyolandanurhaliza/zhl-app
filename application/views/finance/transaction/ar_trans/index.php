                ...
                <!-- <div class="col-md-12">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input id="txtInputRateVoucher" name="txtRateVoucher" type="text" class="form-control input-sm txt-ismo-back-null txtnumRate" readonly />
                                            </div>
                                        </div>
                                    </div>
                                </div> -->
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateBank" name="txtRateBayar" class="form-control input-sm txtnumRate" required onkeydown="return false;" onkeyup="return false;" onkeypress="return false;" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateSGD" name="txtRateSGD" class="form-control input-sm txtnumRate" required onkeydown="return false;" onkeyup="return false;" onkeypress="return false;" />
                      </div>
                    </div>
                  </div>
              ...
              <table class="table-ismo" id="tbl-cashGeneral">
                ...
                <tbody>
                  <tr id="rowSetCOA">
                    ...
                    <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-1" onKeyup="checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-debit col-deb txt txtnum" value="0.00" /></td>
                    <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-1" onKeyup="checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-credit col-cre txt txtnum" value="0.00" /></td>
                  ...
                  <tr id="secendRowCashGeneral">
                    ...
                    <td nowrap><input id="txtInputDebitRow-2" type="text" name="txtDebit[]" onKeyup=" checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-debit col-deb txt txtnum" value="0.00" /></td>
                    <td nowrap><input id="txtInputCreditRow-2" type="text" name="txtCredit[]" onKeyup=" checkGST(); convertToUSD();" onblur="convertToUSD();" class="col-credit col-cre txt txtnum" value="0.00" /></td>
                  ...
                  <tr id="thridhRowCashGeneral">
                    ...
                    <td nowrap>
                      <input type="text" name="txtDeptCode[]" class="txt" value="001" readonly />
                    </td>
                    ...
                    <td nowrap><input type="text" id="txtInputGSTvalue2nd" name="txtGSTvalue[]" class="txt txtnum gst-value  display-none" /></td>
                  </tr>
                </tbody>
                ...
                <tfoot id="detailRowForAddCost">
                  ...
                  <tr id="addCostRow1">
                    ...
                    <td nowrap><input type="text" name="txtDeptCode[]" class="txt" value="001" readonly /></td>
                    <td nowrap><input type="text" name="txtNameCOA[]" id="txtInputNameSuppRow-addCostRow-1" class="txt" value="Bank Charges" readonly /></td>
                    <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-addCostRow-1" onkeyup="checkGST();" class="col-deb txt txtnum" value="0.00" /></td>
                    <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-addCostRow-1" onkeyup="checkGST();" class="col-credit col-cre txt txtnum" value="0.00" /></td>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#txtInputTransDate, #txtCUR2, #txtInputRateSGD').on('change blur', function() {
      ...
      // APtransNew/newGenerateReffNumber
      if ($('#txtInputTransDate').val()) {
        setInterval(function() {
          $.get("<?php echo base_url(); ?>APtransNew/newGenerateReffNumber2", {
            txtTypeForGen: 'IN',
    ...
    //==============GST=========
    $('#txtInputCOAsuppRow-GSTlast-1').val('400101');
    ...
    $("#btnCalculateDetail").click(function() {
      if (!$('#inputCOA').val()) {
        bootbox.alert('Please Choose Bank Account First!!');
      } else {
...
<script>
  function Pilih_Supllier(x) {
    ...
    $('#txtInputSuplierRemark').val('Received Payment from ' + getText(document.getElementById('tbl-selectSupplier').rows[$r].cells[1]));
    ...
    listCoa.forEach(function(element) {
        var Nocoa = element.NewCOA;
        var sub_account = element.sub_account_type;

        // kondisi untuk coaDetailRow2
        if(Nocoa == coaDetail2){
          if(sub_account == "DEPT"){
            $('#txtDeptCodeRow-2').html(`<select name="txtDeptCode[]" class="txt">
                <option value=""> -- Select --</option>
            ...
            $('#txtDeptCodeRow-2').html(`<input name="txtDeptCode[]" type="text" class="txt" value="000" readonly required />`);
          }
        }else{ 
          $('#txtDeptCodeRow-2').html(`<input name="txtDeptCode[]" type="text" class="txt" value="000" readonly required />`);
        }
  ...
  function Pilih_Invoice(x) {
    ...
    var jenis = getText(document.getElementById('tbl-selectInvoice').rows[rr].cells[8]);
    var totexcRtUSD = getText(document.getElementById('tbl-selectInvoice').rows[rr].cells[10]).replace(/,/g, '');
    var totexcRtSGD = getText(document.getElementById('tbl-selectInvoice').rows[rr].cells[11]).replace(/,/g, '');
    ...
    $('#tbl-detail-invoice tbody').append('<tr class="' + cls + ' added-row-ismo">\n\
            ...
            <td><input value="' + Number(ratePay).toFixed(6) + '" name="txtNewRateToPayDtl[]" class="txt txtnum val-rate" readonly/></td>\n\
    ...
    // $('#txtInputRateVoucher').val(addCommas(Number(rate).toFixed(6)));
    // $('#rateTotalID').val(addCommas(Number(rate).toFixed(6)));
    // CountGrandTotal();
  ...
  function calculateInvoiceDetail() {
    ...
    for (var i = 0; i < valTotBef.length; i++) {
      ...
      var a = Number(valTotBef[i].value.replace(/,/g, '')).toFixed(2) * Number(totexcRtUSD[i].value.replace(/,/g, '')).toFixed(6);
      var b = Number(valTotBef[i].value.replace(/,/g, '')).toFixed(2) * Number(totexcRtSGD[i].value.replace(/,/g, '')).toFixed(6);

      totexcUSD[i].value = addCommas(a.toFixed(2));
      totexcSGD[i].value = addCommas(b.toFixed(2));
    }
    ...
    if (totalAP < 0) {
      ...
      $('#txtInputCreditCBdetailRow-1').val(addCommas(Number(Math.abs(grandPay)).toFixed(2)));
      $('#txtInputDebitRow-2').val(addCommas(Number(Math.abs(totalAP)).toFixed(2)));
      $('#txtInputCreditRow-2').val("0.00");
    } else {
      $('#txtInputDebitCBdetailRow-1').val(addCommas(Number(grandPay).toFixed(2)));
      $('#txtInputCreditCBdetailRow-1').val("0.00");
      $('#txtInputDebitRow-2').val("0.00");
      $('#txtInputCreditRow-2').val(addCommas(Number(totalAP).toFixed(2)));
    }

    var valExR = Number(exRate).toFixed(2);
    if (exRate >= 0) {
      $('#txtInputCreditRow-3').val(addCommas(Number(exRate).toFixed(2)));
      $('#txtInputDebitRow-3').val(addCommas(Number('00').toFixed(2)));
    } else {
      $('#txtInputCreditRow-3').val(addCommas(Number('00').toFixed(2)));
      $('#txtInputDebitRow-3').val(addCommas(Number(valExR.replace(/-/g, ''))));
    }
  ...
  function CountPayTotal() {
    ...
    $('#txtInputDebitCBdetailRow-1').val(addCommas(sumPay.toFixed(2)));
  }
  ...
  function CountGrandTotal() {
    ...
    var avgRate = $('#txtInputRateVoucher').val().replace(/,/g, '');
    $('#payTotalID').val(addCommas(sumPay.toFixed(2)));
        ...
        pay: {
          ...
          callback: function() {
            ...
            $('table[id="tbl-cashGeneral"] tfoot[id="detailRowForAddCost"]').append('<tr class="' + cls + ' added-row-ismo">\n\
                            ...
                            <td nowrap><input type="text" name="txtRemark[]" class="txt"/></td>\n\
                            <td nowrap><input type="text" name="txtGST[]" class="txt display-none"/></td>\n\
                            <td nowrap><input type="text" name="txtGSTvalue[]" class="txt txtnum gst-value gst-value-debit display-none"/></td>\n\
                        </tr>');
  ...
  function Pilih_MCOA(x) {
    ...
    if (valCUR != 'ALL') {
      ...
      $.post("<?php echo site_url('ARtrans/getCurrBank'); ?>", {
        txtCurrency: valCUR,
        ...
        // $('#txtInputRateNego').val(0);

        // var no  = 0;
        // var jml = document.getElementsByClassName('col-equi-curr');
        // jml = parseInt(jml.length) - 1;
        // $('input.col-rate-curr').each(function() {
        //     $(this).val(parseFloat(get.inv[no++]).toFixed(6));
        //     $('#rateToCurr').val(parseFloat(get.inv[jml]).toFixed(6));
        // });
  ...
  function exRate() {
    ...
    var totalhutsgd = (sgd_cret[1].value.replace(/,/g, '')) - (sgd_debt[1].value.replace(/,/g, ''));
    var totalhutusd = (usd_cret[1].value.replace(/,/g, '')) - (usd_debt[1].value.replace(/,/g, ''));
    var excratesgd = (sgd_cret[2].value.replace(/,/g, '')) - (sgd_debt[2].value.replace(/,/g, ''));
    var excrateusd = (usd_cret[2].value.replace(/,/g, '')) - (usd_debt[2].value.replace(/,/g, ''));
    // alert(excratesgd);
    ...
    if (mewtotalhutsgd < 0) {
      sgd_debt[1].value = number_format(Math.abs(mewtotalhutsgd), 2); //addCommas(Number(Math.abs(mewtotalhutsgd.toFixed(2))));
