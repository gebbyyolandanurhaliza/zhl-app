<div class="table-responsive">
    <table id="tbl-selectDeposit-hasRecorded" class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr data-id="<?php echo encode_str($row->header_id);?>" onclick="selectAPdepositForFind(this)">
...
<script>
    $(document).ready(function() {
        ...
        /*$("#tbl-selectDeposit-hasRecorded tbody tr").click( function (){
            ...
            //alert(header);
            window.location = "<?php //echo site_url();?>DownPaymentAPNew/reviewDepositAP/" +header;
        });*/
    });
    
    function selectAPdepositForFind(obj){
        var header  = $(obj).data('id');
        //alert(header);
        window.location = "<?php echo site_url();?>DownPaymentAPNew/reviewDepositAP/" +header;
    }
</script>