                ...
                <div class="col-md-6">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="hidden" type="text" id="txtInputRateNego" name="txtRateNego" value="<?php echo number_format($_selectHeader->dp_rate_nego, 6); ?>" onblur="javascript: countSecend(); calculateDetalTes();" class="form-control input-sm txtnumRate" required />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="hidden" type="text" id="txtInputBank" name="txtRateBank" value="<?php echo number_format($_selectHeader->dp_rate_to_bank, 6); ?>" class="form-control input-sm hanya-baca txtnumRate" required />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <table class="table-ismo" id="tbl-detail-journal">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" id="inputTypeJurnal1" name="JenisJurnal[]" value="<?php if (!empty($_selectDetail[0]->coa_description)) {
                                                                                                    echo $_selectDetail[0]->coa_description;
                                                                                                  } ?>" class="txt"></td>
                        <td><input type="text" id="inputDesc1" name="desc[]" value="<?php if (!empty($_selectDetail[0]->remark)) {
                        ...
                        <td><input type="text" name="rate_jr[]" id="inputRate1" value="<?php if (!empty($_selectHeader->currency_rate)) {
                                                                                          echo number_format($_selectHeader->currency_rate, 6);
                                                                                        } ?>" class="txt txtnumRate number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" id="inputDebt1" value="<?php if (!empty($_selectDetail[0]->debit_usd)) {
                                                                                          echo number_format($_selectDetail[0]->debit_usd, 2);
                                                                                        } ?>" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" id="inputCredit1" value="<?php if (!empty($_selectDetail[0]->credit_usd)) {
                                                                                              echo number_format($_selectDetail[0]->credit_usd, 2);
                                                                                            } ?>" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_dtl[]" id="inputDebtDtl1" value="<?php if (!empty($_selectDetail[0]->debit)) {
                                                                                              echo number_format($_selectDetail[0]->debit, 2);
                                                                                            } ?>" class="txt txtnum number jur_deb_dtl" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_dtl[]" id="inputCreditDtl1" value="<?php if (!empty($_selectDetail[0]->credit)) {
                                                                                                  echo number_format($_selectDetail[0]->credit, 2);
                                                                                                } ?>" class="txt txtnum number jur_credit_dtl" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        ...
                        <td><input type="text" id="inputTypeJurnal2" name="JenisJurnal[]" value="<?php if (!empty($_selectDetail[1]->coa_description)) {
                                                                                                    echo $_selectDetail[1]->coa_description;
                                                                                                  } ?>" class="txt"></td>
                        <td><input type="text" id="inputDesc2" name="desc[]" value="<?php if (!empty($_selectDetail[1]->remark)) {
                                                                                      echo $_selectDetail[1]->remark;
                                                                                    } ?>" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal2" name="total_jr[]" value="<?php if (!empty($_selectDetail[1]->total_awal)) {
                                                                                                        ...
                                                                                                        } ?>" class="txt txtnum number no-ro jur_total" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" id="inputRate2" value="<?php if (!empty($_selectHeader->currency_rate)) {
                                                                                          echo number_format($_selectHeader->currency_rate, 6);
                                                                                        } ?>" class="txt txtnumRate number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" id="inputDebt2" value="<?php if (!empty($_selectDetail[1]->debit_usd)) {
                                                                                          echo number_format($_selectDetail[1]->debit_usd, 2);
                                                                                        } ?>" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" id="inputCredit2" value="<?php if (!empty($_selectDetail[1]->credit_usd)) {
                                                                                              echo number_format($_selectDetail[1]->credit_usd, 2);
                                                                                            } ?>" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_dtl[]" id="inputDebtDtl2" value="<?php if (!empty($_selectDetail[1]->debit)) {
                                                                                              echo number_format($_selectDetail[1]->debit, 2);
                                                                                            } ?>" class="txt txtnum number jur_deb_dtl" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_dtl[]" id="inputCreditDtl2" value="<?php if (!empty($_selectDetail[1]->credit)) {
                      ...
                      <tr>
                        ...
                        <td class="total"><input type="text" id="inputTotal3" name="total_jr[]" value="<?php if (!empty($_selectDetail[2]->total_awal)) {
                                                                                                          echo number_format($_selectDetail[2]->total_awal, 2);
                                                                                                        } ?>" class="txt txtnum number jur_total" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" id="inputRate3" value="<?php if (!empty($_selectHeader->currency_rate)) {
                                                                                          echo number_format($_selectHeader->currency_rate, 6);
                                                                                        } ?>" class="txt txtnumRate number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" id="inputDebt3" value="<?php if (!empty($_selectDetail[2]->debit_usd)) {
                                                                                          echo number_format($_selectDetail[2]->debit_usd, 2);
                                                                                        } ?>" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" id="inputCredit3" value="<?php if (!empty($_selectDetail[2]->credit_usd)) {
                                                                                              echo number_format($_selectDetail[2]->credit_usd, 2);
                                                                                            } ?>" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_dtl[]" id="inputDebtDtl3" value="<?php if (!empty($_selectDetail[2]->debit)) {
                                                                                              echo number_format($_selectDetail[2]->debit, 2);
                                                                                            } ?>" class="txt txtnum number jur_deb_dtl" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_dtl[]" id="inputCreditDtl3" value="<?php if (!empty($_selectDetail[2]->credit)) {
...
<script type="text/javascript">
  ...
  function calculateDetalTes() {
    var total = $('#txtInputTotal').val().replace(/,/g, ''),
      ...
      totalBank = Number(total),
      totalDP = Number(total),
      rateUSD = $('#txtInputBank').val(),
      totBankUSD = totalBank * Number(rateUSD),
      totDpUSD = totalDP * Number(rateUSD);
