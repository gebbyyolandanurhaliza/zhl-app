...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      ...
      <form role="form" method="post" id="form-downPaymentAP" action="<?php echo base_url(); ?>DownPaymentAPNew/insertDownPayment" class="form-horizontal">
        <div class="col-md-12">
            ...
            <div class="portlet-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <script>
                    $('#txtInputNoReff').on('blur', function() {
                      ...
                      $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>DownPaymentAPNew/cekNumReffDeposit",
                        data: {
                          value: val
                        },
                        dataType: "json",
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="txtInputCurrencyBank" name="txtCurrencyBank" class="form-control input-sm" readonly />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="txtInputTotal" name="txtTotal" class="form-control input-sm txtnum" title="Double Click for Edit" />
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="col-md-6">
                    <div class="form-group">
                      <!-- <label class="control-label col-sm-4">Rate Nego to [<span class="getHeaderCurr"></span>]</label> -->
                      <div class="col-sm-8">
                        <input type="hidden" type="text" id="txtInputRateNego" name="txtRateNego" onblur="javascript: countSecend(); calculateDetalTes();" class="form-control input-sm txtnumRate" required />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="hidden" type="text" id="txtInputBank" name="txtRateBank" class="form-control input-sm hanya-baca txtnumRate" required />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input id="txtInputTglTrans" name="txtTransDate" value="<?php //echo date('d-m-Y');
                                                                                ?>" type="text" class="form-control input-sm date-picker" data-date-format="dd-mm-yyyy">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input id="txtInputTglTransInv" name="txtTransDateInv" value="<?php //echo date('d-m-Y');
                                                                                      ?>" type="text" class="form-control input-sm date-picker" data-date-format="dd-mm-yyyy">
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input id="txtInputTglJatuhTempo" name="txtDeuDate" value="<?php //echo date('d-m-Y');
                                                                                    ?>" type="text" class="form-control input-sm date-picker" data-date-format="dd-mm-yyyy">
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table-ismo" id="tbl-detail-calculation">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" id="txtTesTotal" name="txtInputTesTotal" class="txt" /></td>
                        <td><input type="text" id="txtTesRateConv" name="txtInputTesRateConv" class="txt" /></td>
                        <td><input type="text" id="txtTesRateNego" name="txtInputTesRateNego" class="txt" /></td>
                        <td><input type="text" id="txtTesTotalBank" name="txtInputTesTotalBank" class="txt" /></td>
                        <td><input type="text" id="txtTesTotalDP" name="txtInputTesTotalDP" class="txt" /></td>
                        <td><input type="text" id="txtTesRateUSD" name="txtInputTesRateUSD" class="txt" /></td>
                        <td><input type="text" id="txtTesBankUSD" name="txtInputTesBankUSD" class="txt" /></td>
                        <td><input type="text" id="txtTesDpUSD" name="txtInputTesDpUSD" class="txt" /></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table class="table-ismo" id="tbl-detail-journal">
                    <thead>
                      <tr>
                        ...
                        <th>Debt [USD]</th>
                        <th>Credit [USD]</th>
                        <th>Debt [<span class="getHeaderCurr"></span>]</th>
                        <th>Credit [<span class="getHeaderCurr"></span>]</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" name="rate_jr[]" id="inputRate1" class="txt txtnumRate number jr_rate" onkeypress="return isNumber(event)"></td>
                        ...
                        <td><input type="text" name="debt_dtl[]" id="inputDebtDtl1" class="txt txtnum number jur_deb_dtl" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_dtl[]" id="inputCreditDtl1" class="txt txtnum number jur_credit_dtl" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        ...
                        <td><input type="text" name="rate_jr[]" id="inputRate2" class="txt txtnumRate number jr_rate" onkeypress="return isNumber(event)"></td>
                        ...
                        <td><input type="text" name="debt_dtl[]" id="inputDebtDtl2" class="txt txtnum number jur_deb_dtl" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_dtl[]" id="inputCreditDtl2" class="txt txtnum number jur_credit_dtl" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        ...
                        <td><input type="text" name="rate_jr[]" id="inputRate3" class="txt txtnumRate number jr_rate" onkeypress="return isNumber(event)"></td>
                        ...
                        <td><input type="text" name="debt_dtl[]" id="inputDebtDtl3" class="txt txtnum number jur_deb_dtl" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_dtl[]" id="inputCreditDtl3" class="txt txtnum number jur_credit_dtl" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <!-- <tr>
                                                <td></td>
                                                <td><input type="text" id="inputNoCOA4" name="no_coa[]" class="no_coa txt" value="610009" autocomplete="off"></td>
                                                <td><input type="text" id="dk4" name="dk[]" class="dk txt40" value=""></td>
                                                ...
                                                <td class="total"><input type="text" id="inputTotal4" name="total_jr[]" class="txt txtnum number jur_total"  onkeypress="return isNumber(event)"></td>
                                                <td><input type="text" name="rate_jr[]" id="inputRate4" class="txt txtnumRate number jr_rate" onkeypress="return isNumber(event)"></td>
                                                <td><input type="text" name="debt_jr[]" id="inputDebt4" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                                                <td><input type="text" name="credit_jr[]" id="inputCredit4" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                                                <td><input type="text" name="debt_dtl[]" id="inputDebtDtl4" class="txt txtnum number jur_deb_dtl" onkeypress="return isNumber(event)"></td>
                                                <td><input type="text" name="credit_dtl[]" id="inputCreditDtl4" class="txt txtnum number jur_credit_dtl" onkeypress="return isNumber(event)"></td>
                                            </tr> -->
                    </tbody>
                  </table>
                </div>
...
<script type="text/javascript">
  ...
  function calculateDetalTes() {
    ...
    // if(excRate > 0){
    //     $('#dk4').val('D');
    //     $('#inputDebt4').val(addCommas(Number(excRateUSD).toFixed(2)));
    //     $('#inputDebtDtl4').val(addCommas(Number(excRate).toFixed(2)));
    ...
    //     $('#inputCredit4').val(addCommas(Number(excMinUSD).toFixed(2)));
    //     $('#inputCreditDtl4').val(addCommas(Number(excMinBiasa).toFixed(2)));
    // }
  ...
  function calculateTotal() {
    ...
    var hasil = total;
    var hasilUSD = total * Number(rateBank);


    $('#inputCredit1').val(addCommas(hasilUSD.toFixed(2)));
    $('#inputCreditDtl1').val(addCommas(hasil.toFixed(2)));
