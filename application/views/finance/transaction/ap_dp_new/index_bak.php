              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="txtInputTotal" name="txtTotal" class="form-control input-sm txtnum" />
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="hidden" id="txtInputCurrencyBank" name="txtCurrencyBank" />
...
<script type="text/javascript">
  ...
  function calculateDetalTes() {
    ...
    $('#inputCredit1').val(Number(totBankUSD).toFixed(2));
    ...
    $('#inputCreditDtl1').val(Number(totalBank).toFixed(2));
