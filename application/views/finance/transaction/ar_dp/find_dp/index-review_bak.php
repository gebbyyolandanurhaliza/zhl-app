                  ...
                  <table class="table-ismo" id="tbl-detail-journal">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" id="inputTypeJurnal1" value="<?php echo $_selectDetail[0]->coa_description; ?>" name="JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc1" value="<?php echo $_selectDetail[0]->remark; ?>" name="desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal1" name="total_jr[]" value="<?php echo number_format($_selectDetail[0]->total_awal, 2); ?>" class="txt number txtnum jur_total" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" value="<?php echo number_format($_selectHeader->currency_rate, 6); ?>" id="inputRate1" class="txt number txtnum jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php echo number_format($_selectDetail[0]->debit, 2); ?>" id="inputDebt1" class="txt number txtnum jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php echo number_format($_selectDetail[0]->credit, 2); ?>" id="inputCredit1" class="txt number txtnum jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        ...
                        <td><input type="text" id="inputTypeJurnal2" value="<?php echo $_selectDetail[1]->coa_description; ?>" name="JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc2" value="<?php echo $_selectDetail[1]->remark; ?>" name="desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal2" name="total_jr[]" value="<?php echo number_format($_selectDetail[1]->total_awal, 2); ?>" class="txt number txtnum jur_total no-ro" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" value="<?php echo number_format($_selectHeader->currency_rate, 6); ?>" id="inputRate2" class="txt number txtnum jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php echo number_format($_selectDetail[1]->debit, 2); ?>" id="inputDebt2" class="txt number txtnum jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php echo number_format($_selectDetail[1]->credit, 2); ?>" id="inputCredit2" class="txt number txtnum jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
