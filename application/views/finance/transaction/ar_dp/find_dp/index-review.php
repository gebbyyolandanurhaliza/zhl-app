              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" style="background-color: #D2E0D1;" value="<?php if (!empty($_selectDetail[1]->remark)) {
                                                                                      echo $_selectDetail[1]->remark;
                                                                                    } ?>" id="txtInputVendor" name="txtVendor" class="form-control input-sm" />
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea id="txtInputRemark" name="txtRemark" class="form-control"><?php echo $_selectHeader->trans_description; ?></textarea>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                ...
                <div class="col-md-12 table-responsive" style="padding-bottom: 15px;">
                  <table class="table-ismo" id="tbl-detail-journal">
                    ...
                    <tbody>
                      <tr>
                        <td></td>
                        <td><input type="text" id="inputNoCOA1" name="no_coa[]" class="no_coa txt" value="<?php if (!empty($_selectDetail[0]->coa)) {
                                                                                                            echo $_selectDetail[0]->coa;
                                                                                                          } ?>" autocomplete="off"></td>
                        <td><input type="text" id="dk1" name="dk[]" class="dk txt40" value="D"></td>
                        <td><input type="text" id="inputTypeJurnal1" value="<?php if (!empty($_selectDetail[0]->coa_description)) {
                                                                              echo $_selectDetail[0]->coa_description;
                                                                            } ?>" name="JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc1" value="<?php if (!empty($_selectDetail[0]->remark)) {
                                                                        echo $_selectDetail[0]->remark;
                                                                      } ?>" name="desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal1" name="total_jr[]" value="<?php if (!empty($_selectDetail[0]->total_awal)) {
                                                                                                          echo number_format($_selectDetail[0]->total_awal, 2);
                                                                                                        } ?>" class="txt number txtnum jur_total" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" value="<?php if (!empty($_selectHeader->currency_rate)) {
                                                                          echo number_format($_selectHeader->currency_rate, 6);
                                                                        } ?>" id="inputRate1" class="txt number txtnum jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php if (!empty($_selectDetail[0]->debit)) {
                                                                          echo number_format($_selectDetail[0]->debit, 2);
                                                                        } ?>" id="inputDebt1" class="txt number txtnum jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php if (!empty($_selectDetail[0]->credit)) {
                                                                            echo number_format($_selectDetail[0]->credit, 2);
                                                                          } ?>" id="inputCredit1" class="txt number txtnum jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td><input type="text" id="inputNoCOA2" name="no_coa[]" class="no_coa txt" value="<?php if (!empty($_selectDetail[1]->coa)) {
                                                                                                            echo $_selectDetail[1]->coa;
                                                                                                          } ?>" autocomplete="off"></td>
                        <td><input type="text" id="dk2" name="dk[]" class="dk txt40" value="C"></td>
                        <td><input type="text" id="inputTypeJurnal2" value="<?php if (!empty($_selectDetail[1]->coa_description)) {
                                                                              echo $_selectDetail[1]->coa_description;
                                                                            } ?>" name="JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc2" value="<?php if (!empty($_selectDetail[1]->remark)) {
                                                                        echo $_selectDetail[1]->remark;
                                                                      } ?>" name="desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal2" name="total_jr[]" value="<?php if (!empty($_selectDetail[1]->total_awal)) {
                                                                                                          echo number_format($_selectDetail[1]->total_awal, 2);
                                                                                                        } ?>" class="txt number txtnum jur_total no-ro" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" value="<?php if (!empty($_selectHeader->currency_rate)) {
                                                                          echo number_format($_selectHeader->currency_rate, 6);
                                                                        } ?>" id="inputRate2" class="txt number txtnum jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php if (!empty($_selectDetail[1]->debit)) {
                                                                          echo number_format($_selectDetail[1]->debit, 2);
                                                                        } ?>" id="inputDebt2" class="txt number txtnum jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php if (!empty($_selectDetail[1]->credit)) {
                                                                            echo number_format($_selectDetail[1]->credit, 2);
                                                                          } ?>" id="inputCredit2" class="txt number txtnum jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td><input type="text" id="inputNoCOA3" name="no_coa[]" class="no_coa txt" value="<?php if ($_jumDetail < 3) {
                                                                                                            echo '610001';
                                                                                                          } else {
                                                                                                            echo $_selectDetail[2]->coa;
                                                                                                          } ?>" autocomplete="off"></td>
                        <td><input type="text" id="dk3" name="dk[]" class="dk txt40" value="D"></td>
                        <td><input type="text" id="inputTypeJurnal3" value="<?php if ($_jumDetail < 3) {
                                                                              echo 'Bank Charges';
                                                                            } else {
                                                                              echo $_selectDetail[2]->coa_description;
                                                                            } ?>" name="JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc3" value="<?php if ($_jumDetail < 3) {
                                                                        echo '';
                                                                      } else {
                                                                        echo $_selectDetail[2]->remark;
                                                                      } ?>" name="desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal3" name="total_jr[]" value="<?php if ($_jumDetail < 3) {
                                                                                                          echo '0.00';
                                                                                                        } else {
                        ...
                        <td><input type="text" name="rate_jr[]" value="<?php if ($_jumDetail < 3) {
                                                                          ...
                                                                          echo number_format($_selectHeader->currency_rate, 6);
                                                                        } ?>" id="inputRate3" class="txt txtnum number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php if ($_jumDetail < 3) {
                                                                          echo '0.00';
                                                                        } else {
                                                                          echo number_format($_selectDetail[2]->debit, 2);
                                                                        } ?>" id="inputDebt3" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php if ($_jumDetail < 3) {
                                                                            echo '0.00';
                                                                          } else {
                                                                            echo number_format($_selectDetail[2]->credit, 2);
                                                                          } ?>" id="inputCredit3" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#btnSubmitUpdate").click(function() {
      $("#form-downPaymentAP").attr('action', "<?php echo base_url(); ?>DownPaymentAR/updateDepositAR");
...
<script type="text/javascript">
  ...
  function Pilih_Supllier(x) {
    ...
    $('#inputNoCOA2').val('200508');
    $('#txtInputVendorCOA').val(suppcoa);
    $('#inputTypeJurnal2').val('Customer Deposit');
