                  ...
                  <table class="table-ismo" id="tbl-detail-journal">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="total"><input type="text" id="inputTotal1" name="total_jr[]" value="0.00" class="txt number jur_total" onkeyup="hitung_total()" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" id="inputRate1" class="txt number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" id="inputDebt1" value="0.00" class="txt number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" id="inputCredit1" value="0.00" class="txt number jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        ...
                        <td class="total"><input type="text" id="inputTotal2" name="total_jr[]" value="0.00" class="txt number jur_total" onkeyup="hitung_total()" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" id="inputRate2" class="txt number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" id="inputDebt2" value="0.00" class="txt number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" id="inputCredit2" value="0.00" class="txt number jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
