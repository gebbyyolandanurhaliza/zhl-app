            ...
            <div class="portlet-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <button class="btn btn-sm btn-default" id="btnPrint" type="button" onclick="javascript: window.open('<?php echo site_url("DownPaymentAR/printInvoiceDeposit/" . encode_str($_selectHeader->header_id)); ?>?cur=<?php echo $_selectHeader->currency_id; ?>');">
...
<script type="text/javascript">
  ...
  function countBankCharge() {
    ...
    $('#inputCredit2').val(addCommas(deb2.toFixed(2)));
