...
<script type="text/javascript">
  ...
  function ganti_signature() {
    var cetak = document.getElementById('btnPrint2');
    var locAppend = $('#signature').find('option:selected').val(),
      locSnip = window.location.href.split('edit')[0];
    cetak.href = "<?php echo site_url("DownPaymentAR/printInvoiceDeposit/" . encode_str($_selectHeader->header_id)); ?>?cur=<?php echo $_selectHeader->currency_id; ?>&signature=" + locAppend;
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption theme-font">
                ...
                <span class="caption-subject bold uppercase"> AR Down Payment</span>
                <span class="caption-helper"> Receivable Recognation</span>
              </div>
              <div class="tools">
              ...
              <div class="actions">
                <a class="btn btn-circle btn-primary" href="<?php echo site_url(); ?>DownPaymentAR">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div id="div-ReffNum" class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="txtInputNoReff" value="<?php echo $_selectHeader->no_reff; ?>" name="txtNoReff" class="form-control input-sm" readonly />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      ...
                      <input type="hidden" id="txtInputVendorCOA" name="txtVendorCOA" value="<?php echo $_selectHeader->cust_coa; ?>" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" style="background-color: #D2E0D1;" value="<?php echo $_selectHeader->cust_name; ?>" id="txtInputVendor" name="txtVendor" class="form-control input-sm" />
                    </div>
                  </div>
                      ...
                      <select class="form-control input-sm" name="selCBCode" id="selInputCBCode" onchange="changeCodeCB(this)">
                        ...
                        <?php foreach ($_selectMasterCOA as $row) : ?>
                          <?php if ($row->NoCOA == $_selectHeader->cashbank_code) : ?>
                            <option value="<?php echo $row->NoCOA; ?>" selected>
                              <?php echo $row->NoCOA; ?> ~ <?php echo $row->AccountName; ?></option>
                          <?php else : ?>
                            <option value="<?php echo $row->NoCOA; ?>">
                              <?php echo $row->NoCOA; ?> ~ <?php echo $row->AccountName; ?></option>
                          <?php endif; ?>
                        <?php endforeach; ?>
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="txtInputTotal" name="txtTotal" value="<?php echo number_format($_selectHeader->dp_total, 2); ?>" class="form-control input-sm txtnum" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="txtInputChequeNumber" name="txtChequeNumber" value="<?php echo $_selectHeader->check_bank; ?>" class="form-control input-sm" required />
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateSGD" value="<?php echo number_format($_selectHeader->dp_rate_sgd, 6); ?>" name="txtRateCurrSGD" class="form-control input-sm hanya-baca txtnumRate" required />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input id="txtInputJangkaTempo" type="text" value="<?php echo $_selectHeader->dp_term; ?>" name="txtTermDay" class="form-control input-sm" required />
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea id="txtInputRemark" name="txtRemark" class="form-control" onkeyup="$('#inputDesc2-dp').val($(this).val());"><?php echo $_selectHeader->trans_description; ?></textarea>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label col-sm-2">PO</label>
                          <div class="col-sm-10">
                            <textarea id="txtInputPO" name="txtPO" class="form-control"></textarea>
                ...
                <div class="col-md-12 table-responsive" style="padding-bottom: 15px;">
                  <table class="table-ismo" id="tbl-detail-journal">
                    ...
                    <tbody>
                      <tr>
                        <td></td>
                        <td><input type="text" id="inputNoCOA1-dp" name="no_coa[]" class="no_coa txt" value="<?php echo $_selectDetail[0]->coa; ?>" autocomplete="off"></td>
                        <td><input type="text" id="dk1-dp" name="dk[]" class="dk txt40" value="D"></td>
                        <td><input type="text" id="inputTypeJurnal1-dp" value="<?php echo $_selectDetail[0]->coa_description; ?>" name="JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc1-dp" value="<?php echo $_selectDetail[0]->remark; ?>" name="desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal1-dp" name="total_jr[]" value="<?php echo number_format($_selectDetail[0]->total_awal, 2); ?>" class="txt number txtnum jur_total" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" value="<?php echo number_format($_selectHeader->currency_rate, 6); ?>" id="inputRate1-dp" class="txt number txtnum jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php echo number_format($_selectDetail[0]->debit, 2); ?>" id="inputDebt1-dp" class="txt number txtnum jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php echo number_format($_selectDetail[0]->credit, 2); ?>" id="inputCredit1-dp" class="txt number txtnum jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td><input type="text" id="inputNoCOA2-dp" name="no_coa[]" class="no_coa txt" value="<?php echo $_selectDetail[1]->coa; ?>" autocomplete="off"></td>
                        <td><input type="text" id="dk2-dp" name="dk[]" class="dk txt40" value="C"></td>
                        <td><input type="text" id="inputTypeJurnal2-dp" value="<?php echo $_selectDetail[1]->coa_description; ?>" name="JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc2-dp" value="<?php echo $_selectDetail[1]->remark; ?>" name="desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal2-dp" name="total_jr[]" value="<?php echo number_format($_selectDetail[1]->total_awal, 2); ?>" class="txt number txtnum jur_total no-ro" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" value="<?php echo number_format($_selectHeader->currency_rate, 6); ?>" id="inputRate2-dp" class="txt number txtnum jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php echo number_format($_selectDetail[1]->debit, 2); ?>" id="inputDebt2-dp" class="txt number txtnum jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php echo number_format($_selectDetail[1]->credit, 2); ?>" id="inputCredit2-dp" class="txt number txtnum jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td><input type="text" id="inputNoCOA3-dp" name="no_coa[]" class="no_coa txt" value="<?php if ($_jumDetail < 3) {
                                                                                                                echo '610001';
                                                                                                              } else {
                                                                                                                echo $_selectDetail[2]->coa;
                                                                                                              } ?>" autocomplete="off"></td>
                        <td><input type="text" id="dk3-dp" name="dk[]" class="dk txt40" value="D"></td>
                        <td><input type="text" id="inputTypeJurnal3-dp" value="<?php if ($_jumDetail < 3) {
                                                                                  echo 'Bank Charges';
                                                                                } else {
                                                                                  echo $_selectDetail[2]->coa_description;
                                                                                } ?>" name="JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc3-dp" value="<?php if ($_jumDetail < 3) {
                                                                            echo '';
                                                                          } else {
                                                                            echo $_selectDetail[2]->remark;
                                                                          } ?>" name="desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal3-dp" name="total_jr[]" value="<?php if ($_jumDetail < 3) {
                                                                                                            echo '0.00';
                                                                                                          } else {
                                                                                                            echo number_format($_selectDetail[2]->total_awal, 2);
                                                                                                          } ?>" class="txt txtnum number jur_total" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" value="<?php if ($_jumDetail < 3) {
                                                                          echo '0.00';
                                                                        } else {
                                                                          echo number_format($_selectHeader->currency_rate, 6);
                                                                        } ?>" id="inputRate3-dp" class="txt txtnum number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php if ($_jumDetail < 3) {
                                                                          echo '0.00';
                                                                        } else {
                                                                          echo number_format($_selectDetail[2]->debit, 2);
                                                                        } ?>" id="inputDebt3-dp" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php if ($_jumDetail < 3) {
                                                                            echo '0.00';
                                                                          } else {
                                                                            echo number_format($_selectDetail[2]->credit, 2);
                                                                          } ?>" id="inputCredit3-dp" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div class="portlet-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <button class="btn btn-sm btn-default ismo-hidden" id="btnPrint" type="button" onclick="javascript: window.open('<?php echo site_url("DownPaymentAR/printInvoiceDeposit/" . encode_str($_selectHeader->header_id)); ?>?cur=<?php echo $_selectHeader->currency_id; ?>');">
                    Print <i class="fa fa-sm fa-print fa-fw" aria-hidden="true"></i></button>
                  <a class="btn btn-sm btn-default" id="btnPrint2" href="<?php echo site_url("DownPaymentAR/printInvoiceDeposit/" . encode_str($_selectHeader->header_id)); ?>?cur=<?php echo $_selectHeader->currency_id; ?>&signature=Mr.Fok Yew Hon Henry" target="_BLANK"><i class="fa fa-print"></i> Print</a>
                ...
                <div class="col-md-6 text-right">
                  <div class="col-md-6 kiri">
                    <select name="signiture" onchange="ganti_signature()" id="signature" class="form-control kanan">
                      <option value="Mr. Fok Yew Hon Henry">Mr. Fok Yew Hon Henry</option>
                      <option value="Mr. Goh Kheng Choong">Mr. Goh Kheng Choong </option>
                    </select>
                  </div>
                  ...
                  <button class="btn btn-sm btn-neutral" type="reset" onclick="javascript: window.location = '<?php echo site_url("DownPaymentAR"); ?>';">
...
<div class="modal fade" id="modal-findDeposit" tabindex="-1" role="basic" aria-hidden="true">
  <div class="modal-dialog" style="width: 75%;">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title">Select AR Deposit</h4>
      </div>
      <div class="modal-body">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#txtInputVendor, #txtInputIdVendor").click(function() {
      $.ajax({
        url: "<?php echo site_url('DownPaymentAR/selectCustomerForDP'); ?>",
        type: "POST",
        datatype: "json",
        cache: false,
        success: function(respon) {
    ...
    $('#btnFindRecord').click(function() {
      $.post("<?php echo site_url(); ?>DownPaymentAR/selectDepositAR", function(data) {
    ...
    $("#btnSubmitUpdate").click(function() {
      $("#form-downPaymentAP").attr('action', "<?php echo base_url(); ?>DownPaymentAR/updateDepositARjustInvoice");
    ...
    $("#btnSubmitDelete").click(function() {
      $("#form-downPaymentAP").attr('action', "<?php echo base_url(); ?>DownPaymentAR/deleteDepositAR");
...
<script type="text/javascript">
  function Pilih_Supllier(x) {
    ...
    //== DP Row Detail 1
    $('#inputNoCOA1-dp').val(suppcoa);
    $('#inputTypeJurnal1-dp').val(nmcoa);
    $('#inputDesc1-dp').val(suppnm);

    $('#inputNoCOA2-dp').val('200508');
    $('#inputTypeJurnal2-dp').val('Customer Deposit');
  ...
  function countBankCharge() {
    var val1 = parseFloat($('#inputTotal1-dp').val().replace(/,/g, ''));
    var val2 = parseFloat($('#inputTotal2-dp').val().replace(/,/g, ''));
    var curr = parseFloat($('#txtInputRateUSD').val());

    var bCharg = val2 - val1;
    $('#inputTotal3-dp').val(addCommas(bCharg.toFixed(2)));

    var deb2 = val2 * curr;
    var deb3 = parseFloat(bCharg.toFixed(2)) * curr;

    $('#inputCredit2-dp').val(addCommas(deb2.toFixed(2)));
    $('#inputDebt3-dp').val(addCommas(deb3.toFixed(2)));
  }
  ...
  function calculateTotal() {
    ...
    //$('#inputCredit2').val(addCommas(hasil.toFixed(2)));
    $('#inputDebt1-dp').val(addCommas(hasil.toFixed(2)));

    $('#inputTotal1-dp').val(value);
