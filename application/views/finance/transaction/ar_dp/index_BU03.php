...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      ...
      <form role="form" method="post" id="form-downPaymentAP" action="<?php echo base_url(); ?>DownPaymentAR/insertDownPayment" class="form-horizontal">
        <div class="col-md-12">
            ...
            <div class="portlet-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-3 lbl-change-dis">C/B Code</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="txtInputChequeNumber" name="txtChequeNumber" class="form-control input-sm" />
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input id="txtInputJangkaTempo" type="text" value="" name="txtTermDay" class="form-control input-sm" required />
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea id="txtInputRemark" name="txtRemark" class="form-control" onkeyup="$('#inputDesc1').val($(this).val());$('#inputDesc2-dp').val($(this).val());"></textarea>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <label class="col-sm-10">
                        ...
                        <strong>Just Make Invoice</strong>
                      </label>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-md-12">
          <div class="portlet light">
            <div id="body-detail-deposit-ar" class="portlet-body">
              <div class="row">
                <div class="col-md-12 table-responsive" style="padding-bottom: 15px;">
                  <table class="table-ismo" id="tbl-detail-journal">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" id="dk1" name="dk[]" class="dk txt40" value="D"></td>
                      ...
                      <tr>
                        ...
                        <td><input type="text" id="dk2" name="dk[]" class="dk txt40" value="C"></td>
            ...
            <div id="body-detail-deposit-invoice-ar" class="portlet-body display-none">
              <div class="row">
                <div class="col-md-12 table-responsive" style="padding-bottom: 15px;">
                  <table class="table-ismo" id="tbl-detail-journal-dp">
                    <thead>
                      <tr>
                        <th class="text-center" style="width: 30px;">
                          <button id="btnSelectInvoice" class="btn btn-xs btn-link baik display-none" type="button">
                    ...
                    <tbody>
                      <tr>
                        <td></td>
                        <td><input type="text" id="inputNoCOA1-dp" name="dp_no_coa[]" class="no_coa txt" autocomplete="off"></td>
                        <td><input type="text" id="dk1-dp" name="dp_dk[]" class="dk txt40" value="D"></td>
                        <td><input type="text" id="inputTypeJurnal1-dp" name="dp_JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc1-dp" name="dp_desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal1-dp" name="dp_total_jr[]" class="txt txtnum number jur_total" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="dp_rate_jr[]" id="inputRate1-dp" class="txt txtnum number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="dp_debt_jr[]" id="inputDebt1-dp" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="dp_credit_jr[]" id="inputCredit1-dp" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td><input type="text" id="inputNoCOA2-dp" name="dp_no_coa[]" class="no_coa txt" autocomplete="off"></td>
                        <td><input type="text" id="dk2-dp" name="dp_dk[]" class="dk txt40" value="C"></td>
                        <td><input type="text" id="inputTypeJurnal2-dp" name="dp_JenisJurnal[]" class="txt"></td>
                        <td><input type="text" id="inputDesc2-dp" name="dp_desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal2-dp" name="dp_total_jr[]" class="txt txtnum number no-ro jur_total" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="dp_rate_jr[]" id="inputRate2-dp" class="txt txtnum number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="dp_debt_jr[]" id="inputDebt2-dp" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="dp_credit_jr[]" id="inputCredit2-dp" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td><input type="text" id="inputNoCOA3-dp" name="dp_no_coa[]" class="no_coa txt" value="610001" autocomplete="off"></td>
                        <td><input type="text" id="dk3-dp" name="dp_dk[]" class="dk txt40" value="D"></td>
                        <td><input type="text" id="inputTypeJurnal3-dp" name="dp_JenisJurnal[]" value="Bank Charges" class="txt"></td>
                        <td><input type="text" id="inputDesc3-dp" name="dp_desc[]" class=" txt"></td>
                        <td class="total"><input type="text" id="inputTotal3-dp" name="dp_total_jr[]" class="txt txtnum number jur_total" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="dp_rate_jr[]" id="inputRate3-dp" class="txt txtnum number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="dp_debt_jr[]" id="inputDebt3-dp" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="dp_credit_jr[]" id="inputCredit3-dp" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#tbl-detail-journal, #tbl-detail-journal-dp').find('input').attr('readonly', true);
    $('#tbl-detail-journal, #tbl-detail-journal-dp').find('.no-ro').attr('readonly', false);
    ...
    $('#txtInputNoReff').on('keyup blur', function() {
      var tgl = document.getElementById('txtInputTglTransInv').value;
      $tgl = tgl.split("-");
      ...
      if (tgl != '') {
        ...
        if ($(this).val() == "INV") {
          $.post("<?php echo base_url(); ?>Receivable_recognition/buat_nofak?tahun=" + y,
            function(data, statuss) {
              var ref = parseFloat(data);
              var no = ("00" + ref).slice(-3);
              var result = 'INV' + no + '/' + b + "/" + y;
              $('#txtInputNoReff').val(result);
            });
        }
      }
    });
    ...
    $('#chkSaveDraf').on('click', function() {
      if ($(this).prop('checked')) {
        bootbox.alert('You will just make Invoice!');
        $('#txtInputNoReff').prop("readonly", false);
        $('#txtInputNoReff').prop("required", true);
        $('#txtInputNoReff').attr("placeholder", 'Please Input No. Reference');
        $('#body-detail-deposit-ar').addClass('display-none');
        $('#body-detail-deposit-invoice-ar').removeClass('display-none');
        $("#form-downPaymentAP").attr('action', '<?php echo site_url(); ?>DownPaymentAR/insertJustInvoiceARdeposit');

        $('#selInputCBCode').attr('disabled', true);
        $('.lbl-change-dis').css('text-decoration', 'line-through');

        $('#inputNoCOA2-dp').val('200508');
        $('#inputTypeJurnal2-dp').val('Customer Deposit');
      } else {
        $("#form-downPaymentAP").attr('action', '<?php echo site_url(); ?>DownPaymentAR/insertDownPayment');
        $('#txtInputNoReff').prop("readonly", true);
        $('#txtInputNoReff').prop("required", true);
        $('#body-detail-deposit-ar').removeClass('display-none');
        $('#body-detail-deposit-invoice-ar').addClass('display-none');
        $('#txtInputNoReff').attr("placeholder", 'Auto Generate');

        $('#selInputCBCode').attr('disabled', false);
        $('.lbl-change-dis').css('text-decoration', 'none');
      }
    });
    ...
    $('#txtInputTglTrans').on('change keyup', function() {
      ...
      if (isNaN(term)) {
        term = 0;
        $('#txtInputTglJatuhTempo').val($('#txtInputTglTrans').val());
      }
...
<script type="text/javascript">
  ...
  function countBankCharge() {
    ...
    var val1dp = parseFloat($('#inputTotal1-dp').val().replace(/,/g, ''));
    var val2dp = parseFloat($('#inputTotal2-dp').val().replace(/,/g, ''));
    var curr = parseFloat($('#txtInputRateUSD').val());

    var bCharg = val2 - val1;
    var bChargdp = val2dp - val1dp;
    $('#inputTotal3').val(addCommas(bCharg.toFixed(2)));
    $('#inputTotal3-dp').val(addCommas(bChargdp.toFixed(2)));

    var deb2 = val2 * curr;
    var deb3 = parseFloat(bCharg.toFixed(2)) * curr;

    var deb2dp = val2dp * curr;
    var deb3dp = parseFloat(bChargdp.toFixed(2)) * curr;
    $('#inputCredit2-dp').val(addCommas(deb2dp.toFixed(2)));
    $('#inputDebt3-dp').val(addCommas(deb3dp.toFixed(2)));
  ...
  function calculateTotal() {
    ...
    $('#inputDebt1').val(addCommas(hasil.toFixed(2)));
