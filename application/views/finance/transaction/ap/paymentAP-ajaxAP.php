<div class="col-md-12">
    <div class="col-sm-4">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input value="<?php echo $_getFaktur->NomorAP;?>" style="background-color: #D2E0D1;" type="text" name="txtVoucher" class="form-control input-sm" readonly/>
            </div>
        </div>
    </div>
...
<div class="col-md-12">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input value="<?php echo number_format($_getFaktur->Rate, 2);?>" name="txtRateVoucher" type="text" class="form-control input-sm date-picker" data-date-format="yyyy-mm-dd" readonly/>
            </div>
        </div>
    </div>
</div>
...
<div class="col-md-12">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input value="<?php echo number_format(number_format($_getFaktur->Rate, 2)*$_getTotal, 2);?>" type="text" name="txtRateSGD" class="form-control input-sm" readonly/>
            </div>
        </div>
    </div>
</div>
