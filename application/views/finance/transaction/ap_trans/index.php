                ...
                <div class="col-md-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateNego" name="txtRateNego" class="form-control input-sm txtnumRate back-null-inv" onkeyup="javascript: HitungPayment();" onBlur="javascript :$('#tbl-payment tbody').addClass('display-none');
                                                        $(this).val(parseFloat($(this).val()).toFixed(6));" required />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
              ...
              <table class="table-ismo" id="tbl-cashGeneral">
                ...
                <tbody>
                  <tr id="rowSetCOA">
                    ...
                    <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-1" onKeyup="checkGST();
                                                convertToUSD();" onblur="convertToUSD();" class="col-debit col-deb txt txtnum" readonly value="0.00" /></td>
                  ...
                  <tr id="secendRowCashGeneral">
                    ...
                    <td nowrap><input id="txtInputDebitRow-2" type="text" name="txtDebit[]" onKeyup=" checkGST();
                                                convertToUSD();" onblur="convertToUSD();" class="col-debit col-deb txt txtnum" value="0.00" /></td>
                    <td nowrap><input id="txtInputCreditRow-2" type="text" name="txtCredit[]" onKeyup=" checkGST();
                                                convertToUSD();" onblur="convertToUSD();" class="col-credit col-cre txt txtnum" readonly value="0.00" /></td>
...
<script>
    ...
    if (valCUR != 'ALL') {
      ...
      $.post("<?php echo site_url('APtrans/getCurrOnDateInvoice'); ?>", {
        ...
        $('input.col-rate-curr').each(function() {
          ...
          $('#rateToCurr').val(addCommas(parseFloat(get.inv[jml]).toFixed(6)));
        });
        //alert(get[0]);
        var col_tota = document.getElementsByClassName('col-dtot');
        var col_equi = document.getElementsByClassName('col-equi-curr');
  ...
  function finalCalculate() {
    ...
    //            $('#txtInputCreditCBdetailRow-1').val(addCommas(xxxCredit.toFixed(2)));
