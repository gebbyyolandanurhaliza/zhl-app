                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateWeekly" name="txtRateBayar" class="form-control input-sm txtnumRate back-null-inv" required />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                ...
                <div class="col-md-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateNego" name="txtRateNego" class="form-control input-sm txtnumRate back-null-inv" onkeyup="javascript: HitungPayment();" onBlur="javascript :$('#tbl-payment tbody').addClass('display-none'); $(this).val(parseFloat($(this).val()).toFixed(6));" required />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateEqui" name="txtRateEqui" class="form-control input-sm txtnumRate back-null-inv" required />
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table-ismo" id="tbl-detail-invoice">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td class="txtnum">
                          <input name="txtAvgRateVaucher" id="rateToCurr" class="txt txtnumRate txt-ismo-back-null back-null-inv" readonly="true" />
                        </td>
                        <td class="txtnum">
                          <input name="" id="equiToCurr" class="txt txtnum txt-ismo-back-null back-null-inv" readonly="true" />
                        </td>
                        <td class="txtnum">
                          <input name="" id="rateTotalID" class="txt txtnumRate txt-ismo-back-null" readonly="true" />
                        </td>
                        <td class="txtnum">
              ...
              <table class="table-ismo" id="tbl-cashGeneral">
                ...
                <tbody>
                  <tr id="rowSetCOA">
                    ...
                    <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-1" onKeyup="checkGST();" class="col-debit txt txtnum" readonly value="0.00" /></td>
                    <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-1" onKeyup="checkGST();" class="col-credit txt txtnum" value="0.00" /></td>
                  ...
                  <tr id="secendRowCashGeneral">
                    ...
                    <td nowrap><input id="txtInputDebitRow-2" type="text" name="txtDebit[]" onKeyup=" checkGST();" class="col-debit txt txtnum" value="0.00" /></td>
                    <td nowrap><input id="txtInputCreditRow-2" type="text" name="txtCredit[]" onKeyup=" checkGST();" class="col-credit txt txtnum" readonly value="0.00" /></td>
                    <td nowrap><input type="text" name="txtRemark[]" class="txt" /></td>
                    <td nowrap>
                  ...
                  <tr id="thridhRowCashGeneral">
                    ...
                    <td nowrap><input id="txtInputDebitRow-3" type="text" name="txtDebit[]" onKeyup=" checkGST();" class="col-debit txt txtnum" readonly value="0.00" /></td>
                    <td nowrap><input id="txtInputCreditRow-3" type="text" name="txtCredit[]" onKeyup=" checkGST();" class="col-credit txt txtnum" readonly value="0.00" /></td>
                    <td nowrap><input type="text" name="txtRemark[]" class="txt" /></td>
                    <td nowrap>
                      <select name="txtGST[]" class="txt gst-name display-none" onchange="checkGST()">
                        <option value=""> -- Select --</option>
                ...
                <tfoot id="detailRowForAddCost">
                  <tr id="addCostRow1">
                    ...
                    <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-addCostRow-1" class="col-debit txt txtnum" value="0.00" /></td>
                    <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-addCostRow-1" class="col-credit txt txtnum" value="0.00" /></td>
                    <td nowrap><input type="text" name="txtRemark[]" class="txt" /></td>
                    <td nowrap>
                      <select name="txtGST[]" class="txt gst-name display-none" onchange="checkGST()">
                        <option value=""> -- Select --</option>
                ...
                <tfoot id="detailRowForGSTfoot">
                  <tr id="rowGSTlast-1">
                    ...
                    <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-GSTlast-1" readonly class="col-debit txt txtnum" value="0.00" /></td>
                    <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-GSTlast-1" readonly class="col-credit txt txtnum" value="0.00" /></td>
                    <td nowrap><input type="text" name="txtRemark[]" class="txt" /></td>
                    <td nowrap>
                      <select name="txtGST[]" class="txt gst-name display-none" onchange="checkGST()">
                        <option value=""> -- Select --</option>
                  ...
                  <tr id="rowGSTlast-2">
                    ...
                    <td nowrap><input type="text" name="txtDebit[]" id="txtInputDebitCBdetailRow-GSTlast-2" readonly class="col-debit txt txtnum" value="0.00" /></td>
                    <td nowrap><input type="text" name="txtCredit[]" id="txtInputCreditCBdetailRow-GSTlast-2" readonly class="col-credit txt txtnum" value="0.00" /></td>
                    <td nowrap><input type="text" name="txtRemark[]" class="txt" /></td>
                    <td nowrap>
                      <select name="txtGST[]" class="txt gst-name display-none" onchange="checkGST()">
                        <option value=""> -- Select --</option>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#btnCalculateDetail").click(function() {
      ...
      if ($('#txtCUR2').val() != $('#selInputCurrencyVoucher').val()) {
        if (selisih < 0) {
          exchRate = selisih * (-1);
        ...
        $('#txtInputDebitRow-2').val(addCommas(inByCurr1st.toFixed(2)));
        $('#txtInputCreditCBdetailRow-1').val(addCommas(inByCurr2nd.toFixed(2)));
...
<script>
  ...
  function CountPayTotal() {
    ...
    //====== for Bank
    $('#txtInputDebitRow-2').val(addCommas(sumPay.toFixed(2)));
    $('#txtInputCreditCBdetailRow-1').val(addCommas(sumPay.toFixed(2)));
  }
        ...
        review: {
          ...
          callback: function() {
            ...
            $('table[id="tbl-cashGeneral"] tfoot[id="detailRowForAddCost"]').append('<tr class="' + cls + ' added-row-ismo">\n\
                            ...
                            <td nowrap><input type="text" name="txtDebit[]" readonly onKeyup="checkGST();" class="ac-col-debit txt txtnum ' + cls + 'xx" /></td>\n\
                            <td nowrap><input type="text" name="txtCredit[]" onKeyup="checkGST();" class="ac-col-credit txt txtnum ' + cls + 'xx"/></td>\n\
                            <td nowrap><input type="text" name="txtRemark[]" class="txt"/></td>\n\
    ...
    if (valCUR != 'ALL') {
      ...
      $.post("<?php echo site_url('APtrans/getCurrOnDateInvoice'); ?>", {
        ...
        $('input.col-rate-curr').each(function() {
          ...
          $('#rateToCurr').val(addCommas(parseFloat(get.inv[0]).toFixed(6)));
        });
        //alert(get[0]);
        var col_tota = document.getElementsByClassName('col-dtot');
        var col_equi = document.getElementsByClassName('col-equi-curr');
  ...
  function finalCalculate() {
    ...
    var apVal = parseFloat($('#txtInputDebitRow-2').val().replace(/,/g, ''));
