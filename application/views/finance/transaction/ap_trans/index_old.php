                ...
                <div class="col-md-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateNego" name="txtRateNego" class="form-control input-sm txtnum" onkeyup="javascript: HitungPayment();" onBlur="javascript :$('#tbl-payment tbody').addClass('display-none'); $(this).val(parseFloat($(this).val()).toFixed(2));" required />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
  ...
  function Pilih_Invoice(x) {
    ...
    $('#tbl-detail-invoice tbody').append('<tr class="' + cls + ' added-row-ismo">\n\
            ...
            <td><input data-max="' + getText(document.getElementById('tbl-selectInvoice').rows[rr].cells[3]) + '" \n\
                ...
                class="txt col-ptot txtnum ' + cls + 'ap" onkeyup="CountPayTotal(); HitungPayment();" /></td>\n\
        </tr>');
  ...
  function Pilih_MCOA(x) {
    ...
    if (valCUR != 'ALL') {
      ...
      $.post("<?php echo site_url('APtrans/getCurrOnDateInvoice'); ?>", {
        ...
        var no = 0;
        $('input.col-rate-curr').each(function() {
          $(this).val(addCommas(parseFloat(get.inv[no++]).toFixed(2)));
        });
        //alert(get[0]);
        var col_tota = document.getElementsByClassName('col-dtot');
        var col_equi = document.getElementsByClassName('col-equi-curr');
