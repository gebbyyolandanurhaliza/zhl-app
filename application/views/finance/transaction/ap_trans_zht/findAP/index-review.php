...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      ...
      <form role="form" method="post" id="form-APtrans" action="<?php echo site_url('APtrans_zht/deleteAPpayment'); ?>" class="form-horizontal">
        <div class="col-md-12">
          <div class="portlet light">
            ...
            <div class="portlet-body">
              ...
              <div class="row" id="ajax-formAP-header">
                ...
                <div class="col-md-12 ismo-hidden">
                  <div class="col-sm-4">
                    <div class="form-group ">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateBank" name="txtRateBank" value="<?php echo number_format($_selectHeaderAP->currency_rate, 6); ?>" name="txtRateBank" class="form-control input-sm txtnum" required />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" value="<?php echo number_format($_selectHeaderAP->rate_sgd, 6); ?>" id="txtInputRateSGD" name="txtRateSGD" class="form-control input-sm txtnum" required readonly />
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <tbody>
                      <?php foreach ($_selectInvoiceAP as $inv) : ?>
                        <tr class="added-row-ismo">
                          ...
                          <td><input data-max="<?php echo number_format($inv->hutang - $inv->total_pay, 2); ?>" value="<?php echo number_format($inv->total_pay, 2); ?>" name="txtPeymentInvoiceDtl[]" class="txt col-ptot txtnum" onkeyup="CountPayTotal(); isNumber();" /></td>
        ...
        <div class="col-md-12">
          <!-- BEGIN PORTLET-->
          <div class="portlet light">
            <!-- <div class="portlet-title ismo-hidden">
                            <div class="caption theme-font">
                                <i class="icon-calendar theme-font"></i>
            ...
            <div class="portlet-body form">
              <div class="row">
                <!-- <div class="col-md-12 table-responsive ismo-hidden" style="padding-bottom: 15px;">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#btnCancel").click(function() {
      window.location = "<?php echo site_url('APtrans_zht'); ?>";
    });
    ...
    $('#btnPrint').click(function() {
      var noAP = '<?php echo encode_str($_selectHeaderAP->no_facture); ?>';
