...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      ...
      <form role="form" method="post" id="form-APtrans" action="<?php echo site_url('ARtrans_zht/deleteARpayment'); ?>" class="form-horizontal">
        <div class="col-md-12">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateBank" value="<?php echo number_format($_selectHeaderAP->currency_rate, 6); ?>" name="txtRateBayar" class="form-control input-sm txtnum" required />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateSGD" name="txtRateSGD" value="<?php echo number_format($_selectHeaderAP->rate_sgd, 6); ?>" class="form-control input-sm txtnumRate" required />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="col-sm-8">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" id="txtInputCheckBank" name="txtCheckBank" value="<?php echo $_selectHeaderAP->check_number; ?>" class="form-control input-sm" required />
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table-ismo" id="tbl-detail-invoice">
                    ...
                    <tbody>
                      <?php foreach ($_selectInvoiceAP as $inv) : ?>
                        <tr class="added-row-ismo">
                          ...
                          <td><input data-max="<?php echo number_format($inv->piutang - $inv->total_pay, 2); ?>" value="<?php echo number_format($inv->total_pay, 2); ?>" name="txtPeymentInvoiceDtl[]" class="txt col-ptot txtnum" onkeyup="CountPayTotal(); isNumber();" /></td>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td class="txtnum">
                          <input name="" id="rateTotalID_temp" class="txt txtnum txt-ismo-back-null" readonly="true" />
                        </td>
                        <td class="txtnum">
                ...
                <tbody>
                  ...
                  foreach ($_selectDtlJrnal as $jrnl) : ?>
                    <tr id="rowSetCOA">
                      ...
                      <?php if($jrnl->dept_code == '0'){?>
                        <td nowrap><input type="text" name="txtDeptCode[]" class="txt" value="000" readonly /></td>
                      <?php }else {?>
                        <td nowrap><input type="text" name="txtDeptCode[]" class="txt" value="<?php echo $jrnl->dept_code; ?>" readonly /></td>
                      <?php } ?>
                ...
                <div class="col-md-12" style="padding-top: 10px;">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <button class="btn btn-sm btn-primary" id="btnCancel" name="btnCancel" type="button"><i class="fa fa-plus"></i> New Transaction </button>
                    </div>
                  </div>
...
<div class="modal fade" id="modal-findAR" tabindex="-1" role="basic" aria-hidden="true">
  <div class="modal-dialog" style="width: 75%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="contentFindAR"><i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i> Loading...</div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn default" data-dismiss="modal">Close</button>
      </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#btnCancel").click(function() {
      window.location = "<?php echo site_url('ARtrans_zht'); ?>";
    });
    ...
    $('#btnPrint').click(function() {
      var noAR = '<?php echo $_selectHeaderAP->no_facture; ?>';
      var suppNm = '<?php echo encode_str($_selectHeaderAP->customer_company_name); ?>';

      // console.log(noAP);

      console.log(suppNm);
      window.open('<?php echo site_url(); ?>ARtrans/print_report/' + noAR + '?sup=' + suppNm, '_blank');
    });
