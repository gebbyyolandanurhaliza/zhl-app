...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      ...
      <form role="form" method="post" id="form-ARtrans" action="<?php echo site_url('ARtrans_zht') . $_actionFrom; ?>" class="form-horizontal">
        <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    ...
                    <script>
                      $('#inputNoReff').on('blur', function() {
                        ...
                        $.ajax({
                          type: "POST",
                          url: "<?php echo base_url(); ?>ARtrans_zht/cekNumReffAR",
                          data: {
                            value: val
                          },
                          dataType: "json",
              ...
              <table class="table-ismo" id="tbl-cashGeneral">
                ...
                <tfoot id="detailRowForAddCost">
                  ...
                  <tr id="addCostRow1">
                    ...
                    <td nowrap><input type="text" name="txtDeptCode[]" id="txtInputDeptCodesuppRow-addCostRow-1" class="txt" value="005" readonly /></td>
  ...
  $(document).ready(function() {
    ...
    $('#txtInputTransDate, #txtCUR2, #txtInputRateSGD').on('change blur', function() {
      ...
      if ($('#txtInputTransDate').val()) {
        setInterval(function() {
          $.get("<?php echo base_url(); ?>ARtrans_zht/newGenerateReffNumber2", {
            txtTypeForGen: 'IN',
    ...
    $("#inputCOA").click(function() {
      if ($('#inputTotalVoucher').val() === '') {
        ...
        $.ajax({
          url: "<?php echo site_url('ARtrans_zht/selectCOA'); ?>",
          type: "POST",
          datatype: "json",
          cache: false,
          success: function(respon) {
    ...
    $("#txtInputSuplierID, #txtInputSuplierName").click(function() {
      ...
      if (!txtTglTrn) {
        ...
        $.ajax({
          url: "<?php echo site_url('ARtrans_zht/selectCustomerForAR'); ?>",
          data: {
    ...
    $("#btnSelectInvoice").click(function() {
      if (inSuppID === '') {
        ...
        if ($('#modal-invoice').hasClass('has-ismo-modal')) {
          ...
          $.ajax({
            url: "<?php echo site_url('ARtrans_zht/selectInvoiceForAR'); ?>",
            type: "POST",
            data: {
    ...
    $("#btnFindRecord").click(function() {
      $.post("<?php echo site_url(); ?>ARtrans_zht/selectARpayment", function(data) {
...
<script>
  ...
  function Pilih_MCOA(x) {
    ...
    if (valCUR != 'ALL') {
      ...
      $.post("<?php echo site_url('ARtrans_zht/getCurrBank'); ?>", {
        txtCurrency: valCUR,
