        ...
        <div class="col-md-12">
          ...
          <div class="portlet light">
            <div class="portlet-title">
              ...
              <div class="actions">
                <a class="btn btn-circle btn-primary" href="<?php echo site_url(); ?>DownPaymentAP">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" name="rate_jr[]" value="<?php if (!empty($_selectHeader->currency_rate)) {
                                                                        ...
                                                                        } ?>" id="inputRate1" class="txt txtnum number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php if (!empty($_selectDetail[0]->debit)) {
                                                                          echo number_format($_selectDetail[0]->debit, 2);
                                                                        } ?>" id="inputDebt1" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php if (!empty($_selectDetail[0]->credit)) {
                                                                            echo number_format($_selectDetail[0]->credit, 2);
                                                                          } ?>" id="inputCredit1" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
                        ...
                        <td class="total"><input type="text" id="inputTotal2" name="total_jr[]" value="<?php if (!empty($_selectDetail[1]->total_awal)) {
                                                                                                        ...
                                                                                                        } ?>" class="txt txtnum number jur_total no-ro" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="rate_jr[]" value="<?php if (!empty($_selectHeader->currency_rate)) {
                                                                          echo number_format($_selectHeader->currency_rate, 6);
                                                                        } ?>" id="inputRate2" class="txt txtnum number jr_rate" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="debt_jr[]" value="<?php if (!empty($_selectDetail[1]->debit)) {
                                                                          echo number_format($_selectDetail[1]->debit, 2);
                                                                        } ?>" id="inputDebt2" class="txt txtnum number jur_deb" onkeypress="return isNumber(event)"></td>
                        <td><input type="text" name="credit_jr[]" value="<?php if (!empty($_selectDetail[1]->credit)) {
                                                                            echo number_format($_selectDetail[1]->credit, 2);
                                                                          } ?>" id="inputCredit2" class="txt txtnum number jur_credit" onkeypress="return isNumber(event)"></td>
                      </tr>
                      <tr>
                        <td></td>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#btnSubmitUpdate").click(function() {
      $("#form-downPaymentAP").attr('action', "<?php echo base_url(); ?>DownPaymentAP/updateDepositAP");
    ...
    $("#btnSubmitDelete").click(function() {
      $("#form-downPaymentAP").attr('action', "<?php echo base_url(); ?>DownPaymentAP/deleteDepositAP");
