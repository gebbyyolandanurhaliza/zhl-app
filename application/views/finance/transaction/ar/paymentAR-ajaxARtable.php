<tr>
    ...
    <td nowrap><input value="Claim" name="txtRemarkDetail[]" class="txt" readonly/></td>
    <td nowrap><input value="<?php echo number_format($_getTotal, 2); ?>" name="txtTotalDetal[]" id="inputAmountRow1" class="txt" readonly/></td>
    <td nowrap><input value="<?php echo number_format($_getRateSGD*$_getTotal, 2);?>" name="txtEquiDetail[]" id="inputUSDRow1" class="txt" readonly/></td>
    ...
    <td nowrap><input value="1000.3.245.10" name="txtCOADetail[]" class="txt" readonly/></td>
    <td nowrap>
...
<tr>
    ...
    <td nowrap><input name="txtTotalDetal[]" class="txt" readonly/></td>
    <td nowrap><input name="txtEquiDetail[]" class="txt" readonly/></td>
