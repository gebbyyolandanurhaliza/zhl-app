                ...
                <div class="col-md-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="txtTotalVoucher" value="<?php echo number_format($_selectDtlJrnal[0]->credit, 2); ?>" id="inputTotalVoucher" class="form-control input-sm txt-ismo-back-null txtnum" readonly="" />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateSGD" value="<?php echo number_format($_selectHeaderAP->currency_rate * $_selectDtlJrnal[0]->credit, 2); ?>" name="txtRateSGD" class="form-control input-sm txt-ismo-back-null txtnum" readonly="" />
                      </div>
                    </div>
                  </div>
                </div>
