...
<div class="page-content">
  <div class="container-fluid">
    <div class="row">
      ...
      <form role="form" method="post" id="form-APtrans" action="<?php echo site_url('ARtrans/deleteARpayment'); ?>" class="form-horizontal">
        <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" id="txtInputSuplierName" name="txtSuplierName" value="<?php echo $_selectHeaderAP->customer_company_name; ?>" class="form-control input-sm" style="background-color: #D2E0D1;" readonly />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-8">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input id="txtInputRateVoucher" value="<?php echo $_selectHeaderAP->currency_rate; ?>" name="txtRateVoucher" type="text" class="form-control input-sm txt-ismo-back-null" data-date-format="yyyy-mm-dd" readonly />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="txtTotalVoucher" value="<?php echo $_selectHeaderAP->amount; ?>" id="inputTotalVoucher" class="form-control input-sm txt-ismo-back-null" readonly="" />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateSGD" value="<?php echo number_format($_selectHeaderAP->currency_rate * $_selectHeaderAP->amount, 6, '.', ''); ?>" name="txtRateSGD" class="form-control input-sm txt-ismo-back-null" readonly="" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateWeekly" value="<?php echo number_format($_selectHeaderAP->rate_nego, 2); ?>" name="txtRateBayar" class="form-control input-sm" required />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateNego" value="<?php echo number_format($_selectHeaderAP->rate_nego, 2); ?>" name="txtRateNego" class="form-control input-sm" required />
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" id="txtInputRateEqui" value="0" name="txtRateEqui" class="form-control input-sm" required />
                      </div>
                    </div>
                  </div>
                    ...
                    <tbody>
                      <?php foreach ($_selectInvoiceAP as $inv) : ?>
                        <tr class="added-row-ismo">
                          ...
                          <td><input value="<?php echo number_format($inv->rate_akhir, 2); ?>" name="txtRateInvoiceDtl[]" class="txt col-rate txtnum" readonly /></td>
                          <td><input value="<?php echo number_format($inv->piutang, 2); ?>" name="txtTotalBeforeInvoiceDtl[]" class="txt col-btot txtnum" readonly /></td>
                          <td><input value="<?php echo number_format($inv->rate_akhir * $inv->piutang, 2); ?>" name="txtToUSDInvoiceDtl[]" class="txt col-dtot txtnum" readonly /></td>
                          <td><input data-max="<?php echo number_format($inv->piutang - $inv->Total, 2); ?>" value="<?php echo number_format($inv->Total, 2); ?>" name="txtPeymentInvoiceDtl[]" class="txt col-ptot txtnum" onkeyup="CountPayTotal(); isNumber();" /></td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
                    <tfoot>
                  ...
                  <table class="table-ismo" id="tbl-payment">
                    ...
                    <tbody id="ajax-tblAP">
                      <tr>
                        ...
                        <td nowrap><input value="" name="txtCurrDetail[]" id="inCurFirstRow" class="txt txt-ismo-back-null" readonly /></td>
                      ...
                      <tr>
                        ...
                        <td nowrap><input value="" name="txtCurrDetail[]" id="inCurThreeRow" class="txt" readonly /></td>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#btnCancel").click(function() {
      window.location = "<?php echo site_url('ARtrans'); ?>";
    });
    ...
    $.post("<?php echo site_url('ARtrans/selectCustomerForARbyCustCode'); ?>", {
    ...
    $.post("<?php echo site_url('ARtrans/selectCurrencyAR'); ?>", {
...
<script>
  function CountGrandTotal() {
    ...
    $('#txtInputRateVoucher').val(addCommas(avgRate.toFixed(2)));
