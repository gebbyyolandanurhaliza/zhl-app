...
<script>
  ...
  function exRate() {
    ...
    if (mewtotalhutsgd < 0) {
      ...
      usd_cret[1].value = addCommas(Number(Math.abs(mewtotalhutusd.toFixed(2))));
      usd_debt[1].value = "0.00";
    }

    if (mewtotalhutusd < 0) {
      usd_debt[1].value = addCommas(Number(Math.abs(mewtotalhutusd.toFixed(2))));
      usd_cret[1].value = "0.00";
    } else {
      sgd_cret[1].value = addCommas(Number(Math.abs(mewtotalhutsgd.toFixed(2))));
      sgd_debt[1].value = "0.00";
    }

    if (newexcRatesgd < 0) {
      sgd_debt[2].value = addCommas(Number(Math.abs(newexcRatesgd.toFixed(2))));
      sgd_cret[2].value = "0.00";
    } else {
      sgd_cret[2].value = addCommas(Number(Math.abs(newexcRatesgd.toFixed(2))));
      sgd_debt[2].value = "0.00";
    }

    if (newexcRateusd < 0) {
      usd_debt[2].value = addCommas(Number(Math.abs(newexcRateusd.toFixed(2))));
      usd_cret[2].value = "0.00";
    } else {
      usd_cret[2].value = addCommas(Number(Math.abs(newexcRateusd.toFixed(2))));
