									...
									<div class="agent-scroll">
										<table width="100%" id="tbl_agent" class="table table-detail">
											<thead>
												<tr>
													<th></th>
													<th width="40%" class="text-left">Agent Name</th>
													<th width="30%" class="text-left">Agent Reference</th>
													<th width="13%" class="text-center">USD Com (%)</th>
													<th width="13%" class="text-center">USD Com/Unit</th>
													<th width="0%" class="text-center sembunyi">Invoice</th>
												</tr>
											</thead>
											<tbody>
												<?php 
												if ($agent_list){
													...
													<tr>
														...
														<td class="bg-editable">
															<input type="text" value="<?php echo $ag->agent_reference ?>" name="agent_reference[]" class="form-control">
														</td>
														<td class="bg-editable">
															<input type="text" value="<?php echo $ag->com_percent ?>" onkeyup="agent_percent()" class="form-control autonum_com_percent text-right autofocus agent_com_percent" name="agent_com_percent[]" id="agent_com_percent" data-a-sign=" %" data-p-sign="s" data-v-max="100" placeholder="0.00 %" />
														</td>
														<td class="bg-editable">
															<input type="text" value="<?php echo $ag->com_unit ?>" onkeyup="agent_unit()" class="form-control autonum_com_unit text-right autofocus agent_com_unit" name="agent_com_unit[]" id="agent_com_unit" data-p-sign="s" placeholder="0.00"/>
														</td>
														<td class="bg-editable text-center sembunyi">
															<?php
...
//																echo "<input type='button' class='btn default btn-xs red-stripe' onclick='removeRow(this)' value='Remove'>";
	...
	//															echo "<input type='hidden' name='quotation_dtl_id[]' value='$d->quotation_dtl_id'>";
															...
															//Kolom Qty
															echo "<td class='bg-editable'>";
																echo "<input name='qty[]' $w_qty required value='$cd->quantity' po_qty_value='$po_qty' type='text' class='form-control input-xs text-right input-table autonum_qty autofocus input_qty' data-v-min='0' onkeyup='calculate()'>";																
															echo "</td>";
															//Kolom Unit Price
															echo "<td class='bg-editable'>";
	...
	//															echo form_hidden('estimated[]', $cd->estimated_qty);
										...
										<script type="text/javascript">
											$('.input_qty').focus(function(){
												var poval = $(this).attr('po_qty_value');
					...
					$('#tblsales_contract > tbody:last-child').append(
						'<tr>\n\
							<td class="text-center w-50 bg-editable valign-middle">\n\
								...
								<input type="button" class="btn default btn-xs red-stripe remove_detail_add" value="Remove" id="0">\n\
