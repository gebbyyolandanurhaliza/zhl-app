							...
							<div class="col-md-12">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<?php 
													...
													$option_factory[''] = '';
													$option_factory['1'] = 'P1 (PSG)';
													$option_factory['3'] = 'P2 (RSUP)';
										...
										<div class="form-group">
											<label class="col-md-2 control-label" for="varchar">Container</label>
											<div class="col-md-7">
												...
												<?php 
													if ($record){
														foreach ($record as $r) {
															...
															$r_ponumber		= str_replace(' PSS','', $r->po_number);
															
															$get_list_po	= $this->M_mar_shipping_instruction->get_mix_po($r_shipid, $r_pohdrid);
															if ($get_list_po){
																$i = 1;
															...
															$r_ponumber		.= str_replace(' PSS', '', $list_po);
															
															$r_contid		= $r->cont_dtl_id;															
//															$r_ponumber		= str_replace(' PSS','', $r->po_number);
															$r_buyersi		= $r->buyer_si;
															$r_vessel		= $r->vessel;
															$r_etd			= tgl_ind($r->etdsin);
															$r_eta			= tgl_ind($r->etasin);
															$r_port			= $r->port_name.', '.$r->destination_country;
															$r_product		= $this->M_mar_shipping_advice->get_product_by_si($r_shipid);
//															$r_product		= $this->M_mar_shipping_advice->get_product_by_po($r->po_hdr_id);
															$r_fcl20		= ($r->container_size == 20) ? number_format($r->total_fcl) : '';
															$r_fcl40		= ($r->container_size == 40) ? number_format($r->total_fcl) : '';
															...
															echo "<td class='bg-editable'>";
																...
																echo "<textarea readonly='readonly' name='po_number_show[]' class='form-control input-xs input-table product_desc autosizeme' style='width:120px;'>$r_ponumber</textarea>";
														...
														echo "<tr>";
														echo "<td colspan='13' class='text-center'>No Data Available</td>";
														echo "</tr>";
													}
												?>
