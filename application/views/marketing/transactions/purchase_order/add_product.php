<table id="tbl_product_head" class="table table-condensed table-hover table-fixed" style="margin-bottom: 2px; width:99%;">
	<thead>
		<tr>
			...
			<th class="sembunyi">PO Format</th>
...
//						}
					...
					//idx = 15
					echo '<td class="po_qty sembunyi" style="width:100px;">'.$quantity.'</td>';
//					echo '<td class="po_qty">'.(isset($r->po_qty) ? $r->po_qty : 0).'</td>';
					//idx = 16					
					echo '<td class="outstanding_qty text-center" style="width:100px;">'.number_format($outstanding_qty,0).'</td>';
					//idx = 17
					...
					switch ($r->factory_id) {
						case 1:
							$po_format = $r->po_code_prefix_psg;
							break;
						case 3:
							$po_format = $r->po_code_prefix_rsup;
							break;
						case 4:
							$po_format = $r->po_code_prefix_psj;
							break;
					...
					//idx = 20
					echo '<td class="po_format sembunyi">'.$po_format.'</td>';
					echo '</tr>';
				}
			} else {
