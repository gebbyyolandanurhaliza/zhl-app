...
<div class="page-content">
	<div class="container-fluid">
		<div class="row">
			...
			<form action="<?php echo $action; ?>" method="post" class="form-horizontal" onsubmit="return validate(this);">
				...
				$('#tbl_po > tbody:last-child').append(
					'<tr>'
						+'<td class="text-center bg-editable" style="vertical-align: top;">'
							+'<input type="button" style="width: 80px; margin-left: 5px; margin-top: 2px;" class="btn default btn-xs red-stripe" used_si="0" onclick="removeRow(this)" value="Remove">'
						...
						+'</td>'
						+'<td class="bg-editable"><input name="fob_price[]" '+s_fobprice+' type="text" class="form-control input-xs text-right input-table autonum_fob autofocus" data-v-min="0" onkeyup="calculate()"></td>'
