											...
											<tbody>
												...
												if ($search_result){									
													foreach($search_result as $r){
														...
														echo "<input type='button' id='".encode_str($r->quotation_hdr_id)."' value='Create Contract' class='btn btn-xs default green-stripe create_contract'>";
														echo "</td>";
//														echo "<td>$r->customer_name</td>";
														...
														echo "<td class='w-40'>".number_format($r->total_qty_quotation - $r->total_qty_contract)."</td>";
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-12">
								...
								<a href="<?php echo site_url('marketing-transaction/sales-contract/create_no_quote')?>" class="btn purple">Create Sales Contract With No Quotation</a>
							</div>
						</div>
					</div>					
...
<script>
	...
	$('.create_contract').click(function(){
		var id = $(this).attr('id');
		window.location = "<?php echo site_url('marketing-transaction/sales-contract/create/?id=')?>"+id;
	});
