					...
					<div class="portlet-body form">
									...
									<table id="tbl_po" class="table table-condensed table-bordered table-hover table-detail">
										<thead>
											<tr>
												<th style="width: 70px; text-align: center;">
													<a href="#modal-select-po" id="mix_po" data-toggle="modal" class="btn btn-xs btn-primary" title="Add More PO">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<input type="text" value="<?php echo $r->factory_abbr ?>" class="form-control input-xs input-table" readonly="readonly" />
												</td>
											...
											<tr>
												...
												<td>
													<input type="text" value="<?php echo $factory_abbr ?>" class="form-control input-xs input-table" readonly="readonly" />
												</td>
												<td class="bg-editable">
						...
						<div class="form-body row">							
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="col-md-4 control-label padding-right-2" for="varchar">Invoice To Buyer										
<!--										<a href="#modal_invoice_buyer" id="invoice_buyer_link" data-toggle="modal" class="pull-right" title="Select Buyer">
									...
									<div class="col-md-7">
										...
										?>	
<!--										<input type="text" class="form-control" name="invoice2buyer" id="invoice2buyer" value="<?php // echo $invoice2buyer ?>" readonly="readonly" />
										<input type="hidden" class="form-control" name="invoice2buyer_id" id="invoice2buyer_id" value="<?php // echo $invoice2buyer_id ?>" />-->
									</div>
								</div>
							</div>
										...
										<tbody>
											...
											if ($agent_list){
												...
												foreach($agent_list as $ag){
													...
													echo form_checkbox('agent_invoice[]', '1', $checked, 'onclick="get_invoice_price();"');
													echo "</td>";
...
//											echo form_dropdown('payment_term', $option_payterm, $payment_term, $extra_payterm);
								...
								<div class="form-group required">
									...
									<div class="col-md-3">
										<?php 
//											form_dropdown tidak ditampikan karena tidak dipakai (Pohlin)
    ...
    <div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div id="po_find" class="po_find">
				...
				<!--<p><div class="page-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></p>-->
			</div>
...
<script>
	$('#mix_po').on('click',function(){
		...
		$('.po_find').html('<div class="modal-body"><div class="spinner text-center"><i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>&nbsp;&nbsp;<span>Loading...</span></div></div>');
			...
			if (chk_arr[r].checked == true) {
				$('#tbl_po > tbody:last-child').append(
					...
					+'<td class="text-center w-70 bg-editable valign-middle">'
						+'<div class="input-group input-table-group">'
						+'<input type="button" class="btn default btn-xs red-stripe"  style="width: 70px; margin-left: 5px; margin-top: 2px;" onclick="removePO(this)" value="Remove">'
						+'</div>'
					+'</td>'
					+'<td><input type="hidden" name="detail_po_hdr_id[]" id="detail_po_hdr_id" value="'+ getText(document.getElementById('tbl_filter_po').rows[i].cells[1]) +'">'
					...
					+'</td>'
					+'<td>'
						+'<input type="text" value="'+ getText(document.getElementById('tbl_filter_po').rows[i].cells[3]) +'" class="form-control input-xs input-table" readonly="readonly" />'
					+'</td>'
					+'<td class="bg-editable">'
...
//	window.onload = get_invoice_price();
</script>