					...
					<div class="portlet-body form">
						...
						<div class="form-body row">
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-4 control-label" for="varchar">Schedule</label>
									<div class="col-md-7">
						...
						<div class="form-body row">							
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="varchar">Invoice To Buyer</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="invoice2buyer" id="invoice2buyer" value="<?php echo $invoice2buyer ?>" />
									</div>
								</div>
							</div>
										...
										<tbody>
											...
											if ($product_dtl){
												...
												foreach($product_dtl as $pd){
													...
													echo "<td class='text-center' style='width:50px;vertical-align: middle;'>$i</td>";
													...
													echo "<td>";
													echo "<input type='text' value='$pd->product_name' title='$pd->product_name' class='form-control input-xs input-table' readonly='readonly' />";
													echo "</td>";
													...
													echo "<td style='width: 12%;'>";
													echo "<input name='detail_pack_size[]' value='$pack_size' title='$pack_size' type='text' class='form-control input-xs input-table text-right' readonly='readonly' />";
													echo "</td>";
						...
						<div class="form-body row">
							...
							<div class="col-md-12">
								...
								<div class="form-group required">
									...
									<div class="col-md-9">
										<?php 
											$extra_payterm = 'id="payment_term" class="form-control select2me" required="required" ';
											$option_payterm[''] = '';
										...
										?>
										<!--<input type="text" class="form-control" name="payment_term" id="payment_term" value="<?php echo $payment_term ?>" />-->
									</div>
								</div>
...
<!--									<label class="col-md-1 control-label" for="varchar" style="padding-right: 5px;">Trucking Date</label>
									<div class="col-md-2">
										<div class="input-group date date-picker" data-date-format="dd/mm/yyyy">
											<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
											</span>
											<input type="text" name="trucking_date" id="trucking_date" class="form-control" readonly="" value="<?php // echo $trucking_date; ?>" title="date format : dd/mm/yyyy">	
										</div>
										<input type="text" class="form-control date date-picker" data-date-format="dd/mm/yyyy" name="trucking_date" id="trucking_date" value="<?php // echo $trucking_date ?>" />
									</div>-->
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" name="shipping_date" id="shipping_date" value="<?php echo $shipping_date ?>" />
									</div>
								</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-md-5 col-sm-5">
										...
										<!--<input type="text" class="form-control" name="notify_party2" id="notify_party2" value="<?php // echo $notify_party2 ?>" />-->
									</div>
								</div>
						...
						<div class="form-body row">
							<div class="col-md-12">
								<h4 class="form-section">For Shipping Department Only</h4>
							</div>
							
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-4 control-label" for="varchar">Vessel / Voyage</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="voyage" id="voyage" value="<?php // echo $voyage ?>" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-md-4 control-label" for="varchar">ETD Singapore</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="etd_singapore" id="etd_singapore" value="<?php // echo $etd_singapore ?>" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" class="form-control" name="ship_port" id="ship_port" value="<?php // echo $ship_port ?>" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-md-4 control-label" for="varchar">Place of Delivery</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="place_delivery" id="place_delivery" value="<?php // echo $place_delivery ?>" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-md-4 control-label" for="varchar">Barge Ref</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="barge_ref" id="barge_ref" value="<?php // echo $barge_ref ?>" />
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-3 control-label" for="varchar">ETD Destination</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="etd_destination" id="etd_destination" value="<?php // echo $etd_destination ?>" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-md-3 control-label" for="varchar">Booking Ref</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="booking_ref" id="booking_ref" value="<?php // echo $booking_ref ?>" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-md-3 control-label" for="varchar">Collection Yard</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="collection_yard" id="collection_yard" value="<?php // echo $collection_yard ?>" />
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-md-3 control-label" for="varchar">Container / Seal No</label>
									<div class="col-md-7">
										<input type="text" class="form-control" name="ship_container" id="ship_container" value="<?php // echo $ship_container ?>" />
									</div>
								</div>
							</div>
