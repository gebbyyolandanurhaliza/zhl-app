...
//			$this->Cell(40, 4, '', 0, 1);
	...
	//			$this->Cell(165, 4,': '.$pro->brand_name, 0, 1, 'L', false);
				...
				$this->Cell(50, 4, ': '.floatval(number_format($pro->gross_weight, 3)).' / '.floatval(number_format($pro->net_weight, 3)), 0, 1, 'L', false);
...
//			$this->setFont('Arial', '', $fontsize);
			//$this->SetFont('DroidSansFallback', '', $fontsize);			// Jika ini dipakai tambahkan fungsi $pdf->AddFont
			$this->setFont('NotoSans-Regular', '', $fontsize);
