...
//                                                url: "<?php // echo site_url('marketing_misc/get_payterm_by_customer') ?>",
                                    ...
                                    <div id="div_freight" class="form-group">
                                        <label class="col-md-2 control-label padding-right-2" for="varchar">Freight 1</label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control autonumber text-right freightnew" name="freight1" id="freight1" value="<?php echo $freight1;?>" <?php echo $freight_disabled;?>>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group date date-picker" data-date-format="mm/yyyy" >
                                                <div class="input-group date-picker input-daterange" data-date="<?php echo $current_date ?>" data-date-format="dd/mm/yyyy">
                                                    <input type="text" class="form-control freightvalid" name="freight11" value="<?php echo $freight11;?>" title="date format : dd/mm/yyyy" <?php echo $freight_disabled;?>>
                                                    <span class="input-group-addon" style="background: transparent; border-color: transparent">to</span>
                                                    <input type="text" class="form-control freightvalid" name="freight12" value="<?php echo $freight12;?>" title="date format : dd/mm/yyyy" <?php echo $freight_disabled;?>>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="div_freight" class="form-group">
                                        <label class="col-md-2 control-label padding-right-2" for="varchar">Freight 2</label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control autonumber text-right freightnew" name="freight2" id="freight2" value="<?php echo $freight2;?>" <?php echo $freight_disabled;?>>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group date date-picker" data-date-format="mm/yyyy" >
                                                <div class="input-group date-picker input-daterange" data-date="<?php echo $current_date ?>" data-date-format="dd/mm/yyyy">
                                                    <input type="text" class="form-control freightvalid" name="freight21" value="<?php echo $freight21;?>" title="date format : dd/mm/yyyy" <?php echo $freight_disabled;?>>
                                                    <span class="input-group-addon" style="background: transparent; border-color: transparent">to</span>
                                                    <input type="text" class="form-control freightvalid" name="freight22" value="<?php echo $freight22;?>" title="date format : dd/mm/yyyy" <?php echo $freight_disabled;?>>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="div_freight" class="form-group">
                                        <label class="col-md-2 control-label padding-right-2" for="varchar">Freight 3</label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control autonumber text-right freightnew" name="freight2" id="freight3" value="<?php echo $freight3;?>" <?php echo $freight_disabled;?>>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group date date-picker" data-date-format="mm/yyyy" >
                                                <div class="input-group date-picker input-daterange" data-date="<?php echo $current_date ?>" data-date-format="dd/mm/yyyy">
                                                    <input type="text" class="form-control freightvalid" name="freight31" value="<?php echo $freight31;?>" title="date format : dd/mm/yyyy" <?php echo $freight_disabled;?>>
                                                    <span class="input-group-addon" style="background: transparent; border-color: transparent">to</span>
                                                    <input type="text" class="form-control freightvalid" name="freight32" value="<?php echo $freight32;?>" title="date format : dd/mm/yyyy" <?php echo $freight_disabled;?>>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
//
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="padding-left: 2px">
                                            <input type="hidden" class="form-control autonumber text-right" name="freight" id="freight" value="<?php echo $freight; ?>" onkeyup="re_calculate()"/>
                                        </div>
                                    </div>
