...
<div id="previous">
	<div id="modal_previous" class="modal fade" role="modal" tabindex="-1" data-toggle="modal" data-backdrop="static" data-keyboard="false" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<div class="form-actions">
						<div class="row">
							<div class="col-md-12">
								<input type="button" class="btn green" value="Use Remark" onclick="change_remark()"> 
...
<script>	
	...
	function change_remark(){
        document.getElementById("quotation_remark").value = document.getElementById("pre_remark").value;    
