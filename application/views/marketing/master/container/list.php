                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-title">
                    	<div class="caption">
                            ...
                            <span class="caption-subject theme-font uppercase">Container</span>
                        </div>
                        <div class="actions">
                        	<?php echo anchor(site_url('marketing/create_master/container'), '<i class="fa fa-plus"></i> Create New Container', 'class="btn btn-primary"'); ?>
                        </div>
                    </div>
                        	...
                        	<table id="tblmst_container" class="table table-bordered table-striped table-condensed">
                            	<thead>
                                	<tr>
                                        ...
                                        <th scope="col" width="50px" class="text-center">Size</th>
                                        <th scope="col" width="100px" class="text-center">Abbr</th>
                                        <th scope="col" width="100px" class="text-center">Measurement</th>
                                ...
                                <tbody>
									...
									<tr>
										<td style="text-align:center" width="100px">
											<?php
											echo anchor(site_url('marketing/delete_master/container/'.$master->container_id),'<i class="fa fa-trash-o"></i>','class="btn default btn-sm red-stripe" onclick="javasciprt: return confirm(\'Are You Sure Delete Data '.$master->container_name.'?\')"'); 
											echo anchor(site_url('marketing/edit_master/container/'.$master->container_id),'<i class="fa fa-edit"></i>', 'class="btn default btn-sm green-stripe"');
											?>
										</td>
										<td class="text-center"><?php echo $master->container_id ?></td>
