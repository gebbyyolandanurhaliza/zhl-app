			...
			<div class="col-md-12">
				...
				<div class="portlet light">
					<div class="portlet-title">
						...
						<div class="actions">
							<?php echo anchor(site_url('marketing/create_master/customer'), '<i class="fa fa-plus"></i> Create New Customer', 'class="btn btn-primary"'); ?>
						</div>
					</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<?php 
													echo anchor(site_url('marketing/delete_master/customer/'.$master->customer_id),'<i class="fa fa-trash-o"></i>','class="btn default btn-sm red-stripe" onclick="javasciprt: return confirm(\'Are You Sure Delete Data '.$master->customer_name.'?\')"'); 
													echo anchor(site_url('marketing/edit_master/customer/'.$master->customer_id),'<i class="fa fa-edit"></i>', 'class="btn default btn-sm green-stripe"'); 
												?>												
												</td>
