		...
		<tbody>
			...
			if ($record){
				foreach ($record as $r){
					...
					echo '</td>';
					//idx = 1
					echo '<td class="id sembunyi">'.$r->itemid.'</td>';
					//idx = 2
					echo '<td class="nama">'.$r->itemname.'</td>';
					//idx = 3
					echo '<td class="code" style="width:220px; text-align: left;">'.$r->itemremark.'</td>';
					//idx = 4
					echo '<td class="factory text-center" style="width:70px;">'.$r->uomname.'</td>';
					// //idx = 5
					// echo '<td class="brand sembunyi">'.$r->uomname.'</td>';
					// //idx = 6
