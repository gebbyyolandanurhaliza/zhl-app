								...
								<div class="col-md-12">
									...
									<script type="text/javascript">
                                        $("#add_bank").click(function () {
                                            $.ajax({
                                                type: "POST",
                                                url: "<?php echo site_url('master/add_bank_row') ?>",
								...
								<div class="col-md-12">
									...
									<script type="text/javascript">
                                        $("#add_payment").click(function () {
                                            $.ajax({
                                                type: "POST",
                                                url: "<?php echo site_url('master/add_payterm_row') ?>",
                                                success: function (msg) {
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-12">
										...
										<a href="<?php echo site_url('master/customer') ?>" class="btn red"><i class="fa fa-close"></i> Cancel</a>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	...
	$('#search_product').on('click',function(){
        ...
        $.ajax({
            type: "POST",
            url : "<?php echo site_url('marketing_misc/search_product/customer')?>",
            data: {
                "product_id[]" : p_id,
                "factory_id[]"  : f_id,
                "param" : param
