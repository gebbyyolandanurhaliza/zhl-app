			...
			<div class="col-md-12">
				...
				<div class="portlet light">
					<div class="portlet-title">
						...
						<div class="actions">
							<?php echo anchor(site_url('master/create_master/customer'), '<i class="fa fa-plus"></i> Create New Customer', 'class="btn btn-primary"'); ?>
						</div>
					</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<?php 
													echo anchor(site_url('master/delete_master/customer/'.$customer->customer_id),'<i class="fa fa-trash-o"></i>','class="btn default btn-sm red-stripe" onclick="javasciprt: return confirm(\'Are You Sure Delete Data '.$customer->customer_name.'?\')"'); 
													echo anchor(site_url('master/edit_master/customer/'.$customer->customer_id),'<i class="fa fa-edit"></i>', 'class="btn default btn-sm green-stripe"'); 
												?>												
												</td>
											...
											<!--<td><?php echo $customer->customer_country ?></td>-->
												<td><?php echo $customer->customer_reference ?></td>
												<td><?php echo $customer->customer_contract_no ?></td>
												<td><?php echo $customer->customer_address ?></td>
												<td><?php echo $customer->customer_phone ?></td>
												<td><?php echo $customer->customer_fax ?></td>
